...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function Qa(){return new Nt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zs(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function eo(){return new Nt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zs(),fragmentShader:`
	...
	`}function yd(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===vs||l===xs,h=l===hi||l===fi;if(c||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let f=e.get(a);return t===null&&(t=new Za(n)),f=c?t.fromEquirectangular(a,f):t.fromCubemap(a,f),e.set(a,f),f.texture}else{if(e.has(a))return e.get(a).texture;{const f=a.image;if(c&&f&&f.height>0||h&&f&&r(f)){t===null&&(t=new Za(n));const p=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,p),a.addEventListener("dispose",s),p.texture}else return null}}}return a}function r(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function Td(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(i){i.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(i){const r=t(i);return r===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function bd(n,e,t,i){const r={},s=new WeakMap;function o(f){const p=f.target;p.index!==null&&e.remove(p.index);for(const v in p.attributes)e.remove(p.attributes[v]);for(const v in p.morphAttributes){const _=p.morphAttributes[v];for(let d=0,u=_.length;d<u;d++)e.remove(_[d])}p.removeEventListener("dispose",o),delete r[p.id];const m=s.get(p);m&&(e.remove(m),s.delete(p)),i.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function a(f,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,t.memory.geometries++),p}function l(f){const p=f.attributes;for(const v in p)e.update(p[v],n.ARRAY_BUFFER);const m=f.morphAttributes;for(const v in m){const _=m[v];for(let d=0,u=_.length;d<u;d++)e.update(_[d],n.ARRAY_BUFFER)}}function c(f){const p=[],m=f.index,v=f.attributes.position;let _=0;if(m!==null){const T=m.array;_=m.version;for(let E=0,b=T.length;E<b;E+=3){const L=T[E+0],R=T[E+1],w=T[E+2];p.push(L,R,R,w,w,L)}}else if(v!==void 0){const T=v.array;_=v.version;for(let E=0,b=T.length/3-1;E<b;E+=3){const L=E+0,R=E+1,w=E+2;p.push(L,R,R,w,w,L)}}else return;const d=new(sl(p)?pl:dl)(p,1);d.version=_;const u=s.get(f);u&&e.remove(u),s.set(f,d)}function h(f){const p=s.get(f);if(p){const m=f.index;m!==null&&p.version<m.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:h}}function Ad(n,e,t,i){const r=i.isWebGL2;let s;function o(m){s=m}let a,l;function c(m){a=m.type,l=m.bytesPerElement}function h(m,v){n.drawElements(s,v,a,m*l),t.update(v,s,1)}function f(m,v,_){if(_===0)return;let d,u;if(r)d=n,u="drawElementsInstanced";else if(d=e.get("ANGLE_instanced_arrays"),u="drawElementsInstancedANGLE",d===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}d[u](s,v,a,m*l,_),t.update(v,s,_)}function p(m,v,_){if(_===0)return;const d=e.get("WEBGL_multi_draw");if(d===null)for(let u=0;u<_;u++)this.render(m[u]/l,v[u]);else{d.multiDrawElementsWEBGL(s,v,0,a,m,0,_);let u=0;for(let T=0;T<_;T++)u+=v[T];t.update(u,s,1)}}this.setMode=o,this.setIndex=c,this.render=h,this.renderInstances=f,this.renderMultiDraw=p}function wd(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Rd(n,e){return n[0]-e[0]}function Cd(n,e){return Math.abs(e[1])-Math.abs(n[1])}function Pd(n,e,t){const i={},r=new Float32Array(8),s=new WeakMap,o=new dt,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,h,f){const p=c.morphTargetInfluences;if(e.isWebGL2===!0){const v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=v!==void 0?v.length:0;let d=s.get(h);if(d===void 0||d.count!==_){let z=function(){re.dispose(),s.delete(h),h.removeEventListener("dispose",z)};var m=z;d!==void 0&&d.texture.dispose();const E=h.morphAttributes.position!==void 0,b=h.morphAttributes.normal!==void 0,L=h.morphAttributes.color!==void 0,R=h.morphAttributes.position||[],w=h.morphAttributes.normal||[],Z=h.morphAttributes.color||[];let S=0;E===!0&&(S=1),b===!0&&(S=2),L===!0&&(S=3);let y=h.attributes.position.count*S,V=1;y>e.maxTextureSize&&(V=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const W=new Float32Array(y*V*4*_),re=new ll(W,y,V,_);re.type=vn,re.needsUpdate=!0;const C=S*4;for(let H=0;H<_;H++){const X=R[H],k=w[H],q=Z[H],Y=y*V*4*H;for(let ee=0;ee<X.count;ee++){const te=ee*C;E===!0&&(o.fromBufferAttribute(X,ee),W[Y+te+0]=o.x,W[Y+te+1]=o.y,W[Y+te+2]=o.z,W[Y+te+3]=0),b===!0&&(o.fromBufferAttribute(k,ee),W[Y+te+4]=o.x,W[Y+te+5]=o.y,W[Y+te+6]=o.z,W[Y+te+7]=0),L===!0&&(o.fromBufferAttribute(q,ee),W[Y+te+8]=o.x,W[Y+te+9]=o.y,W[Y+te+10]=o.z,W[Y+te+11]=q.itemSize===4?o.w:1)}}d={count:_,texture:re,size:new We(y,V)},s.set(h,d),h.addEventListener("dispose",z)}let u=0;for(let E=0;E<p.length;E++)u+=p[E];const T=h.morphTargetsRelative?1:1-u;f.getUniforms().setValue(n,"morphTargetBaseInfluence",T),f.getUniforms().setValue(n,"morphTargetInfluences",p),f.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),f.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}else{const v=p===void 0?0:p.length;let _=i[h.id];if(_===void 0||_.length!==v){_=[];for(let b=0;b<v;b++)_[b]=[b,0];i[h.id]=_}for(let b=0;b<v;b++){const L=_[b];L[0]=b,L[1]=p[b]}_.sort(Cd);for(let b=0;b<8;b++)b<v&&_[b][1]?(a[b][0]=_[b][0],a[b][1]=_[b][1]):(a[b][0]=Number.MAX_SAFE_INTEGER,a[b][1]=0);a.sort(Rd);const d=h.morphAttributes.position,u=h.morphAttributes.normal;let T=0;for(let b=0;b<8;b++){const L=a[b],R=L[0],w=L[1];R!==Number.MAX_SAFE_INTEGER&&w?(d&&h.getAttribute("morphTarget"+b)!==d[R]&&h.setAttribute("morphTarget"+b,d[R]),u&&h.getAttribute("morphNormal"+b)!==u[R]&&h.setAttribute("morphNormal"+b,u[R]),r[b]=w,T+=w):(d&&h.hasAttribute("morphTarget"+b)===!0&&h.deleteAttribute("morphTarget"+b),u&&h.hasAttribute("morphNormal"+b)===!0&&h.deleteAttribute("morphNormal"+b),r[b]=0)}const E=h.morphTargetsRelative?1:1-T;f.getUniforms().setValue(n,"morphTargetBaseInfluence",E),f.getUniforms().setValue(n,"morphTargetInfluences",r)}}return{update:l}}function Ld(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,h=l.geometry,f=e.get(l,h);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==c&&(p.update(),r.set(p,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}class Ml extends It{constructor(e,t,i,r,s,o,a,l,c,h){if(h=h!==void 0?h:zn,h!==zn&&h!==pi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===zn&&(i=_n),i===void 0&&h===pi&&(i=Bn),super(null,r,s,o,a,l,h,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:yt,this.minFilter=l!==void 0?l:yt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Sl=new It,El=new Ml(1,1);El.compareFunction=rl;const yl=new ll,Tl=new pu,bl=new _l,to=[],no=[],io=new Float32Array(16),ro=new Float32Array(9),so=new Float32Array(4);function _i(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=to[r];if(s===void 0&&(s=new Float32Array(r),to[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function at(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ot(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Cr(n,e){let t=no[e];t===void 0&&(t=new Int32Array(e),no[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Dd(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Ud(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2fv(this.addr,e),ot(t,e)}}function Id(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(at(t,e))return;n.uniform3fv(this.addr,e),ot(t,e)}}function Nd(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4fv(this.addr,e),ot(t,e)}}function Fd(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;so.set(i),n.uniformMatrix2fv(this.addr,!1,so),ot(t,i)}}function Od(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;ro.set(i),n.uniformMatrix3fv(this.addr,!1,ro),ot(t,i)}}function Bd(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(at(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ot(t,e)}else{if(at(t,i))return;io.set(i),n.uniformMatrix4fv(this.addr,!1,io),ot(t,i)}}function zd(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Gd(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2iv(this.addr,e),ot(t,e)}}function Hd(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3iv(this.addr,e),ot(t,e)}}function Vd(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4iv(this.addr,e),ot(t,e)}}function kd(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Wd(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(at(t,e))return;n.uniform2uiv(this.addr,e),ot(t,e)}}function qd(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(at(t,e))return;n.uniform3uiv(this.addr,e),ot(t,e)}}function Xd(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(at(t,e))return;n.uniform4uiv(this.addr,e),ot(t,e)}}function Yd(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);const s=this.type===n.SAMPLER_2D_SHADOW?El:Sl;t.setTexture2D(e||s,r)}function jd(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Tl,r)}function $d(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||bl,r)}function Kd(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||yl,r)}function Zd(n){switch(n){case 5126:return Dd;case 35664:return Ud;case 35665:return Id;case 35666:return Nd;case 35674:return Fd;case 35675:return Od;case 35676:return Bd;case 5124:case 35670:return zd;case 35667:case 35671:return Gd;case 35668:case 35672:return Hd;case 35669:case 35673:return Vd;case 5125:return kd;case 36294:return Wd;case 36295:return qd;case 36296:return Xd;case 35678:case 36198:case 36298:case 36306:case 35682:return Yd;case 35679:case 36299:case 36307:return jd;case 35680:case 36300:case 36308:case 36293:return $d;case 36289:case 36303:case 36311:case 36292:return Kd}}function Jd(n,e){n.uniform1fv(this.addr,e)}function Qd(n,e){const t=_i(e,this.size,2);n.uniform2fv(this.addr,t)}function ep(n,e){const t=_i(e,this.size,3);n.uniform3fv(this.addr,t)}function tp(n,e){const t=_i(e,this.size,4);n.uniform4fv(this.addr,t)}function np(n,e){const t=_i(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function ip(n,e){const t=_i(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function rp(n,e){const t=_i(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function sp(n,e){n.uniform1iv(this.addr,e)}function ap(n,e){n.uniform2iv(this.addr,e)}function op(n,e){n.uniform3iv(this.addr,e)}function lp(n,e){n.uniform4iv(this.addr,e)}function cp(n,e){n.uniform1uiv(this.addr,e)}function up(n,e){n.uniform2uiv(this.addr,e)}function hp(n,e){n.uniform3uiv(this.addr,e)}function fp(n,e){n.uniform4uiv(this.addr,e)}function dp(n,e,t){const i=this.cache,r=e.length,s=Cr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||Sl,s[o])}function pp(n,e,t){const i=this.cache,r=e.length,s=Cr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Tl,s[o])}function mp(n,e,t){const i=this.cache,r=e.length,s=Cr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||bl,s[o])}function gp(n,e,t){const i=this.cache,r=e.length,s=Cr(t,r);at(i,s)||(n.uniform1iv(this.addr,s),ot(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||yl,s[o])}function _p(n){switch(n){case 5126:return Jd;case 35664:return Qd;case 35665:return ep;case 35666:return tp;case 35674:return np;case 35675:return ip;case 35676:return rp;case 5124:case 35670:return sp;case 35667:case 35671:return ap;case 35668:case 35672:return op;case 35669:case 35673:return lp;case 5125:return cp;case 36294:return up;case 36295:return hp;case 36296:return fp;case 35678:case 36198:case 36298:case 36306:case 35682:return dp;case 35679:case 36299:case 36307:return pp;case 35680:case 36300:case 36308:case 36293:return mp;case 36289:case 36303:case 36311:case 36292:return gp}}class vp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Zd(t.type)}}class xp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=_p(t.type)}}class Mp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const us=/(\w+)(\])?(\[|\.)?/g;function ao(n,e){n.seq.push(e),n.map[e.id]=e}function Sp(n,e,t){const i=n.name,r=i.length;for(us.lastIndex=0;;){const s=us.exec(i),o=us.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){ao(t,c===void 0?new vp(a,n,e):new xp(a,n,e));break}else{let f=t.map[a];f===void 0&&(f=new Mp(a),ao(t,f)),t=f}}}class dr{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Sp(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function oo(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Ep=37297;let yp=0;function Tp(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}function bp(n){const e=Ye.getPrimaries(Ye.workingColorSpace),t=Ye.getPrimaries(n);let i;switch(e===t?i="":e===vr&&t===_r?i="LinearDisplayP3ToLinearSRGB":e===_r&&t===vr&&(i="LinearSRGBToLinearDisplayP3"),n){case cn:case Ar:return[i,"LinearTransferOETF"];case ft:case Os:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function lo(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Tp(n.getShaderSource(e),o)}else return r}function Ap(n,e){const t=bp(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function wp(n,e){let t;switch(e){case Oc:t="Linear";break;case Bc:t="Reinhard";break;case zc:t="OptimizedCineon";break;case jo:t="ACESFilmic";break;case Hc:t="AgX";break;case Gc:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Rp(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(ai).join(`
`)}function Cp(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(ai).join(`
`)}function Pp(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function Lp(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function ai(n){return n!==""}function co(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function uo(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Dp=/^[ \t]*#include +<([\w\d./]+)>/gm;function bs(n){return n.replace(Dp,Ip)}const Up=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Ip(n,e){let t=Ne[e];if(t===void 0){const i=Up.get(e);if(i!==void 0)t=Ne[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return bs(t)}const Np=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ho(n){return n.replace(Np,Fp)}function Fp(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function fo(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Op(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Xo?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===hc?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===sn&&(e="SHADOWMAP_TYPE_VSM"),e}function Bp(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case hi:case fi:e="ENVMAP_TYPE_CUBE";break;case br:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zp(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case fi:e="ENVMAP_MODE_REFRACTION";break}return e}function Gp(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case Yo:e="ENVMAP_BLENDING_MULTIPLY";break;case Nc:e="ENVMAP_BLENDING_MIX";break;case Fc:e="ENVMAP_BLENDING_ADD";break}return e}function Hp(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function Vp(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Op(t),c=Bp(t),h=zp(t),f=Gp(t),p=Hp(t),m=t.isWebGL2?"":Rp(t),v=Cp(t),_=Pp(s),d=r.createProgram();let u,T,E=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `,wireframe:!1}),this.mesh=new Ut(t,this.mat),this.mesh.rotation.x=-Math.PI/3,this.mesh.position.y=-2,this.scene.add(this.mesh);const i=new Sm(16777215,.2);i.position.set(3,5,2),this.scene.add(i)}scene=new vi;name="terrain";mesh;mat;palette=["#59ffa9","#5aaaff","#ff59be","#ffe459","#ff8a59"];params={intensity:.7,speed:1};start(){}stop(){this.mesh.geometry.dispose(),this.mat.dispose()}update(e,t){this.mat.uniforms.uTime.value=t}setPalette(e){this.palette=e,this.mat.uniforms.uPalette.value=e.map(t=>new Te(t))}onMacro(e,t){e==="intensity"&&(this.mat.uniforms.uIntensity.value=t),e==="speed"&&(this.mat.uniforms.uSpeed.value=t)}onExplode(){this.mat.uniforms.uIntensity.value=Math.min(3,this.mat.uniforms.uIntensity.value+.6),setTimeout(()=>this.mat.uniforms.uIntensity.value=.7,600)}}class wm{constructor(e){this.opts=e;const t=new Tn(2,1);this.mat=new Nt({uniforms:{uTime:{value:0},uPalette:{value:this.palette.map(i=>new Te(i))},uIntensity:{value:this.params.intensity}},vertexShader:`
        ...
        }`,transparent:!0}),this.mesh=new Ut(t,this.mat),this.group.add(this.mesh),this.scene.add(this.group)}scene=new vi;name="type";group=new Ai;mat;mesh;palette=["#59ffa9","#5aaaff","#ff59be","#ffe459","#ff8a59"];params={intensity:.8,speed:1,weight:400,stretch:100};start(){}stop(){this.mesh.geometry.dispose(),this.mat.dispose()}update(e,t){this.mat.uniforms.uTime.value=t*this.params.speed,this.group.rotation.y=Math.sin(t*.2)*.2,this.group.position.z=-1.5}setPalette(e){this.palette=e,this.mat.uniforms.uPalette.value=e.map(t=>new Te(t))}onMacro(e,t){e==="intensity"&&(this.mat.uniforms.uIntensity.value=t),e==="speed"&&(this.params.speed=t)}onExplode(){this.params.speed=2.5,setTimeout(()=>this.params.speed=1,600)}}class wl{scene=new vi;name="basic";mesh;uniforms;t=0;constructor(){this.uniforms={uTime:{value:0},uColors:{value:[new Te("#59ffa9"),new Te("#5aaaff"),new Te("#ff59be")]}};const e=new Tn(2,2,1,1),t=new Nt({uniforms:this.uniforms,vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = vec4(position, 1.0);
      ...
      `,depthWrite:!1,depthTest:!1});this.mesh=new Ut(e,t),this.scene.add(this.mesh)}start(){}stop(){}update(e,t){this.t+=e,this.uniforms.uTime.value=this.t}setPalette(e){const t=[new Te(e[0]||"#59ffa9"),new Te(e[1]||"#5aaaff"),new Te(e[2]||"#ff59be")];this.uniforms.uColors.value=t}onMacro(e,t){}}let ht,ln,pt,En,ui,Sr,ws=["#59ffa9","#5aaaff","#ff59be","#ffe459","#ff8a59"],Rl=60,Rm=new Em,Rs=!1,ds=0;const Cm={basic:wl,particles:ym,fluid:Tm,tunnel:bm,terrain:Am,type:wm};async function Pm(n){En=n,ht=new Al({canvas:n,antialias:!1,powerPreference:"high-performance",alpha:!1}),ht.outputColorSpace=ft,ht.toneMapping=jo,ht.toneMappingExposure=1,ht.debug.checkShaderErrors=!0,ht.autoClear=!0,ht.setPixelRatio(Math.min(window.devicePixelRatio||1,1.5));const e=n.clientWidth||window.innerWidth||1280,t=n.clientHeight||window.innerHeight||720;ht.setSize(e,t,!1),ht.setClearColor(263174,1),ln=new Bt(60,e/t,.1,2e3),ln.position.set(0,0,5),ui={renderScale:1,msaa:0,taa:!1,bloom:0,ssao:!1,motionBlur:!1,dof:!1,toneMap:"filmic",chromaticAberration:0,volumetrics:!1,raymarchSteps:384,softShadowSamples:8,particleCount:5e5,fluidResolution:384,fluidIterations:20,webgpuPathTrace:!1},Sr={epilepsySafe:!1,intensityLimiter:1,reducedMotion:!1,highContrast:!1},pt=new wl,pt.start?.(),window.addEventListener("vj-macro",i=>{pt.onMacro?.(i.detail.name,i.detail.value)}),window.addEventListener("vj-explode",()=>{pt.onExplode?.()}),window.addEventListener("vj-scene",i=>{Vn(i.detail.scene)})}function Lm(){try{return!!ht?.capabilities?.isWebGL2}catch{return!1}}function Cl(){return["basic","particles","type"]}function Pl(n){Rs=n,Rs&&Vn("basic")}function Dm(){return En}function Ll(n,e,t){if(!ht||!ln||!En)return;const i=Math.max(1,n||En.clientWidth||window.innerWidth||1),r=Math.max(1,e||En.clientHeight||window.innerHeight||1),s=Math.max(1,Math.min(t||window.devicePixelRatio||1,1.5))*(ui?.renderScale||1);ht.setPixelRatio(s),ht.setSize(i,r,!1),ln.aspect=i/r,ln.updateProjectionMatrix()}function Um(n){ui={...ui,...n},!(!ht||!En)&&(Ll(En.clientWidth,En.clientHeight,window.devicePixelRatio),pt.setQuality?.(ui))}function Im(n){Sr={...Sr,...n}}function Nm(n){n.intensity!==void 0&&pt.onMacro?.("intensity",n.intensity),n.bloom!==void 0&&pt.onMacro?.("bloom",n.bloom),n.glitch!==void 0&&pt.onMacro?.("glitch",n.glitch),n.speed!==void 0&&pt.onMacro?.("speed",n.speed)}function Vn(n){const t=new Set(Cl()).has(n)?n:"basic",i=Cm[t];if(!(!i||!ht||!ln)){try{pt.stop?.()}catch{}pt=new i({renderer:ht,camera:ln,quality:()=>ui,accessibility:()=>Sr,palette:()=>ws}),pt.setPalette(ws),pt.start()}}function Eo(n,e=0){Vn(n)}function Fm(n){ws=n,pt.setPalette(n)}function Om(){const n=Cl(),e=Math.floor(Date.now()/1e4%n.length);Vn(n[e])}function Bm(){const n=()=>{const e=Rm.getDelta(),t=performance.now()/1e3;1/Math.max(e,1e-5)<Rl-5?pt.onMacro?.("speed",.9):pt.onMacro?.("speed",1);try{pt.update(e,t),ht&&ln&&ht.render(pt.scene,ln),ds=0}catch{ds++,ds>2&&!Rs&&Pl(!0)}requestAnimationFrame(n)};requestAnimationFrame(n)}function zm(n){Rl=n}function Hs(n){return new Promise((e,t)=>{n.oncomplete=n.onsuccess=()=>e(n.result),n.onabort=n.onerror=()=>t(n.error)})}function Gm(n,e){let t;const i=()=>{if(t)return t;const r=indexedDB.open(n);return r.onupgradeneeded=()=>r.result.createObjectStore(e),t=Hs(r),t.then(s=>{s.onclose=()=>t=void 0},()=>{}),t};return(r,s)=>i().then(o=>s(o.transaction(e,r).objectStore(e)))}let ps;function Dl(){return ps||(ps=Gm("keyval-store","keyval")),ps}function Vs(n,e=Dl()){return e("readonly",t=>Hs(t.get(n)))}function Er(n,e,t=Dl()){return t("readwrite",i=>(i.put(e,n),Hs(i.transaction)))}async function Hm(n,e){const t=`cover:${n}`,i=await Vs(t);return!i||i.url!==e?null:(i.blob&&!i.objectUrl&&(i.objectUrl=URL.createObjectURL(i.blob)),i)}async function Vm(n,e,t){const i=`cover:${n}`,r=await Vs(i);r?await Er(i,{...r,palette:t}):await Er(i,{url:e,palette:t})}async function km(n){await Er(`track:${n.id}`,n)}async function Wm(n,e){await Er(`analysis:${n}`,e)}async function qm(n){return Vs(`analysis:${n}`)}let Cs=[],Ps=[],oi=null,bi=0,yo=!0,On=[];function hr(n){return Math.round(n*1e3)}function Xm(n){const{onBeat:e,onPhraseBoundary:t}=n,i=document.getElementById("dir-auto-crossfade");i.addEventListener("change",()=>yo=i.checked);const r=document.getElementById("dir-add"),s=document.getElementById("dir-bar-num"),o=document.getElementById("dir-cue-type"),a=document.getElementById("dir-list"),l=document.getElementById("dir-clear"),c=()=>{if(!On.length){a.textContent="No cues";return}a.innerHTML=On.map(h=>`<div class="chip">bar ${h.bar} → ${h.action}</div>`).join(" ")};r.addEventListener("click",()=>{const h=parseInt(s.value),f=o.value;Number.isFinite(h)&&(On.push({bar:h,action:f}),c(),To())}),l.addEventListener("click",()=>{On=[],c(),To()}),setInterval(async()=>{const h=await Zl();if(!h?.item)return;h.item.id!==oi&&(oi=h.item.id,await Ym(oi),bi=0,await jm(oi),c());const f=h.progress_ms;Cs.findIndex(d=>hr(d.start)<=f&&f<hr(d.start+d.duration))>=0&&e();const m=Ps.findIndex(d=>hr(d.start)<=f&&f<hr(d.start+d.duration));if(m>=0&&m%4===0&&bi!==m/4&&(bi=m/4,t(bi),yo)){const d=["particles","fluid","tunnel","terrain","type"],u=bi%d.length;Eo(d[u],1.5)}const v=Math.max(0,m),_=On.filter(d=>d.bar===v+1);for(const d of _)if(d.action==="explode"){const u=new CustomEvent("vj-explode");window.dispatchEvent(u)}else if(d.action.startsWith("scene:")){const u=d.action.split(":")[1];Eo(u,1.2)}},250)}async function Ym(n){const e=await qm(n);if(e){Cs=e.analysis.beats,Ps=e.analysis.bars,e.analysis.sections;return}const{feats:t,analysis:i}=await Ql(n);Cs=i.beats,Ps=i.bars,i.sections,Wm(n,{features:t,analysis:i}).catch(()=>{})}async function To(){oi&&localStorage.setItem(`dwdw.cues:${oi}`,JSON.stringify(On))}async function jm(n){const e=localStorage.getItem(`dwdw.cues:${n}`);On=e?JSON.parse(e):[]}function yr(n){"@babel/helpers - typeof";return yr=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},yr(n)}var $m=/^\s+/,Km=/\s+$/;function de(n,e){if(n=n||"",e=e||{},n instanceof de)return n;if(!(this instanceof de))return new de(n,e);var t=Zm(n);this._originalInput=n,this._r=t.r,this._g=t.g,this._b=t.b,this._a=t.a,this._roundA=Math.round(100*this._a)/100,this._format=e.format||t.format,this._gradientType=e.gradientType,this._r<1&&(this._r=Math.round(this._r)),this._g<1&&(this._g=Math.round(this._g)),this._b<1&&(this._b=Math.round(this._b)),this._ok=t.ok}de.prototype={isDark:function(){return this.getBrightness()<128},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var e=this.toRgb();return(e.r*299+e.g*587+e.b*114)/1e3},getLuminance:function(){var e=this.toRgb(),t,i,r,s,o,a;return t=e.r/255,i=e.g/255,r=e.b/255,t<=.03928?s=t/12.92:s=Math.pow((t+.055)/1.055,2.4),i<=.03928?o=i/12.92:o=Math.pow((i+.055)/1.055,2.4),r<=.03928?a=r/12.92:a=Math.pow((r+.055)/1.055,2.4),.2126*s+.7152*o+.0722*a},setAlpha:function(e){return this._a=Ul(e),this._roundA=Math.round(100*this._a)/100,this},toHsv:function(){var e=Ao(this._r,this._g,this._b);return{h:e.h*360,s:e.s,v:e.v,a:this._a}},toHsvString:function(){var e=Ao(this._r,this._g,this._b),t=Math.round(e.h*360),i=Math.round(e.s*100),r=Math.round(e.v*100);return this._a==1?"hsv("+t+", "+i+"%, "+r+"%)":"hsva("+t+", "+i+"%, "+r+"%, "+this._roundA+")"},toHsl:function(){var e=bo(this._r,this._g,this._b);return{h:e.h*360,s:e.s,l:e.l,a:this._a}},toHslString:function(){var e=bo(this._r,this._g,this._b),t=Math.round(e.h*360),i=Math.round(e.s*100),r=Math.round(e.l*100);return this._a==1?"hsl("+t+", "+i+"%, "+r+"%)":"hsla("+t+", "+i+"%, "+r+"%, "+this._roundA+")"},toHex:function(e){return wo(this._r,this._g,this._b,e)},toHexString:function(e){return"#"+this.toHex(e)},toHex8:function(e){return tg(this._r,this._g,this._b,this._a,e)},toHex8String:function(e){return"#"+this.toHex8(e)},toRgb:function(){return{r:Math.round(this._r),g:Math.round(this._g),b:Math.round(this._b),a:this._a}},toRgbString:function(){return this._a==1?"rgb("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+")":"rgba("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+", "+this._roundA+")"},toPercentageRgb:function(){return{r:Math.round(Je(this._r,255)*100)+"%",g:Math.round(Je(this._g,255)*100)+"%",b:Math.round(Je(this._b,255)*100)+"%",a:this._a}},toPercentageRgbString:function(){return this._a==1?"rgb("+Math.round(Je(this._r,255)*100)+"%, "+Math.round(Je(this._g,255)*100)+"%, "+Math.round(Je(this._b,255)*100)+"%)":"rgba("+Math.round(Je(this._r,255)*100)+"%, "+Math.round(Je(this._g,255)*100)+"%, "+Math.round(Je(this._b,255)*100)+"%, "+this._roundA+")"},toName:function(){return this._a===0?"transparent":this._a<1?!1:dg[wo(this._r,this._g,this._b,!0)]||!1},toFilter:function(e){var t="#"+Ro(this._r,this._g,this._b,this._a),i=t,r=this._gradientType?"GradientType = 1, ":"";if(e){var s=de(e);i="#"+Ro(s._r,s._g,s._b,s._a)}return"progid:DXImageTransform.Microsoft.gradient("+r+"startColorstr="+t+",endColorstr="+i+")"},toString:function(e){var t=!!e;e=e||this._format;var i=!1,r=this._a<1&&this._a>=0,s=!t&&r&&(e==="hex"||e==="hex6"||e==="hex3"||e==="hex4"||e==="hex8"||e==="name");return s?e==="name"&&this._a===0?this.toName():this.toRgbString():(e==="rgb"&&(i=this.toRgbString()),e==="prgb"&&(i=this.toPercentageRgbString()),(e==="hex"||e==="hex6")&&(i=this.toHexString()),e==="hex3"&&(i=this.toHexString(!0)),e==="hex4"&&(i=this.toHex8String(!0)),e==="hex8"&&(i=this.toHex8String()),e==="name"&&(i=this.toName()),e==="hsl"&&(i=this.toHslString()),e==="hsv"&&(i=this.toHsvString()),i||this.toHexString())},clone:function(){return de(this.toString())},_applyModification:function(e,t){var i=e.apply(null,[this].concat([].slice.call(t)));return this._r=i._r,this._g=i._g,this._b=i._b,this.setAlpha(i._a),this},lighten:function(){return this._applyModification(sg,arguments)},brighten:function(){return this._applyModification(ag,arguments)},darken:function(){return this._applyModification(og,arguments)},desaturate:function(){return this._applyModification(ng,arguments)},saturate:function(){return this._applyModification(ig,arguments)},greyscale:function(){return this._applyModification(rg,arguments)},spin:function(){return this._applyModification(lg,arguments)},_applyCombination:function(e,t){return e.apply(null,[this].concat([].slice.call(t)))},analogous:function(){return this._applyCombination(hg,arguments)},complement:function(){return this._applyCombination(cg,arguments)},monochromatic:function(){return this._applyCombination(fg,arguments)},splitcomplement:function(){return this._applyCombination(ug,arguments)},triad:function(){return this._applyCombination(Co,[3])},tetrad:function(){return this._applyCombination(Co,[4])}};de.fromRatio=function(n,e){if(yr(n)=="object"){var t={};for(var i in n)n.hasOwnProperty(i)&&(i==="a"?t[i]=n[i]:t[i]=wi(n[i]));n=t}return de(n,e)};function Zm(n){var e={r:0,g:0,b:0},t=1,i=null,r=null,s=null,o=!1,a=!1;return typeof n=="string"&&(n=_g(n)),yr(n)=="object"&&(rn(n.r)&&rn(n.g)&&rn(n.b)?(e=Jm(n.r,n.g,n.b),o=!0,a=String(n.r).substr(-1)==="%"?"prgb":"rgb"):rn(n.h)&&rn(n.s)&&rn(n.v)?(i=wi(n.s),r=wi(n.v),e=eg(n.h,i,r),o=!0,a="hsv"):rn(n.h)&&rn(n.s)&&rn(n.l)&&(i=wi(n.s),s=wi(n.l),e=Qm(n.h,i,s),o=!0,a="hsl"),n.hasOwnProperty("a")&&(t=n.a)),t=Ul(t),{ok:o,format:n.format||a,r:Math.min(255,Math.max(e.r,0)),g:Math.min(255,Math.max(e.g,0)),b:Math.min(255,Math.max(e.b,0)),a:t}}function Jm(n,e,t){return{r:Je(n,255)*255,g:Je(e,255)*255,b:Je(t,255)*255}}function bo(n,e,t){n=Je(n,255),e=Je(e,255),t=Je(t,255);var i=Math.max(n,e,t),r=Math.min(n,e,t),s,o,a=(i+r)/2;if(i==r)s=o=0;else{var l=i-r;switch(o=a>.5?l/(2-i-r):l/(i+r),i){case n:s=(e-t)/l+(e<t?6:0);break;case e:s=(t-n)/l+2;break;case t:s=(n-e)/l+4;break}s/=6}return{h:s,s:o,l:a}}function Qm(n,e,t){var i,r,s;n=Je(n,360),e=Je(e,100),t=Je(t,100);function o(c,h,f){return f<0&&(f+=1),f>1&&(f-=1),f<1/6?c+(h-c)*6*f:f<1/2?h:f<2/3?c+(h-c)*(2/3-f)*6:c}if(e===0)i=r=s=t;else{var a=t<.5?t*(1+e):t+e-t*e,l=2*t-a;i=o(l,a,n+1/3),r=o(l,a,n),s=o(l,a,n-1/3)}return{r:i*255,g:r*255,b:s*255}}function Ao(n,e,t){n=Je(n,255),e=Je(e,255),t=Je(t,255);var i=Math.max(n,e,t),r=Math.min(n,e,t),s,o,a=i,l=i-r;if(o=i===0?0:l/i,i==r)s=0;else{switch(i){case n:s=(e-t)/l+(e<t?6:0);break;case e:s=(t-n)/l+2;break;case t:s=(n-e)/l+4;break}s/=6}return{h:s,s:o,v:a}}function eg(n,e,t){n=Je(n,360)*6,e=Je(e,100),t=Je(t,100);var i=Math.floor(n),r=n-i,s=t*(1-e),o=t*(1-r*e),a=t*(1-(1-r)*e),l=i%6,c=[t,o,s,s,a,t][l],h=[a,t,t,o,s,s][l],f=[s,s,a,t,t,o][l];return{r:c*255,g:h*255,b:f*255}}function wo(n,e,t,i){var r=[Yt(Math.round(n).toString(16)),Yt(Math.round(e).toString(16)),Yt(Math.round(t).toString(16))];return i&&r[0].charAt(0)==r[0].charAt(1)&&r[1].charAt(0)==r[1].charAt(1)&&r[2].charAt(0)==r[2].charAt(1)?r[0].charAt(0)+r[1].charAt(0)+r[2].charAt(0):r.join("")}function tg(n,e,t,i,r){var s=[Yt(Math.round(n).toString(16)),Yt(Math.round(e).toString(16)),Yt(Math.round(t).toString(16)),Yt(Il(i))];return r&&s[0].charAt(0)==s[0].charAt(1)&&s[1].charAt(0)==s[1].charAt(1)&&s[2].charAt(0)==s[2].charAt(1)&&s[3].charAt(0)==s[3].charAt(1)?s[0].charAt(0)+s[1].charAt(0)+s[2].charAt(0)+s[3].charAt(0):s.join("")}function Ro(n,e,t,i){var r=[Yt(Il(i)),Yt(Math.round(n).toString(16)),Yt(Math.round(e).toString(16)),Yt(Math.round(t).toString(16))];return r.join("")}de.equals=function(n,e){return!n||!e?!1:de(n).toRgbString()==de(e).toRgbString()};de.random=function(){return de.fromRatio({r:Math.random(),g:Math.random(),b:Math.random()})};function ng(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.s-=e/100,t.s=Pr(t.s),de(t)}function ig(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.s+=e/100,t.s=Pr(t.s),de(t)}function rg(n){return de(n).desaturate(100)}function sg(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.l+=e/100,t.l=Pr(t.l),de(t)}function ag(n,e){e=e===0?0:e||10;var t=de(n).toRgb();return t.r=Math.max(0,Math.min(255,t.r-Math.round(255*-(e/100)))),t.g=Math.max(0,Math.min(255,t.g-Math.round(255*-(e/100)))),t.b=Math.max(0,Math.min(255,t.b-Math.round(255*-(e/100)))),de(t)}function og(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.l-=e/100,t.l=Pr(t.l),de(t)}function lg(n,e){var t=de(n).toHsl(),i=(t.h+e)%360;return t.h=i<0?360+i:i,de(t)}function cg(n){var e=de(n).toHsl();return e.h=(e.h+180)%360,de(e)}function Co(n,e){if(isNaN(e)||e<=0)throw new Error("Argument to polyad must be a positive number");for(var t=de(n).toHsl(),i=[de(n)],r=360/e,s=1;s<e;s++)i.push(de({h:(t.h+s*r)%360,s:t.s,l:t.l}));return i}function ug(n){var e=de(n).toHsl(),t=e.h;return[de(n),de({h:(t+72)%360,s:e.s,l:e.l}),de({h:(t+216)%360,s:e.s,l:e.l})]}function hg(n,e,t){e=e||6,t=t||30;var i=de(n).toHsl(),r=360/t,s=[de(n)];for(i.h=(i.h-(r*e>>1)+720)%360;--e;)i.h=(i.h+r)%360,s.push(de(i));return s}function fg(n,e){e=e||6;for(var t=de(n).toHsv(),i=t.h,r=t.s,s=t.v,o=[],a=1/e;e--;)o.push(de({h:i,s:r,v:s})),s=(s+a)%1;return o}de.mix=function(n,e,t){t=t===0?0:t||50;var i=de(n).toRgb(),r=de(e).toRgb(),s=t/100,o={r:(r.r-i.r)*s+i.r,g:(r.g-i.g)*s+i.g,b:(r.b-i.b)*s+i.b,a:(r.a-i.a)*s+i.a};return de(o)};de.readability=function(n,e){var t=de(n),i=de(e);return(Math.max(t.getLuminance(),i.getLuminance())+.05)/(Math.min(t.getLuminance(),i.getLuminance())+.05)};de.isReadable=function(n,e,t){var i=de.readability(n,e),r,s;switch(s=!1,r=vg(t),r.level+r.size){case"AAsmall":case"AAAlarge":s=i>=4.5;break;case"AAlarge":s=i>=3;break;case"AAAsmall":s=i>=7;break}return s};de.mostReadable=function(n,e,t){var i=null,r=0,s,o,a,l;t=t||{},o=t.includeFallbackColors,a=t.level,l=t.size;for(var c=0;c<e.length;c++)s=de.readability(n,e[c]),s>r&&(r=s,i=de(e[c]));return de.isReadable(n,i,{level:a,size:l})||!o?i:(t.includeFallbackColors=!1,de.mostReadable(n,["#fff","#000"],t))};var Ls=de.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkgrey:"a9a9a9",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"f0f",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",grey:"808080",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgreen:"90ee90",lightgrey:"d3d3d3",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"789",lightslategrey:"789",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"0f0",limegreen:"32cd32",linen:"faf0e6",magenta:"f0f",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370db",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"db7093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"f00",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},dg=de.hexNames=pg(Ls);function pg(n){var e={};for(var t in n)n.hasOwnProperty(t)&&(e[n[t]]=t);return e}function Ul(n){return n=parseFloat(n),(isNaN(n)||n<0||n>1)&&(n=1),n}function Je(n,e){mg(n)&&(n="100%");var t=gg(n);return n=Math.min(e,Math.max(0,parseFloat(n))),t&&(n=parseInt(n*e,10)/100),Math.abs(n-e)<1e-6?1:n%e/parseFloat(e)}function Pr(n){return Math.min(1,Math.max(0,n))}function Dt(n){return parseInt(n,16)}function mg(n){return typeof n=="string"&&n.indexOf(".")!=-1&&parseFloat(n)===1}function gg(n){return typeof n=="string"&&n.indexOf("%")!=-1}function Yt(n){return n.length==1?"0"+n:""+n}function wi(n){return n<=1&&(n=n*100+"%"),n}function Il(n){return Math.round(parseFloat(n)*255).toString(16)}function Po(n){return Dt(n)/255}var Wt=function(){var n="[-\\+]?\\d+%?",e="[-\\+]?\\d*\\.\\d+%?",t="(?:"+e+")|(?:"+n+")",i="[\\s|\\(]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")\\s*\\)?",r="[\\s|\\(]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")\\s*\\)?";return{CSS_UNIT:new RegExp(t),rgb:new RegExp("rgb"+i),rgba:new RegExp("rgba"+r),hsl:new RegExp("hsl"+i),hsla:new RegExp("hsla"+r),hsv:new RegExp("hsv"+i),hsva:new RegExp("hsva"+r),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/}}();function rn(n){return!!Wt.CSS_UNIT.exec(n)}function _g(n){n=n.replace($m,"").replace(Km,"").toLowerCase();var e=!1;if(Ls[n])n=Ls[n],e=!0;else if(n=="transparent")return{r:0,g:0,b:0,a:0,format:"name"};var t;return(t=Wt.rgb.exec(n))?{r:t[1],g:t[2],b:t[3]}:(t=Wt.rgba.exec(n))?{r:t[1],g:t[2],b:t[3],a:t[4]}:(t=Wt.hsl.exec(n))?{h:t[1],s:t[2],l:t[3]}:(t=Wt.hsla.exec(n))?{h:t[1],s:t[2],l:t[3],a:t[4]}:(t=Wt.hsv.exec(n))?{h:t[1],s:t[2],v:t[3]}:(t=Wt.hsva.exec(n))?{h:t[1],s:t[2],v:t[3],a:t[4]}:(t=Wt.hex8.exec(n))?{r:Dt(t[1]),g:Dt(t[2]),b:Dt(t[3]),a:Po(t[4]),format:e?"name":"hex8"}:(t=Wt.hex6.exec(n))?{r:Dt(t[1]),g:Dt(t[2]),b:Dt(t[3]),format:e?"name":"hex"}:(t=Wt.hex4.exec(n))?{r:Dt(t[1]+""+t[1]),g:Dt(t[2]+""+t[2]),b:Dt(t[3]+""+t[3]),a:Po(t[4]+""+t[4]),format:e?"name":"hex8"}:(t=Wt.hex3.exec(n))?{r:Dt(t[1]+""+t[1]),g:Dt(t[2]+""+t[2]),b:Dt(t[3]+""+t[3]),format:e?"name":"hex"}:!1}function vg(n){var e,t;return n=n||{level:"AA",size:"small"},e=(n.level||"AA").toUpperCase(),t=(n.size||"small").toLowerCase(),e!=="AA"&&e!=="AAA"&&(e="AA"),t!=="small"&&t!=="large"&&(t="small"),{level:e,size:t}}async function xg(n,e=5){const t=await Sg(n),i=document.createElement("canvas"),r=i.getContext("2d"),s=i.width=200,o=i.height=Math.max(1,Math.round(s*t.height/t.width));r.drawImage(t,0,0,s,o);const a=r.getImageData(0,0,s,o).data,l=[];for(let f=0;f<a.length;f+=4*8){const p=a[f],m=a[f+1],v=a[f+2],_=de({r:p,g:m,b:v}),{h:d,s:u,v:T}=_.toHsv();l.push([d/360,u,T])}let c=Array.from({length:e},(f,p)=>l[p*l.length/e|0]);for(let f=0;f<10;f++){const p=Array.from({length:e},()=>[]);for(const m of l){let v=0,_=1e9;for(let d=0;d<e;d++){const u=Mg(m,c[d]);u<_&&(_=u,v=d)}p[v].push(m)}for(let m=0;m<e;m++){const v=p[m];if(v.length){const _=[0,0,0];for(const d of v)_[0]+=d[0],_[1]+=d[1],_[2]+=d[2];c[m]=_.map(d=>d/v.length)}}}return c.sort((f,p)=>p[2]-f[2]).map(f=>de({h:f[0]*360,s:f[1],v:Math.min(1,f[2]*1.05)}).toHexString())}function Mg(n,e){const t=Math.min(Math.abs(n[0]-e[0]),1-Math.abs(n[0]-e[0])),i=Math.abs(n[1]-e[1]),r=Math.abs(n[2]-e[2]);return t*2+i+r}function Sg(n){return new Promise((e,t)=>{const i=new Image;i.crossOrigin="anonymous",i.onload=()=>e(i),i.onerror=t,i.src=n})}function Eg(){let n=performance.now(),e=0,t=0;function i(){const r=performance.now();e++,r-n>=1e3&&(t=e*1e3/(r-n),e=0,n=r),requestAnimationFrame(i)}return requestAnimationFrame(i),{value:()=>t}}function yg(){const n=document.createElement("canvas").getContext("webgl2")||document.createElement("canvas").getContext("webgl");if(!n)return"No WebGL";const e=n.getExtension("WEBGL_debug_renderer_info"),t=e?n.getParameter(e.UNMASKED_RENDERER_WEBGL):n.getParameter(n.RENDERER);return String(t||"WebGL")}function Lo(n){const e=Math.floor(n/1e3),t=Math.floor(e/60),i=e%60;return`${t}:${i.toString().padStart(2,"0")}`}let Ln=null,ms=[],Ri,Nl;function Tg(n,e){Nl=n,Ri=e}function bg(){if(!Ln||Ln.state==="inactive"){const n=Nl.captureStream(60);Ln=new MediaRecorder(n,{mimeType:"video/webm;codecs=vp9",videoBitsPerSecond:8e6}),ms=[],Ln.ondataavailable=e=>{e.data.size>0&&ms.push(e.data)},Ln.onstop=()=>{const e=new Blob(ms,{type:"video/webm"}),t=URL.createObjectURL(e),i=document.createElement("a");i.href=t,i.download=`dwdw-${new Date().toISOString().replace(/[:.]/g,"-")}.webm`,i.click(),URL.revokeObjectURL(t),Ri?.("saved"),setTimeout(()=>Ri?.("idle"),1e3)},Ln.start(),Ri?.("recording…")}else Ln.stop(),Ri?.("processing…")}const Do="927fda6918514f96903e828fcd6bb576",Ag=(()=>{const n=location.pathname.split("/").filter(Boolean);return n.length?`/${n[0]}/`:"/"})(),Uo=location.hostname==="127.0.0.1"||location.hostname==="localhost"?"http://127.0.0.1:5173/":`${location.origin}${Ag}`,wg=["user-read-private","user-read-email","user-read-playback-state","user-modify-playback-state","user-read-currently-playing","streaming"];function fe(n){return document.getElementById(n)}const D={loginBtn:null,playpauseBtn:null,prevBtn:null,nextBtn:null,seekRange:null,seekLabel:null,volumeRange:null,devicePicker:null,modeLabel:null,fpsLabel:null,gpuLabel:null,beatDot:null,scenePicker:null,vjIntensity:null,vjIntensityV:null,vjBloom:null,vjBloomV:null,vjGlitch:null,vjGlitchV:null,vjSpeed:null,vjSpeedV:null,midiStatus:null,qScale:null,qScaleV:null,qMSAA:null,qMSAAV:null,qTAA:null,qBloom:null,qBloomV:null,qSSAO:null,qMoBlur:null,qDOF:null,qToneMap:null,qChroma:null,qChromaV:null,qVol:null,qSteps:null,qStepsV:null,qSoft:null,qSoftV:null,qParticles:null,qParticlesV:null,qFluidRes:null,qFluidResV:null,qFluidIters:null,qFluidItersV:null,qWebGPU:null,accEpilepsy:null,accIntensity:null,accIntensityV:null,accReduced:null,accContrast:null,accSafe:null,fullscreen:null,recordToggle:null,recordStatus:null,coverImg:null,trackTitle:null,trackArtist:null,screensaver:null};function Rg(){D.loginBtn=fe("login-btn"),D.playpauseBtn=fe("playpause-btn"),D.prevBtn=fe("prev-btn"),D.nextBtn=fe("next-btn"),D.seekRange=fe("seek-range"),D.seekLabel=fe("seek-label"),D.volumeRange=fe("volume-range"),D.devicePicker=fe("device-picker"),D.modeLabel=fe("mode-label"),D.fpsLabel=fe("fps-label"),D.gpuLabel=fe("gpu-label"),D.beatDot=fe("beat-dot"),D.scenePicker=fe("scene-picker"),D.vjIntensity=fe("vj-intensity"),D.vjIntensityV=fe("vj-intensity-v"),D.vjBloom=fe("vj-bloom"),D.vjBloomV=fe("vj-bloom-v"),D.vjGlitch=fe("vj-glitch"),D.vjGlitchV=fe("vj-glitch-v"),D.vjSpeed=fe("vj-speed"),D.vjSpeedV=fe("vj-speed-v"),D.midiStatus=fe("midi-status"),D.qScale=fe("q-scale"),D.qScaleV=fe("q-scale-v"),D.qMSAA=fe("q-msaa"),D.qMSAAV=fe("q-msaa-v"),D.qTAA=fe("q-taa"),D.qBloom=fe("q-bloom"),D.qBloomV=fe("q-bloom-v"),D.qSSAO=fe("q-ssao"),D.qMoBlur=fe("q-moblur"),D.qDOF=fe("q-dof"),D.qToneMap=fe("q-tonemap"),D.qChroma=fe("q-chroma"),D.qChromaV=fe("q-chroma-v"),D.qVol=fe("q-vol"),D.qSteps=fe("q-steps"),D.qStepsV=fe("q-steps-v"),D.qSoft=fe("q-soft"),D.qSoftV=fe("q-soft-v"),D.qParticles=fe("q-particles"),D.qParticlesV=fe("q-particles-v"),D.qFluidRes=fe("q-fluid-res"),D.qFluidResV=fe("q-fluid-res-v"),D.qFluidIters=fe("q-fluid-iters"),D.qFluidItersV=fe("q-fluid-iters-v"),D.qWebGPU=fe("q-webgpu"),D.accEpilepsy=fe("acc-epilepsy"),D.accIntensity=fe("acc-intensity"),D.accIntensityV=fe("acc-intensity-v"),D.accReduced=fe("acc-reduced"),D.accContrast=fe("acc-contrast"),D.accSafe=fe("acc-safe"),D.fullscreen=fe("fullscreen-btn"),D.recordToggle=fe("record-toggle"),D.recordStatus=fe("record-status"),D.coverImg=fe("cover-img"),D.trackTitle=fe("track-title"),D.trackArtist=fe("track-artist"),D.screensaver=fe("screensaver")}let Tr=!1,Pi=null,Io=Date.now();function Cg(n){for(let e=0;e<5;e++)document.documentElement.style.setProperty(`--palette-${e}`,n[e]||"#666");document.documentElement.style.setProperty("--accent",n[0]||"#59ffa9"),document.documentElement.style.setProperty("--accent-2",n[1]||"#5aaaff"),document.documentElement.style.setProperty("--accent-3",n[2]||"#ff59be")}function Pg(){D.modeLabel&&(D.modeLabel.textContent=Tr?"In-page playback":"Device control")}async function No(){const n=await nc().catch(()=>[]);D.devicePicker&&(D.devicePicker.innerHTML="",n.forEach(e=>{const t=document.createElement("option");t.value=e.id||"",t.textContent=`${e.name} ${e.is_active?"•":""}`,D.devicePicker.appendChild(t),e.is_active&&(Pi=e.id||null)}),Pi&&(D.devicePicker.value=Pi))}function Lg(){const n=D,e=()=>{Um({renderScale:parseFloat(n.qScale?.value||"1"),msaa:parseInt(n.qMSAA?.value||"0"),taa:!!n.qTAA?.checked,bloom:parseFloat(n.qBloom?.value||"0"),ssao:!!n.qSSAO?.checked,motionBlur:!!n.qMoBlur?.checked,dof:!!n.qDOF?.checked,toneMap:n.qToneMap?.value||"filmic",chromaticAberration:parseFloat(n.qChroma?.value||"0"),volumetrics:!!n.qVol?.checked,raymarchSteps:parseInt(n.qSteps?.value||"384"),softShadowSamples:parseInt(n.qSoft?.value||"8"),particleCount:parseInt(n.qParticles?.value||"500000"),fluidResolution:parseInt(n.qFluidRes?.value||"384"),fluidIterations:parseInt(n.qFluidIters?.value||"20"),webgpuPathTrace:!!n.qWebGPU?.checked}),n.qScaleV&&n.qScale&&(n.qScaleV.textContent=`${parseFloat(n.qScale.value).toFixed(1)}x`),n.qMSAAV&&n.qMSAA&&(n.qMSAAV.textContent=n.qMSAA.value),n.qBloomV&&n.qBloom&&(n.qBloomV.textContent=n.qBloom.value),n.qChromaV&&n.qChroma&&(n.qChromaV.textContent=n.qChroma.value),n.qStepsV&&n.qSteps&&(n.qStepsV.textContent=n.qSteps.value),n.qSoftV&&n.qSoft&&(n.qSoftV.textContent=n.qSoft.value),n.qParticlesV&&n.qParticles&&(n.qParticlesV.textContent=`${(parseInt(n.qParticles.value)/1e6).toFixed(1)}M`),n.qFluidResV&&n.qFluidRes&&(n.qFluidResV.textContent=`${n.qFluidRes.value}²`),n.qFluidItersV&&n.qFluidIters&&(n.qFluidItersV.textContent=n.qFluidIters.value)},t=[n.qScale,n.qMSAA,n.qTAA,n.qBloom,n.qSSAO,n.qMoBlur,n.qDOF,n.qToneMap,n.qChroma,n.qVol,n.qSteps,n.qSoft,n.qParticles,n.qFluidRes,n.qFluidIters,n.qWebGPU];["input","change"].forEach(i=>t.forEach(r=>r?.addEventListener?.(i,e))),e()}function Dg(){const n=()=>{const t={epilepsySafe:!!D.accEpilepsy?.checked,intensityLimiter:parseFloat(D.accIntensity?.value||"1"),reducedMotion:!!D.accReduced?.checked,highContrast:!!D.accContrast?.checked};D.accIntensityV&&(D.accIntensityV.textContent=t.intensityLimiter.toFixed(2)),Im(t),Pl(!!D.accSafe?.checked),D.accSafe?.checked&&Vn("basic"),document.body.style.filter=t.highContrast?"contrast(1.15) saturate(1.15)":""},e=[D.accEpilepsy,D.accIntensity,D.accReduced,D.accContrast,D.accSafe];["input","change"].forEach(t=>e.forEach(i=>i?.addEventListener?.(t,n))),n()}function Ug(){const n=()=>{!D.vjIntensity||!D.vjBloom||!D.vjGlitch||!D.vjSpeed||(Nm({intensity:parseFloat(D.vjIntensity.value),bloom:parseFloat(D.vjBloom.value),glitch:parseFloat(D.vjGlitch.value),speed:parseFloat(D.vjSpeed.value)}),D.vjIntensityV&&(D.vjIntensityV.textContent=parseFloat(D.vjIntensity.value).toFixed(2)),D.vjBloomV&&(D.vjBloomV.textContent=parseFloat(D.vjBloom.value).toFixed(2)),D.vjGlitchV&&(D.vjGlitchV.textContent=parseFloat(D.vjGlitch.value).toFixed(2)),D.vjSpeedV&&(D.vjSpeedV.textContent=parseFloat(D.vjSpeed.value).toFixed(2)))};["input","change"].forEach(e=>{[D.vjIntensity,D.vjBloom,D.vjGlitch,D.vjSpeed].forEach(t=>t?.addEventListener?.(e,n))}),n(),D.scenePicker?.addEventListener?.("change",()=>{const e=D.scenePicker.value;Vn(e==="auto"?"basic":e)})}function Fo(){D.playpauseBtn?.addEventListener?.("click",async()=>{await ic().catch(()=>{})}),D.prevBtn?.addEventListener?.("click",async()=>{await sc().catch(()=>{})}),D.nextBtn?.addEventListener?.("click",async()=>{await rc().catch(()=>{})}),D.volumeRange?.addEventListener?.("input",async()=>{const e=parseInt(D.volumeRange.value);Tr?await lc(e).catch(()=>{}):await oc(e).catch(()=>{})}),D.seekRange?.addEventListener?.("change",async()=>{const e=parseInt(D.seekRange.value);await ac(e).catch(()=>{})}),D.devicePicker?.addEventListener?.("change",async()=>{const e=D.devicePicker.value;Pi=e,await Wo(e,!1).catch(()=>{})}),D.fullscreen?.addEventListener?.("click",async()=>{const e=document.documentElement;document.fullscreenElement?document.exitFullscreen?.():e.requestFullscreen?.()});const n=()=>{Io=Date.now(),D.screensaver?.classList.remove("active")};["mousemove","keydown","pointerdown","touchstart"].forEach(e=>window.addEventListener(e,n,{passive:!0})),setInterval(()=>{Date.now()-Io>3e4&&D.screensaver?.classList.add("active")},1e3)}function Ig(){const n=Dm();Tg(n,e=>{D.recordStatus&&(D.recordStatus.textContent=e),D.recordToggle&&(D.recordToggle.textContent=e.startsWith("recording")?"Stop":"Start")}),D.recordToggle?.addEventListener?.("click",()=>bg())}function Ng(){const n=document.getElementById("vis"),e=()=>{n&&Ll(n.clientWidth,n.clientHeight,window.devicePixelRatio)};window.addEventListener("resize",e),e();const t=Eg();setInterval(()=>{D.fpsLabel&&(D.fpsLabel.textContent=`FPS: ${t.value().toFixed(0)}`)},500),D.gpuLabel&&(D.gpuLabel.textContent=yg()+(Lm()?" • WebGL2":" • WebGL1"))}async function Oo(){const n=await qo().catch(()=>null);if(!n)return;const e=n.item?.duration_ms??0,t=n.progress_ms??0;if(e&&!isNaN(e)&&(D.seekRange&&!D.seekRange.matches(":active")&&(D.seekRange.max=String(e),D.seekRange.value=String(t)),D.seekLabel&&(D.seekLabel.textContent=`${Lo(t)} / ${Lo(e)}`)),n.item){D.trackTitle&&(D.trackTitle.textContent=n.item.name),D.trackArtist&&(D.trackArtist.textContent=n.item.artists.map(r=>r.name).join(", "));const i=n.item.album.images[0]?.url;if(i&&D.coverImg){const r=await Hm(n.item.id,i).catch(()=>null),s=r?.objectUrl??i;D.coverImg.src=s;const o=r?.palette??await xg(s).catch(()=>["#59ffa9","#5aaaff","#ff59be","#ffe459","#ff8a59"]);Cg(o),Fm(o.map(a=>a)),Vm(n.item.id,i,o).catch(()=>{})}km(n.item).catch(()=>{})}}async function Bo(){if(Rg(),D.loginBtn&&Wl({loginButton:D.loginBtn,clientId:Do,redirectUri:Uo,scopes:wg}),await Yl(Do,Uo),!await fr()){Fo();return}Kl(()=>fr()),Tr=await $l(),Pg();const e=document.getElementById("vis");await Pm(e),Lg(),Dg(),Ug(),Fo(),Ng(),Ig(),await ec(()=>fr(),async t=>{Pi=t,await No(),Tr&&(await tc(),await Wo(t,!0))},()=>{Oo()}),await No(),Vn("basic"),Bm(),Xm({onBeat:()=>{D.beatDot&&(D.beatDot.style.transform="scale(1.4)",D.beatDot.style.boxShadow="0 0 12px var(--accent)",setTimeout(()=>{D.beatDot.style.transform="scale(1.0)",D.beatDot.style.boxShadow="none"},120))},onPhraseBoundary:()=>{Om()}}),zm(60),setInterval(Oo,1e3)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",()=>{Bo().catch(n=>{console.error(n),alert("Initialization error. Check console.")})}):Bo().catch(n=>{console.error(n),alert("Initialization error. Check console.")});
