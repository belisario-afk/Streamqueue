...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function eo(){return new Gt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zs(),fragmentShader:`
		...
		`,blending:Mn,depthTest:!1,depthWrite:!1})}function to(){return new Gt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zs(),fragmentShader:`
	...
	`}function yf(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const c=a.mapping,l=c===Ms||c===Ss,h=c===ui||c===hi;if(l||h)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let d=e.get(a);return t===null&&(t=new Ja(n)),d=l?t.fromEquirectangular(a,d):t.fromCubemap(a,d),e.set(a,d),d.texture}else{if(e.has(a))return e.get(a).texture;{const d=a.image;if(l&&d&&d.height>0||h&&d&&r(d)){t===null&&(t=new Ja(n));const p=l?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,p),a.addEventListener("dispose",s),p.texture}else return null}}}return a}function r(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function Tf(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(i){i.isWebGL2?(t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance")):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(i){const r=t(i);return r===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function bf(n,e,t,i){const r={},s=new WeakMap;function o(d){const p=d.target;p.index!==null&&e.remove(p.index);for(const v in p.attributes)e.remove(p.attributes[v]);for(const v in p.morphAttributes){const _=p.morphAttributes[v];for(let f=0,u=_.length;f<u;f++)e.remove(_[f])}p.removeEventListener("dispose",o),delete r[p.id];const m=s.get(p);m&&(e.remove(m),s.delete(p)),i.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,t.memory.geometries--}function a(d,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,t.memory.geometries++),p}function c(d){const p=d.attributes;for(const v in p)e.update(p[v],n.ARRAY_BUFFER);const m=d.morphAttributes;for(const v in m){const _=m[v];for(let f=0,u=_.length;f<u;f++)e.update(_[f],n.ARRAY_BUFFER)}}function l(d){const p=[],m=d.index,v=d.attributes.position;let _=0;if(m!==null){const T=m.array;_=m.version;for(let E=0,b=T.length;E<b;E+=3){const L=T[E+0],R=T[E+1],w=T[E+2];p.push(L,R,R,w,w,L)}}else if(v!==void 0){const T=v.array;_=v.version;for(let E=0,b=T.length/3-1;E<b;E+=3){const L=E+0,R=E+1,w=E+2;p.push(L,R,R,w,w,L)}}else return;const f=new(ic(p)?dc:hc)(p,1);f.version=_;const u=s.get(d);u&&e.remove(u),s.set(d,f)}function h(d){const p=s.get(d);if(p){const m=d.index;m!==null&&p.version<m.version&&l(d)}else l(d);return s.get(d)}return{get:a,update:c,getWireframeAttribute:h}}function Af(n,e,t,i){const r=i.isWebGL2;let s;function o(m){s=m}let a,c;function l(m){a=m.type,c=m.bytesPerElement}function h(m,v){n.drawElements(s,v,a,m*c),t.update(v,s,1)}function d(m,v,_){if(_===0)return;let f,u;if(r)f=n,u="drawElementsInstanced";else if(f=e.get("ANGLE_instanced_arrays"),u="drawElementsInstancedANGLE",f===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}f[u](s,v,a,m*c,_),t.update(v,s,_)}function p(m,v,_){if(_===0)return;const f=e.get("WEBGL_multi_draw");if(f===null)for(let u=0;u<_;u++)this.render(m[u]/c,v[u]);else{f.multiDrawElementsWEBGL(s,v,0,a,m,0,_);let u=0;for(let T=0;T<_;T++)u+=v[T];t.update(u,s,1)}}this.setMode=o,this.setIndex=l,this.render=h,this.renderInstances=d,this.renderMultiDraw=p}function wf(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function Rf(n,e){return n[0]-e[0]}function Cf(n,e){return Math.abs(e[1])-Math.abs(n[1])}function Pf(n,e,t){const i={},r=new Float32Array(8),s=new WeakMap,o=new dt,a=[];for(let l=0;l<8;l++)a[l]=[l,0];function c(l,h,d){const p=l.morphTargetInfluences;if(e.isWebGL2===!0){const v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=v!==void 0?v.length:0;let f=s.get(h);if(f===void 0||f.count!==_){let B=function(){ie.dispose(),s.delete(h),h.removeEventListener("dispose",B)};var m=B;f!==void 0&&f.texture.dispose();const E=h.morphAttributes.position!==void 0,b=h.morphAttributes.normal!==void 0,L=h.morphAttributes.color!==void 0,R=h.morphAttributes.position||[],w=h.morphAttributes.normal||[],K=h.morphAttributes.color||[];let S=0;E===!0&&(S=1),b===!0&&(S=2),L===!0&&(S=3);let y=h.attributes.position.count*S,G=1;y>e.maxTextureSize&&(G=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const V=new Float32Array(y*G*4*_),ie=new ac(V,y,G,_);ie.type=xn,ie.needsUpdate=!0;const C=S*4;for(let H=0;H<_;H++){const X=R[H],k=w[H],W=K[H],q=y*G*4*H;for(let Q=0;Q<X.count;Q++){const ee=Q*C;E===!0&&(o.fromBufferAttribute(X,Q),V[q+ee+0]=o.x,V[q+ee+1]=o.y,V[q+ee+2]=o.z,V[q+ee+3]=0),b===!0&&(o.fromBufferAttribute(k,Q),V[q+ee+4]=o.x,V[q+ee+5]=o.y,V[q+ee+6]=o.z,V[q+ee+7]=0),L===!0&&(o.fromBufferAttribute(W,Q),V[q+ee+8]=o.x,V[q+ee+9]=o.y,V[q+ee+10]=o.z,V[q+ee+11]=W.itemSize===4?o.w:1)}}f={count:_,texture:ie,size:new We(y,G)},s.set(h,f),h.addEventListener("dispose",B)}let u=0;for(let E=0;E<p.length;E++)u+=p[E];const T=h.morphTargetsRelative?1:1-u;d.getUniforms().setValue(n,"morphTargetBaseInfluence",T),d.getUniforms().setValue(n,"morphTargetInfluences",p),d.getUniforms().setValue(n,"morphTargetsTexture",f.texture,t),d.getUniforms().setValue(n,"morphTargetsTextureSize",f.size)}else{const v=p===void 0?0:p.length;let _=i[h.id];if(_===void 0||_.length!==v){_=[];for(let b=0;b<v;b++)_[b]=[b,0];i[h.id]=_}for(let b=0;b<v;b++){const L=_[b];L[0]=b,L[1]=p[b]}_.sort(Cf);for(let b=0;b<8;b++)b<v&&_[b][1]?(a[b][0]=_[b][0],a[b][1]=_[b][1]):(a[b][0]=Number.MAX_SAFE_INTEGER,a[b][1]=0);a.sort(Rf);const f=h.morphAttributes.position,u=h.morphAttributes.normal;let T=0;for(let b=0;b<8;b++){const L=a[b],R=L[0],w=L[1];R!==Number.MAX_SAFE_INTEGER&&w?(f&&h.getAttribute("morphTarget"+b)!==f[R]&&h.setAttribute("morphTarget"+b,f[R]),u&&h.getAttribute("morphNormal"+b)!==u[R]&&h.setAttribute("morphNormal"+b,u[R]),r[b]=w,T+=w):(f&&h.hasAttribute("morphTarget"+b)===!0&&h.deleteAttribute("morphTarget"+b),u&&h.hasAttribute("morphNormal"+b)===!0&&h.deleteAttribute("morphNormal"+b),r[b]=0)}const E=h.morphTargetsRelative?1:1-T;d.getUniforms().setValue(n,"morphTargetBaseInfluence",E),d.getUniforms().setValue(n,"morphTargetInfluences",r)}}return{update:c}}function Lf(n,e,t,i){let r=new WeakMap;function s(c){const l=i.render.frame,h=c.geometry,d=e.get(c,h);if(r.get(d)!==l&&(e.update(d),r.set(d,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),r.get(c)!==l&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),r.set(c,l))),c.isSkinnedMesh){const p=c.skeleton;r.get(p)!==l&&(p.update(),r.set(p,l))}return d}function o(){r=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}class vc extends Ut{constructor(e,t,i,r,s,o,a,c,l,h){if(h=h!==void 0?h:Hn,h!==Hn&&h!==fi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&h===Hn&&(i=vn),i===void 0&&h===fi&&(i=zn),super(null,r,s,o,a,c,h,i,l),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:yt,this.minFilter=c!==void 0?c:yt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const xc=new Ut,Mc=new vc(1,1);Mc.compareFunction=nc;const Sc=new ac,Ec=new pu,yc=new mc,no=[],io=[],ro=new Float32Array(16),so=new Float32Array(9),ao=new Float32Array(4);function vi(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=no[r];if(s===void 0&&(s=new Float32Array(r),no[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function ot(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function ct(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Ir(n,e){let t=io[e];t===void 0&&(t=new Int32Array(e),io[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Df(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Uf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;n.uniform2fv(this.addr,e),ct(t,e)}}function If(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(ot(t,e))return;n.uniform3fv(this.addr,e),ct(t,e)}}function Nf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;n.uniform4fv(this.addr,e),ct(t,e)}}function Ff(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ot(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),ct(t,e)}else{if(ot(t,i))return;ao.set(i),n.uniformMatrix2fv(this.addr,!1,ao),ct(t,i)}}function Of(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ot(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),ct(t,e)}else{if(ot(t,i))return;so.set(i),n.uniformMatrix3fv(this.addr,!1,so),ct(t,i)}}function Bf(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(ot(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),ct(t,e)}else{if(ot(t,i))return;ro.set(i),n.uniformMatrix4fv(this.addr,!1,ro),ct(t,i)}}function zf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Hf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;n.uniform2iv(this.addr,e),ct(t,e)}}function Gf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ot(t,e))return;n.uniform3iv(this.addr,e),ct(t,e)}}function kf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;n.uniform4iv(this.addr,e),ct(t,e)}}function Vf(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function Wf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(ot(t,e))return;n.uniform2uiv(this.addr,e),ct(t,e)}}function Xf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(ot(t,e))return;n.uniform3uiv(this.addr,e),ct(t,e)}}function qf(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(ot(t,e))return;n.uniform4uiv(this.addr,e),ct(t,e)}}function Yf(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);const s=this.type===n.SAMPLER_2D_SHADOW?Mc:xc;t.setTexture2D(e||s,r)}function jf(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Ec,r)}function $f(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||yc,r)}function Kf(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Sc,r)}function Zf(n){switch(n){case 5126:return Df;case 35664:return Uf;case 35665:return If;case 35666:return Nf;case 35674:return Ff;case 35675:return Of;case 35676:return Bf;case 5124:case 35670:return zf;case 35667:case 35671:return Hf;case 35668:case 35672:return Gf;case 35669:case 35673:return kf;case 5125:return Vf;case 36294:return Wf;case 36295:return Xf;case 36296:return qf;case 35678:case 36198:case 36298:case 36306:case 35682:return Yf;case 35679:case 36299:case 36307:return jf;case 35680:case 36300:case 36308:case 36293:return $f;case 36289:case 36303:case 36311:case 36292:return Kf}}function Jf(n,e){n.uniform1fv(this.addr,e)}function Qf(n,e){const t=vi(e,this.size,2);n.uniform2fv(this.addr,t)}function ep(n,e){const t=vi(e,this.size,3);n.uniform3fv(this.addr,t)}function tp(n,e){const t=vi(e,this.size,4);n.uniform4fv(this.addr,t)}function np(n,e){const t=vi(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function ip(n,e){const t=vi(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function rp(n,e){const t=vi(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function sp(n,e){n.uniform1iv(this.addr,e)}function ap(n,e){n.uniform2iv(this.addr,e)}function op(n,e){n.uniform3iv(this.addr,e)}function cp(n,e){n.uniform4iv(this.addr,e)}function lp(n,e){n.uniform1uiv(this.addr,e)}function up(n,e){n.uniform2uiv(this.addr,e)}function hp(n,e){n.uniform3uiv(this.addr,e)}function dp(n,e){n.uniform4uiv(this.addr,e)}function fp(n,e,t){const i=this.cache,r=e.length,s=Ir(t,r);ot(i,s)||(n.uniform1iv(this.addr,s),ct(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||xc,s[o])}function pp(n,e,t){const i=this.cache,r=e.length,s=Ir(t,r);ot(i,s)||(n.uniform1iv(this.addr,s),ct(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||Ec,s[o])}function mp(n,e,t){const i=this.cache,r=e.length,s=Ir(t,r);ot(i,s)||(n.uniform1iv(this.addr,s),ct(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||yc,s[o])}function gp(n,e,t){const i=this.cache,r=e.length,s=Ir(t,r);ot(i,s)||(n.uniform1iv(this.addr,s),ct(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||Sc,s[o])}function _p(n){switch(n){case 5126:return Jf;case 35664:return Qf;case 35665:return ep;case 35666:return tp;case 35674:return np;case 35675:return ip;case 35676:return rp;case 5124:case 35670:return sp;case 35667:case 35671:return ap;case 35668:case 35672:return op;case 35669:case 35673:return cp;case 5125:return lp;case 36294:return up;case 36295:return hp;case 36296:return dp;case 35678:case 36198:case 36298:case 36306:case 35682:return fp;case 35679:case 36299:case 36307:return pp;case 35680:case 36300:case 36308:case 36293:return mp;case 36289:case 36303:case 36311:case 36292:return gp}}class vp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Zf(t.type)}}class xp{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=_p(t.type)}}class Mp{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const ms=/(\w+)(\])?(\[|\.)?/g;function oo(n,e){n.seq.push(e),n.map[e.id]=e}function Sp(n,e,t){const i=n.name,r=i.length;for(ms.lastIndex=0;;){const s=ms.exec(i),o=ms.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===r){oo(t,l===void 0?new vp(a,n,e):new xp(a,n,e));break}else{let d=t.map[a];d===void 0&&(d=new Mp(a),oo(t,d)),t=d}}}class mr{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);Sp(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function co(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Ep=37297;let yp=0;function Tp(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}function bp(n){const e=Ye.getPrimaries(Ye.workingColorSpace),t=Ye.getPrimaries(n);let i;switch(e===t?i="":e===yr&&t===Er?i="LinearDisplayP3ToLinearSRGB":e===Er&&t===yr&&(i="LinearSRGBToLinearDisplayP3"),n){case un:case Lr:return[i,"LinearTransferOETF"];case ft:case Os:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function lo(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+Tp(n.getShaderSource(e),o)}else return r}function Ap(n,e){const t=bp(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function wp(n,e){let t;switch(e){case Fl:t="Linear";break;case Ol:t="Reinhard";break;case Bl:t="OptimizedCineon";break;case zl:t="ACESFilmic";break;case Gl:t="AgX";break;case Hl:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function Rp(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(oi).join(`
`)}function Cp(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter(oi).join(`
`)}function Pp(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function Lp(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function oi(n){return n!==""}function uo(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ho(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Dp=/^[ \t]*#include +<([\w\d./]+)>/gm;function ws(n){return n.replace(Dp,Ip)}const Up=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Ip(n,e){let t=Ie[e];if(t===void 0){const i=Up.get(e);if(i!==void 0)t=Ie[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return ws(t)}const Np=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function fo(n){return n.replace(Np,Fp)}function Fp(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function po(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Op(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===Xo?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===ul?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===an&&(e="SHADOWMAP_TYPE_VSM"),e}function Bp(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case ui:case hi:e="ENVMAP_TYPE_CUBE";break;case Pr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function zp(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case hi:e="ENVMAP_MODE_REFRACTION";break}return e}function Hp(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case qo:e="ENVMAP_BLENDING_MULTIPLY";break;case Il:e="ENVMAP_BLENDING_MIX";break;case Nl:e="ENVMAP_BLENDING_ADD";break}return e}function Gp(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function kp(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Op(t),l=Bp(t),h=zp(t),d=Hp(t),p=Gp(t),m=t.isWebGL2?"":Rp(t),v=Cp(t),_=Pp(s),f=r.createProgram();let u,T,E=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `,wireframe:!1}),this.mesh=new Ht(t,this.mat),this.mesh.rotation.x=-Math.PI/3,this.mesh.position.y=-2,this.scene.add(this.mesh);const i=new Sm(16777215,.2);i.position.set(3,5,2),this.scene.add(i)}scene=new Hi;name="terrain";mesh;mat;palette=["#59ffa9","#5aaaff","#ff59be","#ffe459","#ff8a59"];params={intensity:.7,speed:1};start(){}stop(){this.mesh.geometry.dispose(),this.mat.dispose()}update(e,t){this.mat.uniforms.uTime.value=t}setPalette(e){this.palette=e,this.mat.uniforms.uPalette.value=e.map(t=>new Le(t))}onMacro(e,t){e==="intensity"&&(this.mat.uniforms.uIntensity.value=t),e==="speed"&&(this.mat.uniforms.uSpeed.value=t)}onExplode(){this.mat.uniforms.uIntensity.value=Math.min(3,this.mat.uniforms.uIntensity.value+.6),setTimeout(()=>this.mat.uniforms.uIntensity.value=.7,600)}}class Am{constructor(e){this.opts=e;const t=new Vn(2,1);this.mat=new Gt({uniforms:{uTime:{value:0},uPalette:{value:this.palette.map(i=>new Le(i))},uIntensity:{value:this.params.intensity}},vertexShader:`
        ...
        }`,transparent:!0}),this.mesh=new Ht(t,this.mat),this.group.add(this.mesh),this.scene.add(this.group)}scene=new Hi;name="type";group=new Ai;mat;mesh;palette=["#59ffa9","#5aaaff","#ff59be","#ffe459","#ff8a59"];params={intensity:.8,speed:1,weight:400,stretch:100};start(){}stop(){this.mesh.geometry.dispose(),this.mat.dispose()}update(e,t){this.mat.uniforms.uTime.value=t*this.params.speed,this.group.rotation.y=Math.sin(t*.2)*.2,this.group.position.z=-1.5}setPalette(e){this.palette=e,this.mat.uniforms.uPalette.value=e.map(t=>new Le(t))}onMacro(e,t){e==="intensity"&&(this.mat.uniforms.uIntensity.value=t),e==="speed"&&(this.params.speed=t)}onExplode(){this.params.speed=2.5,setTimeout(()=>this.params.speed=1,600)}}let Ve,vt,rt,Ft=null,yn,ln,mi,gi=["#59ffa9","#5aaaff","#ff59be","#ffe459","#ff8a59"],Ac=60,wc=new Em;const Rc={particles:bc,fluid:ym,tunnel:Tm,terrain:bm,type:Am};async function wm(n){yn=n,Ve=new Tc({canvas:n,antialias:!1,powerPreference:"high-performance",alpha:!1,depth:!0,stencil:!1,preserveDrawingBuffer:!1}),Ve.debug.checkShaderErrors=!0,Ve.autoClear=!0,Ve.setPixelRatio(Math.min(window.devicePixelRatio,2));const e=n.clientWidth||window.innerWidth||1280,t=n.clientHeight||window.innerHeight||720;Ve.setSize(e,t,!1),Ve.setClearColor(263174,1),vt=new Ot(60,e/t,.1,2e3),vt.position.set(0,0,5),ln={renderScale:1,msaa:0,taa:!1,bloom:.8,ssao:!0,motionBlur:!1,dof:!1,toneMap:"filmic",chromaticAberration:.12,volumetrics:!0,raymarchSteps:512,softShadowSamples:16,particleCount:1e6,fluidResolution:512,fluidIterations:30,webgpuPathTrace:!1},mi={epilepsySafe:!1,intensityLimiter:1,reducedMotion:!1,highContrast:!1},rt=new bc({renderer:Ve,camera:vt,quality:()=>ln,accessibility:()=>mi,palette:()=>gi}),rt.start(),window.addEventListener("vj-macro",i=>{rt.onMacro?.(i.detail.name,i.detail.value)}),window.addEventListener("vj-explode",()=>{rt.onExplode?.()}),window.addEventListener("vj-scene",i=>{Ii(i.detail.scene,1.2)})}function Cc(){return!!Ve?.capabilities.isWebGL2}function Gs(){return Cc()?["particles","fluid","tunnel","terrain","type"]:["particles","type"]}function Rm(){return yn}function Pc(n,e,t){if(!Ve||!vt||!yn)return;const i=Math.max(1,n||yn.clientWidth||window.innerWidth||1),r=Math.max(1,e||yn.clientHeight||window.innerHeight||1),s=Math.max(1,Math.min(t||window.devicePixelRatio||1,2))*(ln?.renderScale||1);Ve.setPixelRatio(s),Ve.setSize(i,r,!1),vt.aspect=i/r,vt.updateProjectionMatrix()}function Cm(n){ln={...ln,...n},!(!Ve||!yn)&&(Pc(yn.clientWidth,yn.clientHeight,window.devicePixelRatio),rt.setQuality?.(ln),Ft?.setQuality?.(ln))}function Pm(n){mi={...mi,...n}}function Lm(n){n.intensity!==void 0&&rt.onMacro?.("intensity",n.intensity),n.bloom!==void 0&&rt.onMacro?.("bloom",n.bloom),n.glitch!==void 0&&rt.onMacro?.("glitch",n.glitch),n.speed!==void 0&&rt.onMacro?.("speed",n.speed)}function Ar(n){const t=new Set(Gs()).has(n)?n:"particles",i=Rc[t];if(!(!i||!Ve||!vt)){try{rt.stop()}catch{}rt=new i({renderer:Ve,camera:vt,quality:()=>ln,accessibility:()=>mi,palette:()=>gi}),rt.setPalette(gi),rt.start()}}function Ii(n,e=1){const i=new Set(Gs()).has(n)?n:"particles",r=Rc[i];if(!r||!Ve||!vt)return;const s=Ve.getContext?Ve.getContext():null;if(!s){Ar(i);return}try{Ft&&(Ft.stop(),Ft=null),Ft=new r({renderer:Ve,camera:vt,quality:()=>ln,accessibility:()=>mi,palette:()=>gi}),Ft.setPalette(gi),Ft.start();const o=performance.now(),a=()=>{if(!Ve||!vt||!Ft)return;const c=(performance.now()-o)/1e3,l=Math.min(1,e>0?c/e:1);if(Dm(rt,Ft,1-l,l,s),l<1)requestAnimationFrame(a);else{try{rt.stop()}catch{}rt=Ft,Ft=null}};a()}catch{Ar(i)}}function Dm(n,e,t,i,r){const s=wc.getDelta(),o=performance.now()/1e3;n.update(s,o),e.update(s,o),!(!Ve||!vt)&&(r.enable(r.BLEND),r.blendFunc(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA),Ve.autoClear=!0,Ve.setClearAlpha(1),Ve.clear(),Ve.state.setBlending?.(Bn,vr,xr),Ve.setClearAlpha(t),Ve.render(n.scene,vt),Ve.setClearAlpha(i),Ve.render(e.scene,vt),Ve.setClearAlpha(1),r.disable(r.BLEND))}function Um(n){gi=n,rt.setPalette(n),Ft?.setPalette(n)}function gr(){const n=Gs(),e=Math.floor(Date.now()/1e4%n.length);Ar(n[e])}function Im(){const n=()=>{const e=wc.getDelta(),t=performance.now()/1e3;if(1/Math.max(e,1e-6)<Ac-5?rt.onMacro?.("speed",.9):rt.onMacro?.("speed",1),rt.update(e,t),Ve&&vt)try{Ve.render(rt.scene,vt)}catch{}requestAnimationFrame(n)};requestAnimationFrame(n)}function Nm(n){Ac=n}function ks(n){return new Promise((e,t)=>{n.oncomplete=n.onsuccess=()=>e(n.result),n.onabort=n.onerror=()=>t(n.error)})}function Fm(n,e){let t;const i=()=>{if(t)return t;const r=indexedDB.open(n);return r.onupgradeneeded=()=>r.result.createObjectStore(e),t=ks(r),t.then(s=>{s.onclose=()=>t=void 0},()=>{}),t};return(r,s)=>i().then(o=>s(o.transaction(e,r).objectStore(e)))}let vs;function Lc(){return vs||(vs=Fm("keyval-store","keyval")),vs}function Vs(n,e=Lc()){return e("readonly",t=>ks(t.get(n)))}function wr(n,e,t=Lc()){return t("readwrite",i=>(i.put(e,n),ks(i.transaction)))}async function Om(n,e){const t=`cover:${n}`,i=await Vs(t);return!i||i.url!==e?null:(i.blob&&!i.objectUrl&&(i.objectUrl=URL.createObjectURL(i.blob)),i)}async function Bm(n,e,t){const i=`cover:${n}`,r=await Vs(i);r?await wr(i,{...r,palette:t}):await wr(i,{url:e,palette:t})}async function zm(n){await wr(`track:${n.id}`,n)}async function Hm(n,e){await wr(`analysis:${n}`,e)}async function Gm(n){return Vs(`analysis:${n}`)}let Cs=[],Ps=[],ci=null,bi=0,yo=!0,On=[];function fr(n){return Math.round(n*1e3)}function km(n){const{onBeat:e,onPhraseBoundary:t}=n,i=document.getElementById("dir-auto-crossfade");i.addEventListener("change",()=>yo=i.checked);const r=document.getElementById("dir-add"),s=document.getElementById("dir-bar-num"),o=document.getElementById("dir-cue-type"),a=document.getElementById("dir-list"),c=document.getElementById("dir-clear"),l=()=>{if(!On.length){a.textContent="No cues";return}a.innerHTML=On.map(h=>`<div class="chip">bar ${h.bar} → ${h.action}</div>`).join(" ")};r.addEventListener("click",()=>{const h=parseInt(s.value),d=o.value;Number.isFinite(h)&&(On.push({bar:h,action:d}),l(),To())}),c.addEventListener("click",()=>{On=[],l(),To()}),setInterval(async()=>{const h=await Kc();if(!h?.item)return;h.item.id!==ci&&(ci=h.item.id,await Vm(ci),bi=0,await Wm(ci),l());const d=h.progress_ms;Cs.findIndex(f=>fr(f.start)<=d&&d<fr(f.start+f.duration))>=0&&e();const m=Ps.findIndex(f=>fr(f.start)<=d&&d<fr(f.start+f.duration));if(m>=0&&m%4===0&&bi!==m/4&&(bi=m/4,t(bi),yo)){const f=["particles","fluid","tunnel","terrain","type"],u=bi%f.length;Ii(f[u],1.5)}const v=Math.max(0,m),_=On.filter(f=>f.bar===v+1);for(const f of _)if(f.action==="explode"){const u=new CustomEvent("vj-explode");window.dispatchEvent(u)}else if(f.action.startsWith("scene:")){const u=f.action.split(":")[1];Ii(u,1.2)}},250)}async function Vm(n){const e=await Gm(n);if(e){Cs=e.analysis.beats,Ps=e.analysis.bars,e.analysis.sections;return}const{feats:t,analysis:i}=await Jc(n);Cs=i.beats,Ps=i.bars,i.sections,Hm(n,{features:t,analysis:i}).catch(()=>{})}async function To(){ci&&localStorage.setItem(`dwdw.cues:${ci}`,JSON.stringify(On))}async function Wm(n){const e=localStorage.getItem(`dwdw.cues:${n}`);On=e?JSON.parse(e):[]}function Rr(n){"@babel/helpers - typeof";return Rr=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Rr(n)}var Xm=/^\s+/,qm=/\s+$/;function de(n,e){if(n=n||"",e=e||{},n instanceof de)return n;if(!(this instanceof de))return new de(n,e);var t=Ym(n);this._originalInput=n,this._r=t.r,this._g=t.g,this._b=t.b,this._a=t.a,this._roundA=Math.round(100*this._a)/100,this._format=e.format||t.format,this._gradientType=e.gradientType,this._r<1&&(this._r=Math.round(this._r)),this._g<1&&(this._g=Math.round(this._g)),this._b<1&&(this._b=Math.round(this._b)),this._ok=t.ok}de.prototype={isDark:function(){return this.getBrightness()<128},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var e=this.toRgb();return(e.r*299+e.g*587+e.b*114)/1e3},getLuminance:function(){var e=this.toRgb(),t,i,r,s,o,a;return t=e.r/255,i=e.g/255,r=e.b/255,t<=.03928?s=t/12.92:s=Math.pow((t+.055)/1.055,2.4),i<=.03928?o=i/12.92:o=Math.pow((i+.055)/1.055,2.4),r<=.03928?a=r/12.92:a=Math.pow((r+.055)/1.055,2.4),.2126*s+.7152*o+.0722*a},setAlpha:function(e){return this._a=Dc(e),this._roundA=Math.round(100*this._a)/100,this},toHsv:function(){var e=Ao(this._r,this._g,this._b);return{h:e.h*360,s:e.s,v:e.v,a:this._a}},toHsvString:function(){var e=Ao(this._r,this._g,this._b),t=Math.round(e.h*360),i=Math.round(e.s*100),r=Math.round(e.v*100);return this._a==1?"hsv("+t+", "+i+"%, "+r+"%)":"hsva("+t+", "+i+"%, "+r+"%, "+this._roundA+")"},toHsl:function(){var e=bo(this._r,this._g,this._b);return{h:e.h*360,s:e.s,l:e.l,a:this._a}},toHslString:function(){var e=bo(this._r,this._g,this._b),t=Math.round(e.h*360),i=Math.round(e.s*100),r=Math.round(e.l*100);return this._a==1?"hsl("+t+", "+i+"%, "+r+"%)":"hsla("+t+", "+i+"%, "+r+"%, "+this._roundA+")"},toHex:function(e){return wo(this._r,this._g,this._b,e)},toHexString:function(e){return"#"+this.toHex(e)},toHex8:function(e){return Zm(this._r,this._g,this._b,this._a,e)},toHex8String:function(e){return"#"+this.toHex8(e)},toRgb:function(){return{r:Math.round(this._r),g:Math.round(this._g),b:Math.round(this._b),a:this._a}},toRgbString:function(){return this._a==1?"rgb("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+")":"rgba("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+", "+this._roundA+")"},toPercentageRgb:function(){return{r:Math.round(Je(this._r,255)*100)+"%",g:Math.round(Je(this._g,255)*100)+"%",b:Math.round(Je(this._b,255)*100)+"%",a:this._a}},toPercentageRgbString:function(){return this._a==1?"rgb("+Math.round(Je(this._r,255)*100)+"%, "+Math.round(Je(this._g,255)*100)+"%, "+Math.round(Je(this._b,255)*100)+"%)":"rgba("+Math.round(Je(this._r,255)*100)+"%, "+Math.round(Je(this._g,255)*100)+"%, "+Math.round(Je(this._b,255)*100)+"%, "+this._roundA+")"},toName:function(){return this._a===0?"transparent":this._a<1?!1:lg[wo(this._r,this._g,this._b,!0)]||!1},toFilter:function(e){var t="#"+Ro(this._r,this._g,this._b,this._a),i=t,r=this._gradientType?"GradientType = 1, ":"";if(e){var s=de(e);i="#"+Ro(s._r,s._g,s._b,s._a)}return"progid:DXImageTransform.Microsoft.gradient("+r+"startColorstr="+t+",endColorstr="+i+")"},toString:function(e){var t=!!e;e=e||this._format;var i=!1,r=this._a<1&&this._a>=0,s=!t&&r&&(e==="hex"||e==="hex6"||e==="hex3"||e==="hex4"||e==="hex8"||e==="name");return s?e==="name"&&this._a===0?this.toName():this.toRgbString():(e==="rgb"&&(i=this.toRgbString()),e==="prgb"&&(i=this.toPercentageRgbString()),(e==="hex"||e==="hex6")&&(i=this.toHexString()),e==="hex3"&&(i=this.toHexString(!0)),e==="hex4"&&(i=this.toHex8String(!0)),e==="hex8"&&(i=this.toHex8String()),e==="name"&&(i=this.toName()),e==="hsl"&&(i=this.toHslString()),e==="hsv"&&(i=this.toHsvString()),i||this.toHexString())},clone:function(){return de(this.toString())},_applyModification:function(e,t){var i=e.apply(null,[this].concat([].slice.call(t)));return this._r=i._r,this._g=i._g,this._b=i._b,this.setAlpha(i._a),this},lighten:function(){return this._applyModification(tg,arguments)},brighten:function(){return this._applyModification(ng,arguments)},darken:function(){return this._applyModification(ig,arguments)},desaturate:function(){return this._applyModification(Jm,arguments)},saturate:function(){return this._applyModification(Qm,arguments)},greyscale:function(){return this._applyModification(eg,arguments)},spin:function(){return this._applyModification(rg,arguments)},_applyCombination:function(e,t){return e.apply(null,[this].concat([].slice.call(t)))},analogous:function(){return this._applyCombination(og,arguments)},complement:function(){return this._applyCombination(sg,arguments)},monochromatic:function(){return this._applyCombination(cg,arguments)},splitcomplement:function(){return this._applyCombination(ag,arguments)},triad:function(){return this._applyCombination(Co,[3])},tetrad:function(){return this._applyCombination(Co,[4])}};de.fromRatio=function(n,e){if(Rr(n)=="object"){var t={};for(var i in n)n.hasOwnProperty(i)&&(i==="a"?t[i]=n[i]:t[i]=wi(n[i]));n=t}return de(n,e)};function Ym(n){var e={r:0,g:0,b:0},t=1,i=null,r=null,s=null,o=!1,a=!1;return typeof n=="string"&&(n=fg(n)),Rr(n)=="object"&&(sn(n.r)&&sn(n.g)&&sn(n.b)?(e=jm(n.r,n.g,n.b),o=!0,a=String(n.r).substr(-1)==="%"?"prgb":"rgb"):sn(n.h)&&sn(n.s)&&sn(n.v)?(i=wi(n.s),r=wi(n.v),e=Km(n.h,i,r),o=!0,a="hsv"):sn(n.h)&&sn(n.s)&&sn(n.l)&&(i=wi(n.s),s=wi(n.l),e=$m(n.h,i,s),o=!0,a="hsl"),n.hasOwnProperty("a")&&(t=n.a)),t=Dc(t),{ok:o,format:n.format||a,r:Math.min(255,Math.max(e.r,0)),g:Math.min(255,Math.max(e.g,0)),b:Math.min(255,Math.max(e.b,0)),a:t}}function jm(n,e,t){return{r:Je(n,255)*255,g:Je(e,255)*255,b:Je(t,255)*255}}function bo(n,e,t){n=Je(n,255),e=Je(e,255),t=Je(t,255);var i=Math.max(n,e,t),r=Math.min(n,e,t),s,o,a=(i+r)/2;if(i==r)s=o=0;else{var c=i-r;switch(o=a>.5?c/(2-i-r):c/(i+r),i){case n:s=(e-t)/c+(e<t?6:0);break;case e:s=(t-n)/c+2;break;case t:s=(n-e)/c+4;break}s/=6}return{h:s,s:o,l:a}}function $m(n,e,t){var i,r,s;n=Je(n,360),e=Je(e,100),t=Je(t,100);function o(l,h,d){return d<0&&(d+=1),d>1&&(d-=1),d<1/6?l+(h-l)*6*d:d<1/2?h:d<2/3?l+(h-l)*(2/3-d)*6:l}if(e===0)i=r=s=t;else{var a=t<.5?t*(1+e):t+e-t*e,c=2*t-a;i=o(c,a,n+1/3),r=o(c,a,n),s=o(c,a,n-1/3)}return{r:i*255,g:r*255,b:s*255}}function Ao(n,e,t){n=Je(n,255),e=Je(e,255),t=Je(t,255);var i=Math.max(n,e,t),r=Math.min(n,e,t),s,o,a=i,c=i-r;if(o=i===0?0:c/i,i==r)s=0;else{switch(i){case n:s=(e-t)/c+(e<t?6:0);break;case e:s=(t-n)/c+2;break;case t:s=(n-e)/c+4;break}s/=6}return{h:s,s:o,v:a}}function Km(n,e,t){n=Je(n,360)*6,e=Je(e,100),t=Je(t,100);var i=Math.floor(n),r=n-i,s=t*(1-e),o=t*(1-r*e),a=t*(1-(1-r)*e),c=i%6,l=[t,o,s,s,a,t][c],h=[a,t,t,o,s,s][c],d=[s,s,a,t,t,o][c];return{r:l*255,g:h*255,b:d*255}}function wo(n,e,t,i){var r=[jt(Math.round(n).toString(16)),jt(Math.round(e).toString(16)),jt(Math.round(t).toString(16))];return i&&r[0].charAt(0)==r[0].charAt(1)&&r[1].charAt(0)==r[1].charAt(1)&&r[2].charAt(0)==r[2].charAt(1)?r[0].charAt(0)+r[1].charAt(0)+r[2].charAt(0):r.join("")}function Zm(n,e,t,i,r){var s=[jt(Math.round(n).toString(16)),jt(Math.round(e).toString(16)),jt(Math.round(t).toString(16)),jt(Uc(i))];return r&&s[0].charAt(0)==s[0].charAt(1)&&s[1].charAt(0)==s[1].charAt(1)&&s[2].charAt(0)==s[2].charAt(1)&&s[3].charAt(0)==s[3].charAt(1)?s[0].charAt(0)+s[1].charAt(0)+s[2].charAt(0)+s[3].charAt(0):s.join("")}function Ro(n,e,t,i){var r=[jt(Uc(i)),jt(Math.round(n).toString(16)),jt(Math.round(e).toString(16)),jt(Math.round(t).toString(16))];return r.join("")}de.equals=function(n,e){return!n||!e?!1:de(n).toRgbString()==de(e).toRgbString()};de.random=function(){return de.fromRatio({r:Math.random(),g:Math.random(),b:Math.random()})};function Jm(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.s-=e/100,t.s=Nr(t.s),de(t)}function Qm(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.s+=e/100,t.s=Nr(t.s),de(t)}function eg(n){return de(n).desaturate(100)}function tg(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.l+=e/100,t.l=Nr(t.l),de(t)}function ng(n,e){e=e===0?0:e||10;var t=de(n).toRgb();return t.r=Math.max(0,Math.min(255,t.r-Math.round(255*-(e/100)))),t.g=Math.max(0,Math.min(255,t.g-Math.round(255*-(e/100)))),t.b=Math.max(0,Math.min(255,t.b-Math.round(255*-(e/100)))),de(t)}function ig(n,e){e=e===0?0:e||10;var t=de(n).toHsl();return t.l-=e/100,t.l=Nr(t.l),de(t)}function rg(n,e){var t=de(n).toHsl(),i=(t.h+e)%360;return t.h=i<0?360+i:i,de(t)}function sg(n){var e=de(n).toHsl();return e.h=(e.h+180)%360,de(e)}function Co(n,e){if(isNaN(e)||e<=0)throw new Error("Argument to polyad must be a positive number");for(var t=de(n).toHsl(),i=[de(n)],r=360/e,s=1;s<e;s++)i.push(de({h:(t.h+s*r)%360,s:t.s,l:t.l}));return i}function ag(n){var e=de(n).toHsl(),t=e.h;return[de(n),de({h:(t+72)%360,s:e.s,l:e.l}),de({h:(t+216)%360,s:e.s,l:e.l})]}function og(n,e,t){e=e||6,t=t||30;var i=de(n).toHsl(),r=360/t,s=[de(n)];for(i.h=(i.h-(r*e>>1)+720)%360;--e;)i.h=(i.h+r)%360,s.push(de(i));return s}function cg(n,e){e=e||6;for(var t=de(n).toHsv(),i=t.h,r=t.s,s=t.v,o=[],a=1/e;e--;)o.push(de({h:i,s:r,v:s})),s=(s+a)%1;return o}de.mix=function(n,e,t){t=t===0?0:t||50;var i=de(n).toRgb(),r=de(e).toRgb(),s=t/100,o={r:(r.r-i.r)*s+i.r,g:(r.g-i.g)*s+i.g,b:(r.b-i.b)*s+i.b,a:(r.a-i.a)*s+i.a};return de(o)};de.readability=function(n,e){var t=de(n),i=de(e);return(Math.max(t.getLuminance(),i.getLuminance())+.05)/(Math.min(t.getLuminance(),i.getLuminance())+.05)};de.isReadable=function(n,e,t){var i=de.readability(n,e),r,s;switch(s=!1,r=pg(t),r.level+r.size){case"AAsmall":case"AAAlarge":s=i>=4.5;break;case"AAlarge":s=i>=3;break;case"AAAsmall":s=i>=7;break}return s};de.mostReadable=function(n,e,t){var i=null,r=0,s,o,a,c;t=t||{},o=t.includeFallbackColors,a=t.level,c=t.size;for(var l=0;l<e.length;l++)s=de.readability(n,e[l]),s>r&&(r=s,i=de(e[l]));return de.isReadable(n,i,{level:a,size:c})||!o?i:(t.includeFallbackColors=!1,de.mostReadable(n,["#fff","#000"],t))};var Ls=de.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkgrey:"a9a9a9",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"f0f",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",grey:"808080",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgreen:"90ee90",lightgrey:"d3d3d3",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"789",lightslategrey:"789",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"0f0",limegreen:"32cd32",linen:"faf0e6",magenta:"f0f",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370db",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"db7093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"f00",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},lg=de.hexNames=ug(Ls);function ug(n){var e={};for(var t in n)n.hasOwnProperty(t)&&(e[n[t]]=t);return e}function Dc(n){return n=parseFloat(n),(isNaN(n)||n<0||n>1)&&(n=1),n}function Je(n,e){hg(n)&&(n="100%");var t=dg(n);return n=Math.min(e,Math.max(0,parseFloat(n))),t&&(n=parseInt(n*e,10)/100),Math.abs(n-e)<1e-6?1:n%e/parseFloat(e)}function Nr(n){return Math.min(1,Math.max(0,n))}function Dt(n){return parseInt(n,16)}function hg(n){return typeof n=="string"&&n.indexOf(".")!=-1&&parseFloat(n)===1}function dg(n){return typeof n=="string"&&n.indexOf("%")!=-1}function jt(n){return n.length==1?"0"+n:""+n}function wi(n){return n<=1&&(n=n*100+"%"),n}function Uc(n){return Math.round(parseFloat(n)*255).toString(16)}function Po(n){return Dt(n)/255}var Xt=function(){var n="[-\\+]?\\d+%?",e="[-\\+]?\\d*\\.\\d+%?",t="(?:"+e+")|(?:"+n+")",i="[\\s|\\(]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")\\s*\\)?",r="[\\s|\\(]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")\\s*\\)?";return{CSS_UNIT:new RegExp(t),rgb:new RegExp("rgb"+i),rgba:new RegExp("rgba"+r),hsl:new RegExp("hsl"+i),hsla:new RegExp("hsla"+r),hsv:new RegExp("hsv"+i),hsva:new RegExp("hsva"+r),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/}}();function sn(n){return!!Xt.CSS_UNIT.exec(n)}function fg(n){n=n.replace(Xm,"").replace(qm,"").toLowerCase();var e=!1;if(Ls[n])n=Ls[n],e=!0;else if(n=="transparent")return{r:0,g:0,b:0,a:0,format:"name"};var t;return(t=Xt.rgb.exec(n))?{r:t[1],g:t[2],b:t[3]}:(t=Xt.rgba.exec(n))?{r:t[1],g:t[2],b:t[3],a:t[4]}:(t=Xt.hsl.exec(n))?{h:t[1],s:t[2],l:t[3]}:(t=Xt.hsla.exec(n))?{h:t[1],s:t[2],l:t[3],a:t[4]}:(t=Xt.hsv.exec(n))?{h:t[1],s:t[2],v:t[3]}:(t=Xt.hsva.exec(n))?{h:t[1],s:t[2],v:t[3],a:t[4]}:(t=Xt.hex8.exec(n))?{r:Dt(t[1]),g:Dt(t[2]),b:Dt(t[3]),a:Po(t[4]),format:e?"name":"hex8"}:(t=Xt.hex6.exec(n))?{r:Dt(t[1]),g:Dt(t[2]),b:Dt(t[3]),format:e?"name":"hex"}:(t=Xt.hex4.exec(n))?{r:Dt(t[1]+""+t[1]),g:Dt(t[2]+""+t[2]),b:Dt(t[3]+""+t[3]),a:Po(t[4]+""+t[4]),format:e?"name":"hex8"}:(t=Xt.hex3.exec(n))?{r:Dt(t[1]+""+t[1]),g:Dt(t[2]+""+t[2]),b:Dt(t[3]+""+t[3]),format:e?"name":"hex"}:!1}function pg(n){var e,t;return n=n||{level:"AA",size:"small"},e=(n.level||"AA").toUpperCase(),t=(n.size||"small").toLowerCase(),e!=="AA"&&e!=="AAA"&&(e="AA"),t!=="small"&&t!=="large"&&(t="small"),{level:e,size:t}}async function mg(n,e=5){const t=await _g(n),i=document.createElement("canvas"),r=i.getContext("2d"),s=i.width=200,o=i.height=Math.max(1,Math.round(s*t.height/t.width));r.drawImage(t,0,0,s,o);const a=r.getImageData(0,0,s,o).data,c=[];for(let d=0;d<a.length;d+=4*8){const p=a[d],m=a[d+1],v=a[d+2],_=de({r:p,g:m,b:v}),{h:f,s:u,v:T}=_.toHsv();c.push([f/360,u,T])}let l=Array.from({length:e},(d,p)=>c[p*c.length/e|0]);for(let d=0;d<10;d++){const p=Array.from({length:e},()=>[]);for(const m of c){let v=0,_=1e9;for(let f=0;f<e;f++){const u=gg(m,l[f]);u<_&&(_=u,v=f)}p[v].push(m)}for(let m=0;m<e;m++){const v=p[m];if(v.length){const _=[0,0,0];for(const f of v)_[0]+=f[0],_[1]+=f[1],_[2]+=f[2];l[m]=_.map(f=>f/v.length)}}}return l.sort((d,p)=>p[2]-d[2]).map(d=>de({h:d[0]*360,s:d[1],v:Math.min(1,d[2]*1.05)}).toHexString())}function gg(n,e){const t=Math.min(Math.abs(n[0]-e[0]),1-Math.abs(n[0]-e[0])),i=Math.abs(n[1]-e[1]),r=Math.abs(n[2]-e[2]);return t*2+i+r}function _g(n){return new Promise((e,t)=>{const i=new Image;i.crossOrigin="anonymous",i.onload=()=>e(i),i.onerror=t,i.src=n})}function vg(){let n=performance.now(),e=0,t=0;function i(){const r=performance.now();e++,r-n>=1e3&&(t=e*1e3/(r-n),e=0,n=r),requestAnimationFrame(i)}return requestAnimationFrame(i),{value:()=>t}}function xg(){const n=document.createElement("canvas").getContext("webgl2")||document.createElement("canvas").getContext("webgl");if(!n)return"No WebGL";const e=n.getExtension("WEBGL_debug_renderer_info"),t=e?n.getParameter(e.UNMASKED_RENDERER_WEBGL):n.getParameter(n.RENDERER);return String(t||"WebGL")}function Lo(n){const e=Math.floor(n/1e3),t=Math.floor(e/60),i=e%60;return`${t}:${i.toString().padStart(2,"0")}`}let Ln=null,xs=[],Ri,Ic;function Mg(n,e){Ic=n,Ri=e}function Sg(){if(!Ln||Ln.state==="inactive"){const n=Ic.captureStream(60);Ln=new MediaRecorder(n,{mimeType:"video/webm;codecs=vp9",videoBitsPerSecond:8e6}),xs=[],Ln.ondataavailable=e=>{e.data.size>0&&xs.push(e.data)},Ln.onstop=()=>{const e=new Blob(xs,{type:"video/webm"}),t=URL.createObjectURL(e),i=document.createElement("a");i.href=t,i.download=`dwdw-${new Date().toISOString().replace(/[:.]/g,"-")}.webm`,i.click(),URL.revokeObjectURL(t),Ri?.("saved"),setTimeout(()=>Ri?.("idle"),1e3)},Ln.start(),Ri?.("recording…")}else Ln.stop(),Ri?.("processing…")}const Do="927fda6918514f96903e828fcd6bb576",Eg=(()=>{const n=location.pathname.split("/").filter(Boolean);return n.length?`/${n[0]}/`:"/"})(),Uo=location.hostname==="127.0.0.1"||location.hostname==="localhost"?"http://127.0.0.1:5173/":`${location.origin}${Eg}`,yg=["user-read-private","user-read-email","user-read-playback-state","user-modify-playback-state","user-read-currently-playing","streaming"],ce={loginBtn:document.getElementById("login-btn"),playpauseBtn:document.getElementById("playpause-btn"),prevBtn:document.getElementById("prev-btn"),nextBtn:document.getElementById("next-btn"),seekRange:document.getElementById("seek-range"),seekLabel:document.getElementById("seek-label"),volumeRange:document.getElementById("volume-range"),devicePicker:document.getElementById("device-picker"),modeLabel:document.getElementById("mode-label"),fpsLabel:document.getElementById("fps-label"),gpuLabel:document.getElementById("gpu-label"),beatDot:document.getElementById("beat-dot"),scenePicker:document.getElementById("scene-picker"),vjIntensity:document.getElementById("vj-intensity"),vjIntensityV:document.getElementById("vj-intensity-v"),vjBloom:document.getElementById("vj-bloom"),vjBloomV:document.getElementById("vj-bloom-v"),vjGlitch:document.getElementById("vj-glitch"),vjGlitchV:document.getElementById("vj-glitch-v"),vjSpeed:document.getElementById("vj-speed"),vjSpeedV:document.getElementById("vj-speed-v"),midiStatus:document.getElementById("midi-status"),qScale:document.getElementById("q-scale"),qScaleV:document.getElementById("q-scale-v"),qMSAA:document.getElementById("q-msaa"),qMSAAV:document.getElementById("q-msaa-v"),qTAA:document.getElementById("q-taa"),qBloom:document.getElementById("q-bloom"),qBloomV:document.getElementById("q-bloom-v"),qSSAO:document.getElementById("q-ssao"),qMoBlur:document.getElementById("q-moblur"),qDOF:document.getElementById("q-dof"),qToneMap:document.getElementById("q-tonemap"),qChroma:document.getElementById("q-chroma"),qChromaV:document.getElementById("q-chroma-v"),qVol:document.getElementById("q-vol"),qSteps:document.getElementById("q-steps"),qStepsV:document.getElementById("q-steps-v"),qSoft:document.getElementById("q-soft"),qSoftV:document.getElementById("q-soft-v"),qParticles:document.getElementById("q-particles"),qParticlesV:document.getElementById("q-particles-v"),qFluidRes:document.getElementById("q-fluid-res"),qFluidResV:document.getElementById("q-fluid-res-v"),qFluidIters:document.getElementById("q-fluid-iters"),qFluidItersV:document.getElementById("q-fluid-iters-v"),qWebGPU:document.getElementById("q-webgpu"),accEpilepsy:document.getElementById("acc-epilepsy"),accIntensity:document.getElementById("acc-intensity"),accIntensityV:document.getElementById("acc-intensity-v"),accReduced:document.getElementById("acc-reduced"),accContrast:document.getElementById("acc-contrast"),fullscreen:document.getElementById("fullscreen-btn"),recordToggle:document.getElementById("record-toggle"),recordStatus:document.getElementById("record-status"),coverImg:document.getElementById("cover-img"),trackTitle:document.getElementById("track-title"),trackArtist:document.getElementById("track-artist"),screensaver:document.getElementById("screensaver")};let Cr=!1,Pi=null,Io=Date.now();function Tg(n){for(let e=0;e<5;e++)document.documentElement.style.setProperty(`--palette-${e}`,n[e]||"#666");document.documentElement.style.setProperty("--accent",n[0]||"#59ffa9"),document.documentElement.style.setProperty("--accent-2",n[1]||"#5aaaff"),document.documentElement.style.setProperty("--accent-3",n[2]||"#ff59be")}function bg(){ce.modeLabel.textContent=Cr?"In-page playback":"Device control"}async function No(){const n=await tl();ce.devicePicker.innerHTML="",n.forEach(e=>{const t=document.createElement("option");t.value=e.id||"",t.textContent=`${e.name} ${e.is_active?"•":""}`,ce.devicePicker.appendChild(t),e.is_active&&(Pi=e.id||null)}),Pi&&(ce.devicePicker.value=Pi)}function Ag(){const n=ce,e=()=>{Cm({renderScale:parseFloat(n.qScale.value),msaa:parseInt(n.qMSAA.value),taa:n.qTAA.checked,bloom:parseFloat(n.qBloom.value),ssao:n.qSSAO.checked,motionBlur:n.qMoBlur.checked,dof:n.qDOF.checked,toneMap:n.qToneMap.value,chromaticAberration:parseFloat(n.qChroma.value),volumetrics:n.qVol?.checked??!0,raymarchSteps:parseInt(n.qSteps.value),softShadowSamples:parseInt(n.qSoft.value),particleCount:parseInt(n.qParticles.value),fluidResolution:parseInt(n.qFluidRes.value),fluidIterations:parseInt(n.qFluidIters.value),webgpuPathTrace:n.qWebGPU.checked}),n.qScaleV.textContent=`${parseFloat(n.qScale.value).toFixed(1)}x`,n.qMSAAV.textContent=n.qMSAA.value,n.qBloomV.textContent=n.qBloom.value,n.qChromaV.textContent=n.qChroma.value,n.qStepsV.textContent=n.qSteps.value,n.qSoftV.textContent=n.qSoft.value,n.qParticlesV.textContent=`${(parseInt(n.qParticles.value)/1e6).toFixed(1)}M`,n.qFluidResV.textContent=`${n.qFluidRes.value}²`,n.qFluidItersV.textContent=n.qFluidIters.value};["input","change"].forEach(t=>{[n.qScale,n.qMSAA,n.qTAA,n.qBloom,n.qSSAO,n.qMoBlur,n.qDOF,n.qToneMap,n.qChroma,n.qVol,n.qSteps,n.qSoft,n.qParticles,n.qFluidRes,n.qFluidIters,n.qWebGPU].forEach(i=>{i?.addEventListener(t,e)})})}function wg(){const n=()=>{const e={epilepsySafe:ce.accEpilepsy.checked,intensityLimiter:parseFloat(ce.accIntensity.value),reducedMotion:ce.accReduced.checked,highContrast:ce.accContrast.checked};ce.accIntensityV.textContent=parseFloat(ce.accIntensity.value).toFixed(2),Pm(e),document.body.style.filter=e.highContrast?"contrast(1.15) saturate(1.15)":""};["input","change"].forEach(e=>{[ce.accEpilepsy,ce.accIntensity,ce.accReduced,ce.accContrast].forEach(t=>t.addEventListener(e,n))}),n()}function Rg(){const n=()=>{Lm({intensity:parseFloat(ce.vjIntensity.value),bloom:parseFloat(ce.vjBloom.value),glitch:parseFloat(ce.vjGlitch.value),speed:parseFloat(ce.vjSpeed.value)}),ce.vjIntensityV.textContent=parseFloat(ce.vjIntensity.value).toFixed(2),ce.vjBloomV.textContent=parseFloat(ce.vjBloom.value).toFixed(2),ce.vjGlitchV.textContent=parseFloat(ce.vjGlitch.value).toFixed(2),ce.vjSpeedV.textContent=parseFloat(ce.vjSpeed.value).toFixed(2)};["input","change"].forEach(e=>{[ce.vjIntensity,ce.vjBloom,ce.vjGlitch,ce.vjSpeed].forEach(t=>t.addEventListener(e,n))}),n(),ce.scenePicker.addEventListener("change",()=>{const e=ce.scenePicker.value;e==="auto"?gr():Ar(e)})}function Fo(){ce.playpauseBtn.addEventListener("click",async()=>{await nl()}),ce.prevBtn.addEventListener("click",async()=>{await rl()}),ce.nextBtn.addEventListener("click",async()=>{await il()}),ce.volumeRange.addEventListener("input",async()=>{const e=parseInt(ce.volumeRange.value);Cr?await ol(e):await al(e)}),ce.seekRange.addEventListener("input",()=>{}),ce.seekRange.addEventListener("change",async()=>{const e=parseInt(ce.seekRange.value);await sl(e)}),ce.devicePicker.addEventListener("change",async()=>{const e=ce.devicePicker.value;Pi=e,await Vo(e,!1)}),ce.fullscreen.addEventListener("click",async()=>{const e=document.documentElement;document.fullscreenElement?document.exitFullscreen?.():e.requestFullscreen?.()});const n=()=>{Io=Date.now(),ce.screensaver.classList.remove("active")};["mousemove","keydown","pointerdown","touchstart"].forEach(e=>window.addEventListener(e,n,{passive:!0})),setInterval(()=>{Date.now()-Io>3e4&&ce.screensaver.classList.add("active")},1e3)}function Cg(){Mg(Rm(),n=>{ce.recordStatus.textContent=n,ce.recordToggle.textContent=n.startsWith("recording")?"Stop":"Start"}),ce.recordToggle.addEventListener("click",()=>Sg())}function Pg(){const n=document.getElementById("vis"),e=()=>{n&&Pc(n.clientWidth,n.clientHeight,window.devicePixelRatio)};window.addEventListener("resize",e),e();const t=vg();setInterval(()=>{ce.fpsLabel.textContent=`FPS: ${t.value().toFixed(0)}`},500),ce.gpuLabel.textContent=xg()}async function Oo(){const n=await Wo();if(!n)return;const e=n.item?.duration_ms??0,t=n.progress_ms??0;if(e&&!isNaN(e)&&(ce.seekRange.matches(":active")||(ce.seekRange.max=String(e),ce.seekRange.value=String(t)),ce.seekLabel.textContent=`${Lo(t)} / ${Lo(e)}`),n.item){ce.trackTitle.textContent=n.item.name,ce.trackArtist.textContent=n.item.artists.map(r=>r.name).join(", ");const i=n.item.album.images[0]?.url;if(i){const r=await Om(n.item.id,i),s=r?.objectUrl??i;ce.coverImg.src=s;const o=r?.palette??await mg(s);Tg(o),Um(o.map(a=>a)),Bm(n.item.id,i,o).catch(()=>{})}zm(n.item).catch(()=>{})}}function Lg(){Cc()||["tunnel","terrain","fluid"].forEach(e=>{const t=ce.scenePicker.querySelector(`option[value="${e}"]`);t&&(t.disabled=!0,t.textContent=`${t.textContent||e} (unsupported)`)})}async function Dg(){if(Vc({loginButton:ce.loginBtn,clientId:Do,redirectUri:Uo,scopes:yg}),await qc(Do,Uo),!await pr()){Fo();return}$c(()=>pr()),Cr=await jc(),bg();const e=document.getElementById("vis");await wm(e),Lg(),Ag(),ce.qScale.dispatchEvent(new Event("input")),wg(),Rg(),Fo(),Pg(),Cg(),await Qc(()=>pr(),async t=>{Pi=t,await No(),Cr&&(await el(),await Vo(t,!0))},()=>{Oo()}),await No(),gr(),Im(),km({onBeat:()=>{ce.beatDot.style.transform="scale(1.4)",ce.beatDot.style.boxShadow="0 0 12px var(--accent)",setTimeout(()=>{ce.beatDot.style.transform="scale(1.0)",ce.beatDot.style.boxShadow="none"},120)},onPhraseBoundary:()=>{const t=ce.scenePicker.value;t==="auto"?gr():Ii(t,1.2)}}),Nm(60),setInterval(Oo,1e3),ce.scenePicker.addEventListener("change",()=>{const t=ce.scenePicker.value;t==="auto"?gr():Ii(t,1)})}Dg().catch(n=>{console.error(n),alert("Initialization error. Check console.")});
