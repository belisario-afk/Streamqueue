...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function Xa(){return new Lt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ds(),fragmentShader:`
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function qa(){return new Lt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ds(),fragmentShader:`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
}`;function Wp(n,e,t){let i=new al;const r=new We,s=new We,o=new ft,a=new Hp({depthPacking:Fc}),l=new Gp,c={},h=t.maxTextureSize,f={[Tn]:Rt,[Rt]:Tn,[on]:on},p=new Lt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new We},radius:{value:4}},vertexShader:kp,fragmentShader:Vp}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const v=new pn;v.setAttribute("position",new jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new wt(v,p),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Io;let u=this.type;this.render=function(R,w,j){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||R.length===0)return;const S=n.getRenderTarget(),y=n.getActiveCubeFace(),G=n.getActiveMipmapLevel(),V=n.state;V.setBlending(En),V.buffers.color.setClear(1,1,1,1),V.buffers.depth.setTest(!0),V.setScissorTest(!1);const ie=u!==an&&this.type===an,C=u===an&&this.type!==an;for(let B=0,H=R.length;B<H;B++){const X=R[B],k=X.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",X,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;r.copy(k.mapSize);const W=k.getFrameExtents();if(r.multiply(W),s.copy(k.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/W.x),r.x=s.x*W.x,k.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/W.y),r.y=s.y*W.y,k.mapSize.y=s.y)),k.map===null||ie===!0||C===!0){const Q=this.type!==an?{minFilter:Et,magFilter:Et}:{};k.map!==null&&k.map.dispose(),k.map=new bn(r.x,r.y,Q),k.map.texture.name=X.name+".shadowMap",k.camera.updateProjectionMatrix()}n.setRenderTarget(k.map),n.clear();const q=k.getViewportCount();for(let Q=0;Q<q;Q++){const ee=k.getViewport(Q);o.set(s.x*ee.x,s.y*ee.y,s.x*ee.z,s.y*ee.w),V.viewport(o),k.updateMatrices(X,Q),i=k.getFrustum(),b(w,j,k.camera,X,this.type)}k.isPointLightShadow!==!0&&this.type===an&&T(k,j),k.needsUpdate=!1}u=this.type,d.needsUpdate=!1,n.setRenderTarget(S,y,G)};function T(R,w){const j=e.update(_);p.defines.VSM_SAMPLES!==R.blurSamples&&(p.defines.VSM_SAMPLES=R.blurSamples,m.defines.VSM_SAMPLES=R.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new bn(r.x,r.y)),p.uniforms.shadow_pass.value=R.map.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,n.setRenderTarget(R.mapPass),n.clear(),n.renderBufferDirect(w,null,j,p,_,null),m.uniforms.shadow_pass.value=R.mapPass.texture,m.uniforms.resolution.value=R.mapSize,m.uniforms.radius.value=R.radius,n.setRenderTarget(R.map),n.clear(),n.renderBufferDirect(w,null,j,m,_,null)}function E(R,w,j,S){let y=null;const G=j.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(G!==void 0)y=G;else if(y=j.isPointLight===!0?l:a,n.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const V=y.uuid,ie=w.uuid;let C=c[V];C===void 0&&(C={},c[V]=C);let B=C[ie];B===void 0&&(B=y.clone(),C[ie]=B,w.addEventListener("dispose",L)),y=B}if(y.visible=w.visible,y.wireframe=w.wireframe,S===an?y.side=w.shadowSide!==null?w.shadowSide:w.side:y.side=w.shadowSide!==null?w.shadowSide:f[w.side],y.alphaMap=w.alphaMap,y.alphaTest=w.alphaTest,y.map=w.map,y.clipShadows=w.clipShadows,y.clippingPlanes=w.clippingPlanes,y.clipIntersection=w.clipIntersection,y.displacementMap=w.displacementMap,y.displacementScale=w.displacementScale,y.displacementBias=w.displacementBias,y.wireframeLinewidth=w.wireframeLinewidth,y.linewidth=w.linewidth,j.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const V=n.properties.get(y);V.light=j}return y}function b(R,w,j,S,y){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&y===an)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,R.matrixWorld);const ie=e.update(R),C=R.material;if(Array.isArray(C)){const B=ie.groups;for(let H=0,X=B.length;H<X;H++){const k=B[H],W=C[k.materialIndex];if(W&&W.visible){const q=E(R,W,S,y);R.onBeforeShadow(n,R,w,j,ie,q,k),n.renderBufferDirect(j,null,ie,q,R,k),R.onAfterShadow(n,R,w,j,ie,q,k)}}}else if(C.visible){const B=E(R,C,S,y);R.onBeforeShadow(n,R,w,j,ie,B,null),n.renderBufferDirect(j,null,ie,B,R,null),R.onAfterShadow(n,R,w,j,ie,B,null)}}const V=R.children;for(let ie=0,C=V.length;ie<C;ie++)b(V[ie],w,j,S,y)}function L(R){R.target.removeEventListener("dispose",L);for(const j in c){const S=c[j],y=R.target.uuid;y in S&&(S[y].dispose(),delete S[y])}}}function Xp(n,e,t){const i=t.isWebGL2;function r(){let A=!1;const re=new ft;let se=null;const Te=new ft(0,0,0,0);return{setMask:function(xe){se!==xe&&!A&&(n.colorMask(xe,xe,xe,xe),se=xe)},setLocked:function(xe){A=xe},setClear:function(xe,Ye,$e,at,xt){xt===!0&&(xe*=at,Ye*=at,$e*=at),re.set(xe,Ye,$e,at),Te.equals(re)===!1&&(n.clearColor(xe,Ye,$e,at),Te.copy(re))},reset:function(){A=!1,se=null,Te.set(-1,0,0,0)}}}function s(){let A=!1,re=null,se=null,Te=null;return{setTest:function(xe){xe?Le(n.DEPTH_TEST):ye(n.DEPTH_TEST)},setMask:function(xe){re!==xe&&!A&&(n.depthMask(xe),re=xe)},setFunc:function(xe){if(se!==xe){switch(xe){case fc:n.depthFunc(n.NEVER);break;case dc:n.depthFunc(n.ALWAYS);break;case pc:n.depthFunc(n.LESS);break;case dr:n.depthFunc(n.LEQUAL);break;case mc:n.depthFunc(n.EQUAL);break;case gc:n.depthFunc(n.GEQUAL);break;case _c:n.depthFunc(n.GREATER);break;case vc:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}se=xe}},setLocked:function(xe){A=xe},setClear:function(xe){Te!==xe&&(n.clearDepth(xe),Te=xe)},reset:function(){A=!1,re=null,se=null,Te=null}}}function o(){let A=!1,re=null,se=null,Te=null,xe=null,Ye=null,$e=null,at=null,xt=null;return{setTest:function(Ke){A||(Ke?Le(n.STENCIL_TEST):ye(n.STENCIL_TEST))},setMask:function(Ke){re!==Ke&&!A&&(n.stencilMask(Ke),re=Ke)},setFunc:function(Ke,Mt,$t){(se!==Ke||Te!==Mt||xe!==$t)&&(n.stencilFunc(Ke,Mt,$t),se=Ke,Te=Mt,xe=$t)},setOp:function(Ke,Mt,$t){(Ye!==Ke||$e!==Mt||at!==$t)&&(n.stencilOp(Ke,Mt,$t),Ye=Ke,$e=Mt,at=$t)},setLocked:function(Ke){A=Ke},setClear:function(Ke){xt!==Ke&&(n.clearStencil(Ke),xt=Ke)},reset:function(){A=!1,re=null,se=null,Te=null,xe=null,Ye=null,$e=null,at=null,xt=null}}}const a=new r,l=new s,c=new o,h=new WeakMap,f=new WeakMap;let p={},m={},v=new WeakMap,_=[],d=null,u=!1,T=null,E=null,b=null,L=null,R=null,w=null,j=null,S=new Ee(0,0,0),y=0,G=!1,V=null,ie=null,C=null,B=null,H=null;const X=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,W=0;const q=n.getParameter(n.VERSION);q.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(q)[1]),k=W>=1):q.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),k=W>=2);let Q=null,ee={};const z=n.getParameter(n.SCISSOR_BOX),Y=n.getParameter(n.VIEWPORT),oe=new ft().fromArray(z),ge=new ft().fromArray(Y);function me(A,re,se,Te){const xe=new Uint8Array(4),Ye=n.createTexture();n.bindTexture(A,Ye),n.texParameteri(A,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(A,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let $e=0;$e<se;$e++)i&&(A===n.TEXTURE_3D||A===n.TEXTURE_2D_ARRAY)?n.texImage3D(re,0,n.RGBA,1,1,Te,0,n.RGBA,n.UNSIGNED_BYTE,xe):n.texImage2D(re+$e,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,xe);return Ye}const Ce={};Ce[n.TEXTURE_2D]=me(n.TEXTURE_2D,n.TEXTURE_2D,1),Ce[n.TEXTURE_CUBE_MAP]=me(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Ce[n.TEXTURE_2D_ARRAY]=me(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Ce[n.TEXTURE_3D]=me(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),c.setClear(0),Le(n.DEPTH_TEST),l.setFunc(dr),Ie(!1),M(Vs),Le(n.CULL_FACE),fe(En);function Le(A){p[A]!==!0&&(n.enable(A),p[A]=!0)}function ye(A){p[A]!==!1&&(n.disable(A),p[A]=!1)}function ke(A,re){return m[A]!==re?(n.bindFramebuffer(A,re),m[A]=re,i&&(A===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=re),A===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=re)),!0):!1}function D(A,re){let se=_,Te=!1;if(A)if(se=v.get(re),se===void 0&&(se=[],v.set(re,se)),A.isWebGLMultipleRenderTargets){const xe=A.texture;if(se.length!==xe.length||se[0]!==n.COLOR_ATTACHMENT0){for(let Ye=0,$e=xe.length;Ye<$e;Ye++)se[Ye]=n.COLOR_ATTACHMENT0+Ye;se.length=xe.length,Te=!0}}else se[0]!==n.COLOR_ATTACHMENT0&&(se[0]=n.COLOR_ATTACHMENT0,Te=!0);else se[0]!==n.BACK&&(se[0]=n.BACK,Te=!0);Te&&(t.isWebGL2?n.drawBuffers(se):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(se))}function vt(A){return d!==A?(n.useProgram(A),d=A,!0):!1}const ve={[Nn]:n.FUNC_ADD,[Zl]:n.FUNC_SUBTRACT,[Jl]:n.FUNC_REVERSE_SUBTRACT};if(i)ve[qs]=n.MIN,ve[Ys]=n.MAX;else{const A=e.get("EXT_blend_minmax");A!==null&&(ve[qs]=A.MIN_EXT,ve[Ys]=A.MAX_EXT)}const we={[Ql]:n.ZERO,[ec]:n.ONE,[tc]:n.SRC_COLOR,[fs]:n.SRC_ALPHA,[oc]:n.SRC_ALPHA_SATURATE,[sc]:n.DST_COLOR,[ic]:n.DST_ALPHA,[nc]:n.ONE_MINUS_SRC_COLOR,[ds]:n.ONE_MINUS_SRC_ALPHA,[ac]:n.ONE_MINUS_DST_COLOR,[rc]:n.ONE_MINUS_DST_ALPHA,[lc]:n.CONSTANT_COLOR,[cc]:n.ONE_MINUS_CONSTANT_COLOR,[uc]:n.CONSTANT_ALPHA,[hc]:n.ONE_MINUS_CONSTANT_ALPHA};function fe(A,re,se,Te,xe,Ye,$e,at,xt,Ke){if(A===En){u===!0&&(ye(n.BLEND),u=!1);return}if(u===!1&&(Le(n.BLEND),u=!0),A!==jl){if(A!==T||Ke!==G){if((E!==Nn||R!==Nn)&&(n.blendEquation(n.FUNC_ADD),E=Nn,R=Nn),Ke)switch(A){case oi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case hs:n.blendFunc(n.ONE,n.ONE);break;case Ws:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Xs:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",A);break}else switch(A){case oi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case hs:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case Ws:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Xs:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",A);break}b=null,L=null,w=null,j=null,S.set(0,0,0),y=0,T=A,G=Ke}return}xe=xe||re,Ye=Ye||se,$e=$e||Te,(re!==E||xe!==R)&&(n.blendEquationSeparate(ve[re],ve[xe]),E=re,R=xe),(se!==b||Te!==L||Ye!==w||$e!==j)&&(n.blendFuncSeparate(we[se],we[Te],we[Ye],we[$e]),b=se,L=Te,w=Ye,j=$e),(at.equals(S)===!1||xt!==y)&&(n.blendColor(at.r,at.g,at.b,xt),S.copy(at),y=xt),T=A,G=!1}function Je(A,re){A.side===on?ye(n.CULL_FACE):Le(n.CULL_FACE);let se=A.side===Rt;re&&(se=!se),Ie(se),A.blending===oi&&A.transparent===!1?fe(En):fe(A.blending,A.blendEquation,A.blendSrc,A.blendDst,A.blendEquationAlpha,A.blendSrcAlpha,A.blendDstAlpha,A.blendColor,A.blendAlpha,A.premultipliedAlpha),l.setFunc(A.depthFunc),l.setTest(A.depthTest),l.setMask(A.depthWrite),a.setMask(A.colorWrite);const Te=A.stencilWrite;c.setTest(Te),Te&&(c.setMask(A.stencilWriteMask),c.setFunc(A.stencilFunc,A.stencilRef,A.stencilFuncMask),c.setOp(A.stencilFail,A.stencilZFail,A.stencilZPass)),I(A.polygonOffset,A.polygonOffsetFactor,A.polygonOffsetUnits),A.alphaToCoverage===!0?Le(n.SAMPLE_ALPHA_TO_COVERAGE):ye(n.SAMPLE_ALPHA_TO_COVERAGE)}function Ie(A){V!==A&&(A?n.frontFace(n.CW):n.frontFace(n.CCW),V=A)}function M(A){A!==Yl?(Le(n.CULL_FACE),A!==ie&&(A===Vs?n.cullFace(n.BACK):A===$l?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ye(n.CULL_FACE),ie=A}function g(A){A!==C&&(k&&n.lineWidth(A),C=A)}function I(A,re,se){A?(Le(n.POLYGON_OFFSET_FILL),(B!==re||H!==se)&&(n.polygonOffset(re,se),B=re,H=se)):ye(n.POLYGON_OFFSET_FILL)}function Z(A){A?Le(n.SCISSOR_TEST):ye(n.SCISSOR_TEST)}function K(A){A===void 0&&(A=n.TEXTURE0+X-1),Q!==A&&(n.activeTexture(A),Q=A)}function J(A,re,se){se===void 0&&(Q===null?se=n.TEXTURE0+X-1:se=Q);let Te=ee[se];Te===void 0&&(Te={type:void 0,texture:void 0},ee[se]=Te),(Te.type!==A||Te.texture!==re)&&(Q!==se&&(n.activeTexture(se),Q=se),n.bindTexture(A,re||Ce[A]),Te.type=A,Te.texture=re)}function de(){const A=ee[Q];A!==void 0&&A.type!==void 0&&(n.bindTexture(A.type,null),A.type=void 0,A.texture=void 0)}function ae(){try{n.compressedTexImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function ce(){try{n.compressedTexImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function Se(){try{n.texSubImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function Ne(){try{n.texSubImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function $(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function Xe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function He(){try{n.texStorage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function Ae(){try{n.texStorage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function _e(){try{n.texImage2D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function ue(){try{n.texImage3D.apply(n,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function De(A){oe.equals(A)===!1&&(n.scissor(A.x,A.y,A.z,A.w),oe.copy(A))}function Ve(A){ge.equals(A)===!1&&(n.viewport(A.x,A.y,A.z,A.w),ge.copy(A))}function et(A,re){let se=f.get(re);se===void 0&&(se=new WeakMap,f.set(re,se));let Te=se.get(A);Te===void 0&&(Te=n.getUniformBlockIndex(re,A.name),se.set(A,Te))}function Oe(A,re){const Te=f.get(re).get(A);h.get(re)!==Te&&(n.uniformBlockBinding(re,Te,A.__bindingPointIndex),h.set(re,Te))}function te(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),p={},Q=null,ee={},m={},v=new WeakMap,_=[],d=null,u=!1,T=null,E=null,b=null,L=null,R=null,w=null,j=null,S=new Ee(0,0,0),y=0,G=!1,V=null,ie=null,C=null,B=null,H=null,oe.set(0,0,n.canvas.width,n.canvas.height),ge.set(0,0,n.canvas.width,n.canvas.height),a.reset(),l.reset(),c.reset()}return{buffers:{color:a,depth:l,stencil:c},enable:Le,disable:ye,bindFramebuffer:ke,drawBuffers:D,useProgram:vt,setBlending:fe,setMaterial:Je,setFlipSided:Ie,setCullFace:M,setLineWidth:g,setPolygonOffset:I,setScissorTest:Z,activeTexture:K,bindTexture:J,unbindTexture:de,compressedTexImage2D:ae,compressedTexImage3D:ce,texImage2D:_e,texImage3D:ue,updateUBOMapping:et,uniformBlockBinding:Oe,texStorage2D:He,texStorage3D:Ae,texSubImage2D:Se,texSubImage3D:Ne,compressedTexSubImage2D:$,compressedTexSubImage3D:Xe,scissor:De,viewport:Ve,reset:te}}function qp(n,e,t,i,r,s,o){const a=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new WeakMap;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function v(M,g){return m?new OffscreenCanvas(M,g):vr("canvas")}function _(M,g,I,Z){let K=1;if((M.width>Z||M.height>Z)&&(K=Z/Math.max(M.width,M.height)),K<1||g===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){const J=g?Ms:Math.floor,de=J(K*M.width),ae=J(K*M.height);f===void 0&&(f=v(de,ae));const ce=I?v(de,ae):f;return ce.width=de,ce.height=ae,ce.getContext("2d").drawImage(M,0,0,de,ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+de+"x"+ae+")."),ce}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function d(M){return ya(M.width)&&ya(M.height)}function u(M){return a?!1:M.wrapS!==qt||M.wrapT!==qt||M.minFilter!==Et&&M.minFilter!==yt}function T(M,g){return M.generateMipmaps&&g&&M.minFilter!==Et&&M.minFilter!==yt}function E(M){n.generateMipmap(M)}function b(M,g,I,Z,K=!1){if(a===!1)return g;if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let J=g;if(g===n.RED&&(I===n.FLOAT&&(J=n.R32F),I===n.HALF_FLOAT&&(J=n.R16F),I===n.UNSIGNED_BYTE&&(J=n.R8)),g===n.RED_INTEGER&&(I===n.UNSIGNED_BYTE&&(J=n.R8UI),I===n.UNSIGNED_SHORT&&(J=n.R16UI),I===n.UNSIGNED_INT&&(J=n.R32UI),I===n.BYTE&&(J=n.R8I),I===n.SHORT&&(J=n.R16I),I===n.INT&&(J=n.R32I)),g===n.RG&&(I===n.FLOAT&&(J=n.RG32F),I===n.HALF_FLOAT&&(J=n.RG16F),I===n.UNSIGNED_BYTE&&(J=n.RG8)),g===n.RGBA){const de=K?pr:qe.getTransfer(Z);I===n.FLOAT&&(J=n.RGBA32F),I===n.HALF_FLOAT&&(J=n.RGBA16F),I===n.UNSIGNED_BYTE&&(J=de===je?n.SRGB8_ALPHA8:n.RGBA8),I===n.UNSIGNED_SHORT_4_4_4_4&&(J=n.RGBA4),I===n.UNSIGNED_SHORT_5_5_5_1&&(J=n.RGB5_A1)}return(J===n.R16F||J===n.R32F||J===n.RG16F||J===n.RG32F||J===n.RGBA16F||J===n.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function L(M,g,I){return T(M,I)===!0||M.isFramebufferTexture&&M.minFilter!==Et&&M.minFilter!==yt?Math.log2(Math.max(g.width,g.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?g.mipmaps.length:1}function R(M){return M===Et||M===$s||M===Ur?n.NEAREST:n.LINEAR}function w(M){const g=M.target;g.removeEventListener("dispose",w),S(g),g.isVideoTexture&&h.delete(g)}function j(M){const g=M.target;g.removeEventListener("dispose",j),G(g)}function S(M){const g=i.get(M);if(g.__webglInit===void 0)return;const I=M.source,Z=p.get(I);if(Z){const K=Z[g.__cacheKey];K.usedTimes--,K.usedTimes===0&&y(M),Object.keys(Z).length===0&&p.delete(I)}i.remove(M)}function y(M){const g=i.get(M);n.deleteTexture(g.__webglTexture);const I=M.source,Z=p.get(I);delete Z[g.__cacheKey],o.memory.textures--}function G(M){const g=M.texture,I=i.get(M),Z=i.get(g);if(Z.__webglTexture!==void 0&&(n.deleteTexture(Z.__webglTexture),o.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(I.__webglFramebuffer[K]))for(let J=0;J<I.__webglFramebuffer[K].length;J++)n.deleteFramebuffer(I.__webglFramebuffer[K][J]);else n.deleteFramebuffer(I.__webglFramebuffer[K]);I.__webglDepthbuffer&&n.deleteRenderbuffer(I.__webglDepthbuffer[K])}else{if(Array.isArray(I.__webglFramebuffer))for(let K=0;K<I.__webglFramebuffer.length;K++)n.deleteFramebuffer(I.__webglFramebuffer[K]);else n.deleteFramebuffer(I.__webglFramebuffer);if(I.__webglDepthbuffer&&n.deleteRenderbuffer(I.__webglDepthbuffer),I.__webglMultisampledFramebuffer&&n.deleteFramebuffer(I.__webglMultisampledFramebuffer),I.__webglColorRenderbuffer)for(let K=0;K<I.__webglColorRenderbuffer.length;K++)I.__webglColorRenderbuffer[K]&&n.deleteRenderbuffer(I.__webglColorRenderbuffer[K]);I.__webglDepthRenderbuffer&&n.deleteRenderbuffer(I.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let K=0,J=g.length;K<J;K++){const de=i.get(g[K]);de.__webglTexture&&(n.deleteTexture(de.__webglTexture),o.memory.textures--),i.remove(g[K])}i.remove(g),i.remove(M)}let V=0;function ie(){V=0}function C(){const M=V;return M>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),V+=1,M}function B(M){const g=[];return g.push(M.wrapS),g.push(M.wrapT),g.push(M.wrapR||0),g.push(M.magFilter),g.push(M.minFilter),g.push(M.anisotropy),g.push(M.internalFormat),g.push(M.format),g.push(M.type),g.push(M.generateMipmaps),g.push(M.premultiplyAlpha),g.push(M.flipY),g.push(M.unpackAlignment),g.push(M.colorSpace),g.join()}function H(M,g){const I=i.get(M);if(M.isVideoTexture&&Je(M),M.isRenderTargetTexture===!1&&M.version>0&&I.__version!==M.version){const Z=M.image;if(Z===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Z.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{oe(I,M,g);return}}t.bindTexture(n.TEXTURE_2D,I.__webglTexture,n.TEXTURE0+g)}function X(M,g){const I=i.get(M);if(M.version>0&&I.__version!==M.version){oe(I,M,g);return}t.bindTexture(n.TEXTURE_2D_ARRAY,I.__webglTexture,n.TEXTURE0+g)}function k(M,g){const I=i.get(M);if(M.version>0&&I.__version!==M.version){oe(I,M,g);return}t.bindTexture(n.TEXTURE_3D,I.__webglTexture,n.TEXTURE0+g)}function W(M,g){const I=i.get(M);if(M.version>0&&I.__version!==M.version){ge(I,M,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,I.__webglTexture,n.TEXTURE0+g)}const q={[gs]:n.REPEAT,[qt]:n.CLAMP_TO_EDGE,[_s]:n.MIRRORED_REPEAT},Q={[Et]:n.NEAREST,[$s]:n.NEAREST_MIPMAP_NEAREST,[Ur]:n.NEAREST_MIPMAP_LINEAR,[yt]:n.LINEAR,[Ac]:n.LINEAR_MIPMAP_NEAREST,[Ri]:n.LINEAR_MIPMAP_LINEAR},ee={[zc]:n.NEVER,[Xc]:n.ALWAYS,[Hc]:n.LESS,[qo]:n.LEQUAL,[Gc]:n.EQUAL,[Wc]:n.GEQUAL,[kc]:n.GREATER,[Vc]:n.NOTEQUAL};function z(M,g,I){if(I?(n.texParameteri(M,n.TEXTURE_WRAP_S,q[g.wrapS]),n.texParameteri(M,n.TEXTURE_WRAP_T,q[g.wrapT]),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,q[g.wrapR]),n.texParameteri(M,n.TEXTURE_MAG_FILTER,Q[g.magFilter]),n.texParameteri(M,n.TEXTURE_MIN_FILTER,Q[g.minFilter])):(n.texParameteri(M,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(M,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(M===n.TEXTURE_3D||M===n.TEXTURE_2D_ARRAY)&&n.texParameteri(M,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(g.wrapS!==qt||g.wrapT!==qt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(M,n.TEXTURE_MAG_FILTER,R(g.magFilter)),n.texParameteri(M,n.TEXTURE_MIN_FILTER,R(g.minFilter)),g.minFilter!==Et&&g.minFilter!==yt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),g.compareFunction&&(n.texParameteri(M,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(M,n.TEXTURE_COMPARE_FUNC,ee[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const Z=e.get("EXT_texture_filter_anisotropic");if(g.magFilter===Et||g.minFilter!==Ur&&g.minFilter!==Ri||g.type===Sn&&e.has("OES_texture_float_linear")===!1||a===!1&&g.type===Ci&&e.has("OES_texture_half_float_linear")===!1)return;(g.anisotropy>1||i.get(g).__currentAnisotropy)&&(n.texParameterf(M,Z.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy)}}function Y(M,g){let I=!1;M.__webglInit===void 0&&(M.__webglInit=!0,g.addEventListener("dispose",w));const Z=g.source;let K=p.get(Z);K===void 0&&(K={},p.set(Z,K));const J=B(g);if(J!==M.__cacheKey){K[J]===void 0&&(K[J]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,I=!0),K[J].usedTimes++;const de=K[M.__cacheKey];de!==void 0&&(K[M.__cacheKey].usedTimes--,de.usedTimes===0&&y(g)),M.__cacheKey=J,M.__webglTexture=K[J].texture}return I}function oe(M,g,I){let Z=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(Z=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(Z=n.TEXTURE_3D);const K=Y(M,g),J=g.source;t.bindTexture(Z,M.__webglTexture,n.TEXTURE0+I);const de=i.get(J);if(J.version!==de.__version||K===!0){t.activeTexture(n.TEXTURE0+I);const ae=qe.getPrimaries(qe.workingColorSpace),ce=g.colorSpace===Ht?null:qe.getPrimaries(g.colorSpace),Se=g.colorSpace===Ht||ae===ce?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);const Ne=u(g)&&d(g.image)===!1;let $=_(g.image,Ne,!1,r.maxTextureSize);$=Ie(g,$);const Xe=d($)||a,He=s.convert(g.format,g.colorSpace);let Ae=s.convert(g.type),_e=b(g.internalFormat,He,Ae,g.colorSpace,g.isVideoTexture);z(Z,g,Xe);let ue;const De=g.mipmaps,Ve=a&&g.isVideoTexture!==!0&&_e!==Wo,et=de.__version===void 0||K===!0,Oe=L(g,$,Xe);if(g.isDepthTexture)_e=n.DEPTH_COMPONENT,a?g.type===Sn?_e=n.DEPTH_COMPONENT32F:g.type===Mn?_e=n.DEPTH_COMPONENT24:g.type===Bn?_e=n.DEPTH24_STENCIL8:_e=n.DEPTH_COMPONENT16:g.type===Sn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),g.format===zn&&_e===n.DEPTH_COMPONENT&&g.type!==Ps&&g.type!==Mn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),g.type=Mn,Ae=s.convert(g.type)),g.format===hi&&_e===n.DEPTH_COMPONENT&&(_e=n.DEPTH_STENCIL,g.type!==Bn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),g.type=Bn,Ae=s.convert(g.type))),et&&(Ve?t.texStorage2D(n.TEXTURE_2D,1,_e,$.width,$.height):t.texImage2D(n.TEXTURE_2D,0,_e,$.width,$.height,0,He,Ae,null));else if(g.isDataTexture)if(De.length>0&&Xe){Ve&&et&&t.texStorage2D(n.TEXTURE_2D,Oe,_e,De[0].width,De[0].height);for(let te=0,A=De.length;te<A;te++)ue=De[te],Ve?t.texSubImage2D(n.TEXTURE_2D,te,0,0,ue.width,ue.height,He,Ae,ue.data):t.texImage2D(n.TEXTURE_2D,te,_e,ue.width,ue.height,0,He,Ae,ue.data);g.generateMipmaps=!1}else Ve?(et&&t.texStorage2D(n.TEXTURE_2D,Oe,_e,$.width,$.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,$.width,$.height,He,Ae,$.data)):t.texImage2D(n.TEXTURE_2D,0,_e,$.width,$.height,0,He,Ae,$.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ve&&et&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Oe,_e,De[0].width,De[0].height,$.depth);for(let te=0,A=De.length;te<A;te++)ue=De[te],g.format!==zt?He!==null?Ve?t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ue.width,ue.height,$.depth,He,ue.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,te,_e,ue.width,ue.height,$.depth,0,ue.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?t.texSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ue.width,ue.height,$.depth,He,Ae,ue.data):t.texImage3D(n.TEXTURE_2D_ARRAY,te,_e,ue.width,ue.height,$.depth,0,He,Ae,ue.data)}else{Ve&&et&&t.texStorage2D(n.TEXTURE_2D,Oe,_e,De[0].width,De[0].height);for(let te=0,A=De.length;te<A;te++)ue=De[te],g.format!==zt?He!==null?Ve?t.compressedTexSubImage2D(n.TEXTURE_2D,te,0,0,ue.width,ue.height,He,ue.data):t.compressedTexImage2D(n.TEXTURE_2D,te,_e,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?t.texSubImage2D(n.TEXTURE_2D,te,0,0,ue.width,ue.height,He,Ae,ue.data):t.texImage2D(n.TEXTURE_2D,te,_e,ue.width,ue.height,0,He,Ae,ue.data)}else if(g.isDataArrayTexture)Ve?(et&&t.texStorage3D(n.TEXTURE_2D_ARRAY,Oe,_e,$.width,$.height,$.depth),t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,He,Ae,$.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,_e,$.width,$.height,$.depth,0,He,Ae,$.data);else if(g.isData3DTexture)Ve?(et&&t.texStorage3D(n.TEXTURE_3D,Oe,_e,$.width,$.height,$.depth),t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,He,Ae,$.data)):t.texImage3D(n.TEXTURE_3D,0,_e,$.width,$.height,$.depth,0,He,Ae,$.data);else if(g.isFramebufferTexture){if(et)if(Ve)t.texStorage2D(n.TEXTURE_2D,Oe,_e,$.width,$.height);else{let te=$.width,A=$.height;for(let re=0;re<Oe;re++)t.texImage2D(n.TEXTURE_2D,re,_e,te,A,0,He,Ae,null),te>>=1,A>>=1}}else if(De.length>0&&Xe){Ve&&et&&t.texStorage2D(n.TEXTURE_2D,Oe,_e,De[0].width,De[0].height);for(let te=0,A=De.length;te<A;te++)ue=De[te],Ve?t.texSubImage2D(n.TEXTURE_2D,te,0,0,He,Ae,ue):t.texImage2D(n.TEXTURE_2D,te,_e,He,Ae,ue);g.generateMipmaps=!1}else Ve?(et&&t.texStorage2D(n.TEXTURE_2D,Oe,_e,$.width,$.height),t.texSubImage2D(n.TEXTURE_2D,0,0,0,He,Ae,$)):t.texImage2D(n.TEXTURE_2D,0,_e,He,Ae,$);T(g,Xe)&&E(Z),de.__version=J.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function ge(M,g,I){if(g.image.length!==6)return;const Z=Y(M,g),K=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,M.__webglTexture,n.TEXTURE0+I);const J=i.get(K);if(K.version!==J.__version||Z===!0){t.activeTexture(n.TEXTURE0+I);const de=qe.getPrimaries(qe.workingColorSpace),ae=g.colorSpace===Ht?null:qe.getPrimaries(g.colorSpace),ce=g.colorSpace===Ht||de===ae?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce);const Se=g.isCompressedTexture||g.image[0].isCompressedTexture,Ne=g.image[0]&&g.image[0].isDataTexture,$=[];for(let te=0;te<6;te++)!Se&&!Ne?$[te]=_(g.image[te],!1,!0,r.maxCubemapSize):$[te]=Ne?g.image[te].image:g.image[te],$[te]=Ie(g,$[te]);const Xe=$[0],He=d(Xe)||a,Ae=s.convert(g.format,g.colorSpace),_e=s.convert(g.type),ue=b(g.internalFormat,Ae,_e,g.colorSpace),De=a&&g.isVideoTexture!==!0,Ve=J.__version===void 0||Z===!0;let et=L(g,Xe,He);z(n.TEXTURE_CUBE_MAP,g,He);let Oe;if(Se){De&&Ve&&t.texStorage2D(n.TEXTURE_CUBE_MAP,et,ue,Xe.width,Xe.height);for(let te=0;te<6;te++){Oe=$[te].mipmaps;for(let A=0;A<Oe.length;A++){const re=Oe[A];g.format!==zt?Ae!==null?De?t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A,0,0,re.width,re.height,Ae,re.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A,ue,re.width,re.height,0,re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):De?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A,0,0,re.width,re.height,Ae,_e,re.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A,ue,re.width,re.height,0,Ae,_e,re.data)}}}else{Oe=g.mipmaps,De&&Ve&&(Oe.length>0&&et++,t.texStorage2D(n.TEXTURE_CUBE_MAP,et,ue,$[0].width,$[0].height));for(let te=0;te<6;te++)if(Ne){De?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,$[te].width,$[te].height,Ae,_e,$[te].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,ue,$[te].width,$[te].height,0,Ae,_e,$[te].data);for(let A=0;A<Oe.length;A++){const se=Oe[A].image[te].image;De?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A+1,0,0,se.width,se.height,Ae,_e,se.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A+1,ue,se.width,se.height,0,Ae,_e,se.data)}}else{De?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,Ae,_e,$[te]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,ue,Ae,_e,$[te]);for(let A=0;A<Oe.length;A++){const re=Oe[A];De?t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A+1,0,0,Ae,_e,re.image[te]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+te,A+1,ue,Ae,_e,re.image[te])}}}T(g,He)&&E(n.TEXTURE_CUBE_MAP),J.__version=K.version,g.onUpdate&&g.onUpdate(g)}M.__version=g.version}function me(M,g,I,Z,K,J){const de=s.convert(I.format,I.colorSpace),ae=s.convert(I.type),ce=b(I.internalFormat,de,ae,I.colorSpace);if(!i.get(g).__hasExternalTextures){const Ne=Math.max(1,g.width>>J),$=Math.max(1,g.height>>J);K===n.TEXTURE_3D||K===n.TEXTURE_2D_ARRAY?t.texImage3D(K,J,ce,Ne,$,g.depth,0,de,ae,null):t.texImage2D(K,J,ce,Ne,$,0,de,ae,null)}t.bindFramebuffer(n.FRAMEBUFFER,M),fe(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Z,K,i.get(I).__webglTexture,0,we(g)):(K===n.TEXTURE_2D||K>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,Z,K,i.get(I).__webglTexture,J),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ce(M,g,I){if(n.bindRenderbuffer(n.RENDERBUFFER,M),g.depthBuffer&&!g.stencilBuffer){let Z=a===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(I||fe(g)){const K=g.depthTexture;K&&K.isDepthTexture&&(K.type===Sn?Z=n.DEPTH_COMPONENT32F:K.type===Mn&&(Z=n.DEPTH_COMPONENT24));const J=we(g);fe(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,J,Z,g.width,g.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,J,Z,g.width,g.height)}else n.renderbufferStorage(n.RENDERBUFFER,Z,g.width,g.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,M)}else if(g.depthBuffer&&g.stencilBuffer){const Z=we(g);I&&fe(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Z,n.DEPTH24_STENCIL8,g.width,g.height):fe(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Z,n.DEPTH24_STENCIL8,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,M)}else{const Z=g.isWebGLMultipleRenderTargets===!0?g.texture:[g.texture];for(let K=0;K<Z.length;K++){const J=Z[K],de=s.convert(J.format,J.colorSpace),ae=s.convert(J.type),ce=b(J.internalFormat,de,ae,J.colorSpace),Se=we(g);I&&fe(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Se,ce,g.width,g.height):fe(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Se,ce,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,ce,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Le(M,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,M),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),H(g.depthTexture,0);const Z=i.get(g.depthTexture).__webglTexture,K=we(g);if(g.depthTexture.format===zn)fe(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0,K):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,Z,0);else if(g.depthTexture.format===hi)fe(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0,K):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function ye(M){const g=i.get(M),I=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!g.__autoAllocateDepthBuffer){if(I)throw new Error("target.depthTexture not supported in Cube render targets");Le(g.__webglFramebuffer,M)}else if(I){g.__webglDepthbuffer=[];for(let Z=0;Z<6;Z++)t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[Z]),g.__webglDepthbuffer[Z]=n.createRenderbuffer(),Ce(g.__webglDepthbuffer[Z],M,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=n.createRenderbuffer(),Ce(g.__webglDepthbuffer,M,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function ke(M,g,I){const Z=i.get(M);g!==void 0&&me(Z.__webglFramebuffer,M,M.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),I!==void 0&&ye(M)}function D(M){const g=M.texture,I=i.get(M),Z=i.get(g);M.addEventListener("dispose",j),M.isWebGLMultipleRenderTargets!==!0&&(Z.__webglTexture===void 0&&(Z.__webglTexture=n.createTexture()),Z.__version=g.version,o.memory.textures++);const K=M.isWebGLCubeRenderTarget===!0,J=M.isWebGLMultipleRenderTargets===!0,de=d(M)||a;if(K){I.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(a&&g.mipmaps&&g.mipmaps.length>0){I.__webglFramebuffer[ae]=[];for(let ce=0;ce<g.mipmaps.length;ce++)I.__webglFramebuffer[ae][ce]=n.createFramebuffer()}else I.__webglFramebuffer[ae]=n.createFramebuffer()}else{if(a&&g.mipmaps&&g.mipmaps.length>0){I.__webglFramebuffer=[];for(let ae=0;ae<g.mipmaps.length;ae++)I.__webglFramebuffer[ae]=n.createFramebuffer()}else I.__webglFramebuffer=n.createFramebuffer();if(J)if(r.drawBuffers){const ae=M.texture;for(let ce=0,Se=ae.length;ce<Se;ce++){const Ne=i.get(ae[ce]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=n.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&M.samples>0&&fe(M)===!1){const ae=J?g:[g];I.__webglMultisampledFramebuffer=n.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let ce=0;ce<ae.length;ce++){const Se=ae[ce];I.__webglColorRenderbuffer[ce]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,I.__webglColorRenderbuffer[ce]);const Ne=s.convert(Se.format,Se.colorSpace),$=s.convert(Se.type),Xe=b(Se.internalFormat,Ne,$,Se.colorSpace,M.isXRRenderTarget===!0),He=we(M);n.renderbufferStorageMultisample(n.RENDERBUFFER,He,Xe,M.width,M.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ce,n.RENDERBUFFER,I.__webglColorRenderbuffer[ce])}n.bindRenderbuffer(n.RENDERBUFFER,null),M.depthBuffer&&(I.__webglDepthRenderbuffer=n.createRenderbuffer(),Ce(I.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(K){t.bindTexture(n.TEXTURE_CUBE_MAP,Z.__webglTexture),z(n.TEXTURE_CUBE_MAP,g,de);for(let ae=0;ae<6;ae++)if(a&&g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)me(I.__webglFramebuffer[ae][ce],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,ce);else me(I.__webglFramebuffer[ae],M,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);T(g,de)&&E(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(J){const ae=M.texture;for(let ce=0,Se=ae.length;ce<Se;ce++){const Ne=ae[ce],$=i.get(Ne);t.bindTexture(n.TEXTURE_2D,$.__webglTexture),z(n.TEXTURE_2D,Ne,de),me(I.__webglFramebuffer,M,Ne,n.COLOR_ATTACHMENT0+ce,n.TEXTURE_2D,0),T(Ne,de)&&E(n.TEXTURE_2D)}t.unbindTexture()}else{let ae=n.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(a?ae=M.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(ae,Z.__webglTexture),z(ae,g,de),a&&g.mipmaps&&g.mipmaps.length>0)for(let ce=0;ce<g.mipmaps.length;ce++)me(I.__webglFramebuffer[ce],M,g,n.COLOR_ATTACHMENT0,ae,ce);else me(I.__webglFramebuffer,M,g,n.COLOR_ATTACHMENT0,ae,0);T(g,de)&&E(ae),t.unbindTexture()}M.depthBuffer&&ye(M)}function vt(M){const g=d(M)||a,I=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let Z=0,K=I.length;Z<K;Z++){const J=I[Z];if(T(J,g)){const de=M.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,ae=i.get(J).__webglTexture;t.bindTexture(de,ae),E(de),t.unbindTexture()}}}function ve(M){if(a&&M.samples>0&&fe(M)===!1){const g=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],I=M.width,Z=M.height;let K=n.COLOR_BUFFER_BIT;const J=[],de=M.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ae=i.get(M),ce=M.isWebGLMultipleRenderTargets===!0;if(ce)for(let Se=0;Se<g.length;Se++)t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,ae.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ae.__webglFramebuffer);for(let Se=0;Se<g.length;Se++){J.push(n.COLOR_ATTACHMENT0+Se),M.depthBuffer&&J.push(de);const Ne=ae.__ignoreDepthValues!==void 0?ae.__ignoreDepthValues:!1;if(Ne===!1&&(M.depthBuffer&&(K|=n.DEPTH_BUFFER_BIT),M.stencilBuffer&&(K|=n.STENCIL_BUFFER_BIT)),ce&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ae.__webglColorRenderbuffer[Se]),Ne===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[de]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[de])),ce){const $=i.get(g[Se]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,$,0)}n.blitFramebuffer(0,0,I,Z,0,0,I,Z,K,n.NEAREST),c&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,J)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),ce)for(let Se=0;Se<g.length;Se++){t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.RENDERBUFFER,ae.__webglColorRenderbuffer[Se]);const Ne=i.get(g[Se]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,ae.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+Se,n.TEXTURE_2D,Ne,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,ae.__webglMultisampledFramebuffer)}}function we(M){return Math.min(r.maxSamples,M.samples)}function fe(M){const g=i.get(M);return a&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Je(M){const g=o.render.frame;h.get(M)!==g&&(h.set(M,g),M.update())}function Ie(M,g){const I=M.colorSpace,Z=M.format,K=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===vs||I!==fn&&I!==Ht&&(qe.getTransfer(I)===je?a===!1?e.has("EXT_sRGB")===!0&&Z===zt?(M.format=vs,M.minFilter=yt,M.generateMipmaps=!1):g=$o.sRGBToLinear(g):(Z!==zt||K!==cn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",I)),g}this.allocateTextureUnit=C,this.resetTextureUnits=ie,this.setTexture2D=H,this.setTexture2DArray=X,this.setTexture3D=k,this.setTextureCube=W,this.rebindTextures=ke,this.setupRenderTarget=D,this.updateRenderTargetMipmap=vt,this.updateMultisampleRenderTarget=ve,this.setupDepthRenderbuffer=ye,this.setupFrameBufferTexture=me,this.useMultisampledRTT=fe}function Yp(n,e,t){const i=t.isWebGL2;function r(s,o=Ht){let a;const l=qe.getTransfer(o);if(s===cn)return n.UNSIGNED_BYTE;if(s===zo)return n.UNSIGNED_SHORT_4_4_4_4;if(s===Ho)return n.UNSIGNED_SHORT_5_5_5_1;if(s===wc)return n.BYTE;if(s===Rc)return n.SHORT;if(s===Ps)return n.UNSIGNED_SHORT;if(s===Bo)return n.INT;if(s===Mn)return n.UNSIGNED_INT;if(s===Sn)return n.FLOAT;if(s===Ci)return i?n.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===Cc)return n.ALPHA;if(s===zt)return n.RGBA;if(s===Pc)return n.LUMINANCE;if(s===Lc)return n.LUMINANCE_ALPHA;if(s===zn)return n.DEPTH_COMPONENT;if(s===hi)return n.DEPTH_STENCIL;if(s===vs)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===Dc)return n.RED;if(s===Go)return n.RED_INTEGER;if(s===Uc)return n.RG;if(s===ko)return n.RG_INTEGER;if(s===Vo)return n.RGBA_INTEGER;if(s===Ir||s===Nr||s===Fr||s===Or)if(l===je)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===Ir)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Nr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Fr)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Or)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===Ir)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Nr)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Fr)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Or)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Ks||s===js||s===Zs||s===Js)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===Ks)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===js)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Zs)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Js)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Wo)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Qs||s===ea)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===Qs)return l===je?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===ea)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===ta||s===na||s===ia||s===ra||s===sa||s===aa||s===oa||s===la||s===ca||s===ua||s===ha||s===fa||s===da||s===pa)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===ta)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===na)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===ia)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===ra)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===sa)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===aa)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===oa)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===la)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===ca)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ua)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===ha)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===fa)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===da)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===pa)return l===je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Br||s===ma||s===ga)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===Br)return l===je?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===ma)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===ga)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Ic||s===_a||s===va||s===xa)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===Br)return a.COMPRESSED_RED_RGTC1_EXT;if(s===_a)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===va)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===xa)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Bn?i?n.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class $p extends Bt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Si extends Pt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Kp={type:"move"};class cs{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Si,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Si,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new F,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new F),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Si,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new F,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new F),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const d=t.getJointPose(_,i),u=this._getHandJoint(c,_);d!==null&&(u.matrix.fromArray(d.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=d.radius),u.visible=d!==null}const h=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],p=h.position.distanceTo(f.position),m=.02,v=.005;c.inputState.pinching&&p>m+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(Kp)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Si;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class jp extends di{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,h=null,f=null,p=null,m=null,v=null;const _=t.getContextAttributes();let d=null,u=null;const T=[],E=[],b=new We;let L=null;const R=new Bt;R.layers.enable(1),R.viewport=new ft;const w=new Bt;w.layers.enable(2),w.viewport=new ft;const j=[R,w],S=new $p;S.layers.enable(1),S.layers.enable(2);let y=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(z){let Y=T[z];return Y===void 0&&(Y=new cs,T[z]=Y),Y.getTargetRaySpace()},this.getControllerGrip=function(z){let Y=T[z];return Y===void 0&&(Y=new cs,T[z]=Y),Y.getGripSpace()},this.getHand=function(z){let Y=T[z];return Y===void 0&&(Y=new cs,T[z]=Y),Y.getHandSpace()};function V(z){const Y=E.indexOf(z.inputSource);if(Y===-1)return;const oe=T[Y];oe!==void 0&&(oe.update(z.inputSource,z.frame,c||o),oe.dispatchEvent({type:z.type,data:z.inputSource}))}function ie(){r.removeEventListener("select",V),r.removeEventListener("selectstart",V),r.removeEventListener("selectend",V),r.removeEventListener("squeeze",V),r.removeEventListener("squeezestart",V),r.removeEventListener("squeezeend",V),r.removeEventListener("end",ie),r.removeEventListener("inputsourceschange",C);for(let z=0;z<T.length;z++){const Y=E[z];Y!==null&&(E[z]=null,T[z].disconnect(Y))}y=null,G=null,e.setRenderTarget(d),m=null,p=null,f=null,r=null,u=null,ee.stop(),i.isPresenting=!1,e.setPixelRatio(L),e.setSize(b.width,b.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(z){s=z,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(z){a=z,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(z){c=z},this.getBaseLayer=function(){return p!==null?p:m},this.getBinding=function(){return f},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(z){if(r=z,r!==null){if(d=e.getRenderTarget(),r.addEventListener("select",V),r.addEventListener("selectstart",V),r.addEventListener("selectend",V),r.addEventListener("squeeze",V),r.addEventListener("squeezestart",V),r.addEventListener("squeezeend",V),r.addEventListener("end",ie),r.addEventListener("inputsourceschange",C),_.xrCompatible!==!0&&await t.makeXRCompatible(),L=e.getPixelRatio(),e.getSize(b),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const Y={antialias:r.renderState.layers===void 0?_.antialias:!0,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,Y),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),u=new bn(m.framebufferWidth,m.framebufferHeight,{format:zt,type:cn,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil})}else{let Y=null,oe=null,ge=null;_.depth&&(ge=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Y=_.stencil?hi:zn,oe=_.stencil?Bn:Mn);const me={colorFormat:t.RGBA8,depthFormat:ge,scaleFactor:s};f=new XRWebGLBinding(r,t),p=f.createProjectionLayer(me),r.updateRenderState({layers:[p]}),e.setPixelRatio(1),e.setSize(p.textureWidth,p.textureHeight,!1),u=new bn(p.textureWidth,p.textureHeight,{format:zt,type:cn,depthTexture:new cl(p.textureWidth,p.textureHeight,oe,void 0,void 0,void 0,void 0,void 0,void 0,Y),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0});const Ce=e.properties.get(u);Ce.__ignoreDepthValues=p.ignoreDepthValues}u.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),ee.setContext(r),ee.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function C(z){for(let Y=0;Y<z.removed.length;Y++){const oe=z.removed[Y],ge=E.indexOf(oe);ge>=0&&(E[ge]=null,T[ge].disconnect(oe))}for(let Y=0;Y<z.added.length;Y++){const oe=z.added[Y];let ge=E.indexOf(oe);if(ge===-1){for(let Ce=0;Ce<T.length;Ce++)if(Ce>=E.length){E.push(oe),ge=Ce;break}else if(E[Ce]===null){E[Ce]=oe,ge=Ce;break}if(ge===-1)break}const me=T[ge];me&&me.connect(oe)}}const B=new F,H=new F;function X(z,Y,oe){B.setFromMatrixPosition(Y.matrixWorld),H.setFromMatrixPosition(oe.matrixWorld);const ge=B.distanceTo(H),me=Y.projectionMatrix.elements,Ce=oe.projectionMatrix.elements,Le=me[14]/(me[10]-1),ye=me[14]/(me[10]+1),ke=(me[9]+1)/me[5],D=(me[9]-1)/me[5],vt=(me[8]-1)/me[0],ve=(Ce[8]+1)/Ce[0],we=Le*vt,fe=Le*ve,Je=ge/(-vt+ve),Ie=Je*-vt;Y.matrixWorld.decompose(z.position,z.quaternion,z.scale),z.translateX(Ie),z.translateZ(Je),z.matrixWorld.compose(z.position,z.quaternion,z.scale),z.matrixWorldInverse.copy(z.matrixWorld).invert();const M=Le+Je,g=ye+Je,I=we-Ie,Z=fe+(ge-Ie),K=ke*ye/g*M,J=D*ye/g*M;z.projectionMatrix.makePerspective(I,Z,K,J,M,g),z.projectionMatrixInverse.copy(z.projectionMatrix).invert()}function k(z,Y){Y===null?z.matrixWorld.copy(z.matrix):z.matrixWorld.multiplyMatrices(Y.matrixWorld,z.matrix),z.matrixWorldInverse.copy(z.matrixWorld).invert()}this.updateCamera=function(z){if(r===null)return;S.near=w.near=R.near=z.near,S.far=w.far=R.far=z.far,(y!==S.near||G!==S.far)&&(r.updateRenderState({depthNear:S.near,depthFar:S.far}),y=S.near,G=S.far);const Y=z.parent,oe=S.cameras;k(S,Y);for(let ge=0;ge<oe.length;ge++)k(oe[ge],Y);oe.length===2?X(S,R,w):S.projectionMatrix.copy(R.projectionMatrix),W(z,S,Y)};function W(z,Y,oe){oe===null?z.matrix.copy(Y.matrixWorld):(z.matrix.copy(oe.matrixWorld),z.matrix.invert(),z.matrix.multiply(Y.matrixWorld)),z.matrix.decompose(z.position,z.quaternion,z.scale),z.updateMatrixWorld(!0),z.projectionMatrix.copy(Y.projectionMatrix),z.projectionMatrixInverse.copy(Y.projectionMatrixInverse),z.isPerspectiveCamera&&(z.fov=xs*2*Math.atan(1/z.projectionMatrix.elements[5]),z.zoom=1)}this.getCamera=function(){return S},this.getFoveation=function(){if(!(p===null&&m===null))return l},this.setFoveation=function(z){l=z,p!==null&&(p.fixedFoveation=z),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=z)};let q=null;function Q(z,Y){if(h=Y.getViewerPose(c||o),v=Y,h!==null){const oe=h.views;m!==null&&(e.setRenderTargetFramebuffer(u,m.framebuffer),e.setRenderTarget(u));let ge=!1;oe.length!==S.cameras.length&&(S.cameras.length=0,ge=!0);for(let me=0;me<oe.length;me++){const Ce=oe[me];let Le=null;if(m!==null)Le=m.getViewport(Ce);else{const ke=f.getViewSubImage(p,Ce);Le=ke.viewport,me===0&&(e.setRenderTargetTextures(u,ke.colorTexture,p.ignoreDepthValues?void 0:ke.depthStencilTexture),e.setRenderTarget(u))}let ye=j[me];ye===void 0&&(ye=new Bt,ye.layers.enable(me),ye.viewport=new ft,j[me]=ye),ye.matrix.fromArray(Ce.transform.matrix),ye.matrix.decompose(ye.position,ye.quaternion,ye.scale),ye.projectionMatrix.fromArray(Ce.projectionMatrix),ye.projectionMatrixInverse.copy(ye.projectionMatrix).invert(),ye.viewport.set(Le.x,Le.y,Le.width,Le.height),me===0&&(S.matrix.copy(ye.matrix),S.matrix.decompose(S.position,S.quaternion,S.scale)),ge===!0&&S.cameras.push(ye)}}for(let oe=0;oe<T.length;oe++){const ge=E[oe],me=T[oe];ge!==null&&me!==void 0&&me.update(ge,Y,c||o)}q&&q(z,Y),Y.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Y}),v=null}const ee=new ol;ee.setAnimationLoop(Q),this.setAnimationLoop=function(z){q=z},this.dispose=function(){}}}function Zp(n,e){function t(d,u){d.matrixAutoUpdate===!0&&d.updateMatrix(),u.value.copy(d.matrix)}function i(d,u){u.color.getRGB(d.fogColor.value,il(n)),u.isFog?(d.fogNear.value=u.near,d.fogFar.value=u.far):u.isFogExp2&&(d.fogDensity.value=u.density)}function r(d,u,T,E,b){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(d,u):u.isMeshToonMaterial?(s(d,u),f(d,u)):u.isMeshPhongMaterial?(s(d,u),h(d,u)):u.isMeshStandardMaterial?(s(d,u),p(d,u),u.isMeshPhysicalMaterial&&m(d,u,b)):u.isMeshMatcapMaterial?(s(d,u),v(d,u)):u.isMeshDepthMaterial?s(d,u):u.isMeshDistanceMaterial?(s(d,u),_(d,u)):u.isMeshNormalMaterial?s(d,u):u.isLineBasicMaterial?(o(d,u),u.isLineDashedMaterial&&a(d,u)):u.isPointsMaterial?l(d,u,T,E):u.isSpriteMaterial?c(d,u):u.isShadowMaterial?(d.color.value.copy(u.color),d.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(d,u){d.opacity.value=u.opacity,u.color&&d.diffuse.value.copy(u.color),u.emissive&&d.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(d.map.value=u.map,t(u.map,d.mapTransform)),u.alphaMap&&(d.alphaMap.value=u.alphaMap,t(u.alphaMap,d.alphaMapTransform)),u.bumpMap&&(d.bumpMap.value=u.bumpMap,t(u.bumpMap,d.bumpMapTransform),d.bumpScale.value=u.bumpScale,u.side===Rt&&(d.bumpScale.value*=-1)),u.normalMap&&(d.normalMap.value=u.normalMap,t(u.normalMap,d.normalMapTransform),d.normalScale.value.copy(u.normalScale),u.side===Rt&&d.normalScale.value.negate()),u.displacementMap&&(d.displacementMap.value=u.displacementMap,t(u.displacementMap,d.displacementMapTransform),d.displacementScale.value=u.displacementScale,d.displacementBias.value=u.displacementBias),u.emissiveMap&&(d.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,d.emissiveMapTransform)),u.specularMap&&(d.specularMap.value=u.specularMap,t(u.specularMap,d.specularMapTransform)),u.alphaTest>0&&(d.alphaTest.value=u.alphaTest);const T=e.get(u).envMap;if(T&&(d.envMap.value=T,d.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,d.reflectivity.value=u.reflectivity,d.ior.value=u.ior,d.refractionRatio.value=u.refractionRatio),u.lightMap){d.lightMap.value=u.lightMap;const E=n._useLegacyLights===!0?Math.PI:1;d.lightMapIntensity.value=u.lightMapIntensity*E,t(u.lightMap,d.lightMapTransform)}u.aoMap&&(d.aoMap.value=u.aoMap,d.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,d.aoMapTransform))}function o(d,u){d.diffuse.value.copy(u.color),d.opacity.value=u.opacity,u.map&&(d.map.value=u.map,t(u.map,d.mapTransform))}function a(d,u){d.dashSize.value=u.dashSize,d.totalSize.value=u.dashSize+u.gapSize,d.scale.value=u.scale}function l(d,u,T,E){d.diffuse.value.copy(u.color),d.opacity.value=u.opacity,d.size.value=u.size*T,d.scale.value=E*.5,u.map&&(d.map.value=u.map,t(u.map,d.uvTransform)),u.alphaMap&&(d.alphaMap.value=u.alphaMap,t(u.alphaMap,d.alphaMapTransform)),u.alphaTest>0&&(d.alphaTest.value=u.alphaTest)}function c(d,u){d.diffuse.value.copy(u.color),d.opacity.value=u.opacity,d.rotation.value=u.rotation,u.map&&(d.map.value=u.map,t(u.map,d.mapTransform)),u.alphaMap&&(d.alphaMap.value=u.alphaMap,t(u.alphaMap,d.alphaMapTransform)),u.alphaTest>0&&(d.alphaTest.value=u.alphaTest)}function h(d,u){d.specular.value.copy(u.specular),d.shininess.value=Math.max(u.shininess,1e-4)}function f(d,u){u.gradientMap&&(d.gradientMap.value=u.gradientMap)}function p(d,u){d.metalness.value=u.metalness,u.metalnessMap&&(d.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,d.metalnessMapTransform)),d.roughness.value=u.roughness,u.roughnessMap&&(d.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,d.roughnessMapTransform)),e.get(u).envMap&&(d.envMapIntensity.value=u.envMapIntensity)}function m(d,u,T){d.ior.value=u.ior,u.sheen>0&&(d.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),d.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(d.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,d.sheenColorMapTransform)),u.sheenRoughnessMap&&(d.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,d.sheenRoughnessMapTransform))),u.clearcoat>0&&(d.clearcoat.value=u.clearcoat,d.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(d.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,d.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(d.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,d.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(d.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,d.clearcoatNormalMapTransform),d.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Rt&&d.clearcoatNormalScale.value.negate())),u.iridescence>0&&(d.iridescence.value=u.iridescence,d.iridescenceIOR.value=u.iridescenceIOR,d.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],d.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(d.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,d.iridescenceMapTransform)),u.iridescenceThicknessMap&&(d.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,d.iridescenceThicknessMapTransform))),u.transmission>0&&(d.transmission.value=u.transmission,d.transmissionSamplerMap.value=T.texture,d.transmissionSamplerSize.value.set(T.width,T.height),u.transmissionMap&&(d.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,d.transmissionMapTransform)),d.thickness.value=u.thickness,u.thicknessMap&&(d.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,d.thicknessMapTransform)),d.attenuationDistance.value=u.attenuationDistance,d.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(d.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(d.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,d.anisotropyMapTransform))),d.specularIntensity.value=u.specularIntensity,d.specularColor.value.copy(u.specularColor),u.specularColorMap&&(d.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,d.specularColorMapTransform)),u.specularIntensityMap&&(d.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,d.specularIntensityMapTransform))}function v(d,u){u.matcap&&(d.matcap.value=u.matcap)}function _(d,u){const T=e.get(u).light;d.referencePosition.value.setFromMatrixPosition(T.matrixWorld),d.nearDistance.value=T.shadow.camera.near,d.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Jp(n,e,t,i){let r={},s={},o=[];const a=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(T,E){const b=E.program;i.uniformBlockBinding(T,b)}function c(T,E){let b=r[T.id];b===void 0&&(v(T),b=h(T),r[T.id]=b,T.addEventListener("dispose",d));const L=E.program;i.updateUBOMapping(T,L);const R=e.render.frame;s[T.id]!==R&&(p(T),s[T.id]=R)}function h(T){const E=f();T.__bindingPointIndex=E;const b=n.createBuffer(),L=T.__size,R=T.usage;return n.bindBuffer(n.UNIFORM_BUFFER,b),n.bufferData(n.UNIFORM_BUFFER,L,R),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,E,b),b}function f(){for(let T=0;T<a;T++)if(o.indexOf(T)===-1)return o.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(T){const E=r[T.id],b=T.uniforms,L=T.__cache;n.bindBuffer(n.UNIFORM_BUFFER,E);for(let R=0,w=b.length;R<w;R++){const j=Array.isArray(b[R])?b[R]:[b[R]];for(let S=0,y=j.length;S<y;S++){const G=j[S];if(m(G,R,S,L)===!0){const V=G.__offset,ie=Array.isArray(G.value)?G.value:[G.value];let C=0;for(let B=0;B<ie.length;B++){const H=ie[B],X=_(H);typeof H=="number"||typeof H=="boolean"?(G.__data[0]=H,n.bufferSubData(n.UNIFORM_BUFFER,V+C,G.__data)):H.isMatrix3?(G.__data[0]=H.elements[0],G.__data[1]=H.elements[1],G.__data[2]=H.elements[2],G.__data[3]=0,G.__data[4]=H.elements[3],G.__data[5]=H.elements[4],G.__data[6]=H.elements[5],G.__data[7]=0,G.__data[8]=H.elements[6],G.__data[9]=H.elements[7],G.__data[10]=H.elements[8],G.__data[11]=0):(H.toArray(G.__data,C),C+=X.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,V,G.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(T,E,b,L){const R=T.value,w=E+"_"+b;if(L[w]===void 0)return typeof R=="number"||typeof R=="boolean"?L[w]=R:L[w]=R.clone(),!0;{const j=L[w];if(typeof R=="number"||typeof R=="boolean"){if(j!==R)return L[w]=R,!0}else if(j.equals(R)===!1)return j.copy(R),!0}return!1}function v(T){const E=T.uniforms;let b=0;const L=16;for(let w=0,j=E.length;w<j;w++){const S=Array.isArray(E[w])?E[w]:[E[w]];for(let y=0,G=S.length;y<G;y++){const V=S[y],ie=Array.isArray(V.value)?V.value:[V.value];for(let C=0,B=ie.length;C<B;C++){const H=ie[C],X=_(H),k=b%L;k!==0&&L-k<X.boundary&&(b+=L-k),V.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),V.__offset=b,b+=X.storage}}}const R=b%L;return R>0&&(b+=L-R),T.__size=b,T.__cache={},this}function _(T){const E={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(E.boundary=4,E.storage=4):T.isVector2?(E.boundary=8,E.storage=8):T.isVector3||T.isColor?(E.boundary=16,E.storage=12):T.isVector4?(E.boundary=16,E.storage=16):T.isMatrix3?(E.boundary=48,E.storage=48):T.isMatrix4?(E.boundary=64,E.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),E}function d(T){const E=T.target;E.removeEventListener("dispose",d);const b=o.indexOf(E.__bindingPointIndex);o.splice(b,1),n.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function u(){for(const T in r)n.deleteBuffer(r[T]);o=[],r={},s={}}return{bind:l,update:c,dispose:u}}class ml{constructor(e={}){const{canvas:t=Yc(),context:i=null,depth:r=!0,stencil:s=!0,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let p;i!==null?p=i.getContextAttributes().alpha:p=o;const m=new Uint32Array(4),v=new Int32Array(4);let _=null,d=null;const u=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ct,this._useLegacyLights=!1,this.toneMapping=yn,this.toneMappingExposure=1;const E=this;let b=!1,L=0,R=0,w=null,j=-1,S=null;const y=new ft,G=new ft;let V=null;const ie=new Ee(0);let C=0,B=t.width,H=t.height,X=1,k=null,W=null;const q=new ft(0,0,B,H),Q=new ft(0,0,B,H);let ee=!1;const z=new al;let Y=!1,oe=!1,ge=null;const me=new ut,Ce=new We,Le=new F,ye={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function ke(){return w===null?X:1}let D=i;function vt(x,P){for(let N=0;N<x.length;N++){const O=x[N],U=t.getContext(O,P);if(U!==null)return U}return null}try{const x={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Cs}`),t.addEventListener("webglcontextlost",te,!1),t.addEventListener("webglcontextrestored",A,!1),t.addEventListener("webglcontextcreationerror",re,!1),D===null){const P=["webgl2","webgl","experimental-webgl"];if(E.isWebGL1Renderer===!0&&P.shift(),D=vt(P,x),D===null)throw vt(P)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&D instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),D.getShaderPrecisionFormat===void 0&&(D.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(x){throw console.error("THREE.WebGLRenderer: "+x.message),x}let ve,we,fe,Je,Ie,M,g,I,Z,K,J,de,ae,ce,Se,Ne,$,Xe,He,Ae,_e,ue,De,Ve;function et(){ve=new ld(D),we=new nd(D,ve,e),ve.init(we),ue=new Yp(D,ve,we),fe=new Xp(D,ve,we),Je=new hd(D),Ie=new Lp,M=new qp(D,ve,fe,Ie,we,ue,Je),g=new rd(E),I=new od(E),Z=new vu(D,we),De=new ed(D,ve,Z,we),K=new cd(D,Z,Je,De),J=new md(D,K,Z,Je),He=new pd(D,we,M),Ne=new id(Ie),de=new Pp(E,g,I,ve,we,De,Ne),ae=new Zp(E,Ie),ce=new Up,Se=new zp(ve,we),Xe=new Qf(E,g,I,fe,J,p,l),$=new Wp(E,J,we),Ve=new Jp(D,Je,we,fe),Ae=new td(D,ve,Je,we),_e=new ud(D,ve,Je,we),Je.programs=de.programs,E.capabilities=we,E.extensions=ve,E.properties=Ie,E.renderLists=ce,E.shadowMap=$,E.state=fe,E.info=Je}et();const Oe=new jp(E,D);this.xr=Oe,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const x=ve.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=ve.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return X},this.setPixelRatio=function(x){x!==void 0&&(X=x,this.setSize(B,H,!1))},this.getSize=function(x){return x.set(B,H)},this.setSize=function(x,P,N=!0){if(Oe.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}B=x,H=P,t.width=Math.floor(x*X),t.height=Math.floor(P*X),N===!0&&(t.style.width=x+"px",t.style.height=P+"px"),this.setViewport(0,0,x,P)},this.getDrawingBufferSize=function(x){return x.set(B*X,H*X).floor()},this.setDrawingBufferSize=function(x,P,N){B=x,H=P,X=N,t.width=Math.floor(x*N),t.height=Math.floor(P*N),this.setViewport(0,0,x,P)},this.getCurrentViewport=function(x){return x.copy(y)},this.getViewport=function(x){return x.copy(q)},this.setViewport=function(x,P,N,O){x.isVector4?q.set(x.x,x.y,x.z,x.w):q.set(x,P,N,O),fe.viewport(y.copy(q).multiplyScalar(X).floor())},this.getScissor=function(x){return x.copy(Q)},this.setScissor=function(x,P,N,O){x.isVector4?Q.set(x.x,x.y,x.z,x.w):Q.set(x,P,N,O),fe.scissor(G.copy(Q).multiplyScalar(X).floor())},this.getScissorTest=function(){return ee},this.setScissorTest=function(x){fe.setScissorTest(ee=x)},this.setOpaqueSort=function(x){k=x},this.setTransparentSort=function(x){W=x},this.getClearColor=function(x){return x.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor.apply(Xe,arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha.apply(Xe,arguments)},this.clear=function(x=!0,P=!0,N=!0){let O=0;if(x){let U=!1;if(w!==null){const le=w.texture.format;U=le===Vo||le===ko||le===Go}if(U){const le=w.texture.type,pe=le===cn||le===Mn||le===Ps||le===Bn||le===zo||le===Ho,Me=Xe.getClearColor(),be=Xe.getClearAlpha(),Fe=Me.r,Re=Me.g,Pe=Me.b;pe?(m[0]=Fe,m[1]=Re,m[2]=Pe,m[3]=be,D.clearBufferuiv(D.COLOR,0,m)):(v[0]=Fe,v[1]=Re,v[2]=Pe,v[3]=be,D.clearBufferiv(D.COLOR,0,v))}else O|=D.COLOR_BUFFER_BIT}P&&(O|=D.DEPTH_BUFFER_BIT),N&&(O|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),D.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",te,!1),t.removeEventListener("webglcontextrestored",A,!1),t.removeEventListener("webglcontextcreationerror",re,!1),ce.dispose(),Se.dispose(),Ie.dispose(),g.dispose(),I.dispose(),J.dispose(),De.dispose(),Ve.dispose(),de.dispose(),Oe.dispose(),Oe.removeEventListener("sessionstart",xt),Oe.removeEventListener("sessionend",Ke),ge&&(ge.dispose(),ge=null),Mt.stop()};function te(x){x.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),b=!0}function A(){console.log("THREE.WebGLRenderer: Context Restored."),b=!1;const x=Je.autoReset,P=$.enabled,N=$.autoUpdate,O=$.needsUpdate,U=$.type;et(),Je.autoReset=x,$.enabled=P,$.autoUpdate=N,$.needsUpdate=O,$.type=U}function re(x){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function se(x){const P=x.target;P.removeEventListener("dispose",se),Te(P)}function Te(x){xe(x),Ie.remove(x)}function xe(x){const P=Ie.get(x).programs;P!==void 0&&(P.forEach(function(N){de.releaseProgram(N)}),x.isShaderMaterial&&de.releaseShaderCache(x))}this.renderBufferDirect=function(x,P,N,O,U,le){P===null&&(P=ye);const pe=U.isMesh&&U.matrixWorld.determinant()<0,Me=Sl(x,P,N,O,U);fe.setMaterial(O,pe);let be=N.index,Fe=1;if(O.wireframe===!0){if(be=K.getWireframeAttribute(N),be===void 0)return;Fe=2}const Re=N.drawRange,Pe=N.attributes.position;let nt=Re.start*Fe,Dt=(Re.start+Re.count)*Fe;le!==null&&(nt=Math.max(nt,le.start*Fe),Dt=Math.min(Dt,(le.start+le.count)*Fe)),be!==null?(nt=Math.max(nt,0),Dt=Math.min(Dt,be.count)):Pe!=null&&(nt=Math.max(nt,0),Dt=Math.min(Dt,Pe.count));const ot=Dt-nt;if(ot<0||ot===1/0)return;De.setup(U,O,Me,N,be);let Jt,Qe=Ae;if(be!==null&&(Jt=Z.get(be),Qe=_e,Qe.setIndex(Jt)),U.isMesh)O.wireframe===!0?(fe.setLineWidth(O.wireframeLinewidth*ke()),Qe.setMode(D.LINES)):Qe.setMode(D.TRIANGLES);else if(U.isLine){let Be=O.linewidth;Be===void 0&&(Be=1),fe.setLineWidth(Be*ke()),U.isLineSegments?Qe.setMode(D.LINES):U.isLineLoop?Qe.setMode(D.LINE_LOOP):Qe.setMode(D.LINE_STRIP)}else U.isPoints?Qe.setMode(D.POINTS):U.isSprite&&Qe.setMode(D.TRIANGLES);if(U.isBatchedMesh)Qe.renderMultiDraw(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount);else if(U.isInstancedMesh)Qe.renderInstances(nt,ot,U.count);else if(N.isInstancedBufferGeometry){const Be=N._maxInstanceCount!==void 0?N._maxInstanceCount:1/0,Cr=Math.min(N.instanceCount,Be);Qe.renderInstances(nt,ot,Cr)}else Qe.render(nt,ot)};function Ye(x,P,N){x.transparent===!0&&x.side===on&&x.forceSinglePass===!1?(x.side=Rt,x.needsUpdate=!0,Fi(x,P,N),x.side=Tn,x.needsUpdate=!0,Fi(x,P,N),x.side=on):Fi(x,P,N)}this.compile=function(x,P,N=null){N===null&&(N=x),d=Se.get(N),d.init(),T.push(d),N.traverseVisible(function(U){U.isLight&&U.layers.test(P.layers)&&(d.pushLight(U),U.castShadow&&d.pushShadow(U))}),x!==N&&x.traverseVisible(function(U){U.isLight&&U.layers.test(P.layers)&&(d.pushLight(U),U.castShadow&&d.pushShadow(U))}),d.setupLights(E._useLegacyLights);const O=new Set;return x.traverse(function(U){const le=U.material;if(le)if(Array.isArray(le))for(let pe=0;pe<le.length;pe++){const Me=le[pe];Ye(Me,N,U),O.add(Me)}else Ye(le,N,U),O.add(le)}),T.pop(),d=null,O},this.compileAsync=function(x,P,N=null){const O=this.compile(x,P,N);return new Promise(U=>{function le(){if(O.forEach(function(pe){Ie.get(pe).currentProgram.isReady()&&O.delete(pe)}),O.size===0){U(x);return}setTimeout(le,10)}ve.get("KHR_parallel_shader_compile")!==null?le():setTimeout(le,10)})};let $e=null;function at(x){$e&&$e(x)}function xt(){Mt.stop()}function Ke(){Mt.start()}const Mt=new ol;Mt.setAnimationLoop(at),typeof self<"u"&&Mt.setContext(self),this.setAnimationLoop=function(x){$e=x,Oe.setAnimationLoop(x),x===null?Mt.stop():Mt.start()},Oe.addEventListener("sessionstart",xt),Oe.addEventListener("sessionend",Ke),this.render=function(x,P){if(P!==void 0&&P.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),P.parent===null&&P.matrixWorldAutoUpdate===!0&&P.updateMatrixWorld(),Oe.enabled===!0&&Oe.isPresenting===!0&&(Oe.cameraAutoUpdate===!0&&Oe.updateCamera(P),P=Oe.getCamera()),x.isScene===!0&&x.onBeforeRender(E,x,P,w),d=Se.get(x,T.length),d.init(),T.push(d),me.multiplyMatrices(P.projectionMatrix,P.matrixWorldInverse),z.setFromProjectionMatrix(me),oe=this.localClippingEnabled,Y=Ne.init(this.clippingPlanes,oe),_=ce.get(x,u.length),_.init(),u.push(_),$t(x,P,0,E.sortObjects),_.finish(),E.sortObjects===!0&&_.sort(k,W),this.info.render.frame++,Y===!0&&Ne.beginShadows();const N=d.state.shadowsArray;if($.render(N,x,P),Y===!0&&Ne.endShadows(),this.info.autoReset===!0&&this.info.reset(),Xe.render(_,x),d.setupLights(E._useLegacyLights),P.isArrayCamera){const O=P.cameras;for(let U=0,le=O.length;U<le;U++){const pe=O[U];Fs(_,x,pe,pe.viewport)}}else Fs(_,x,P);w!==null&&(M.updateMultisampleRenderTarget(w),M.updateRenderTargetMipmap(w)),x.isScene===!0&&x.onAfterRender(E,x,P),De.resetDefaultState(),j=-1,S=null,T.pop(),T.length>0?d=T[T.length-1]:d=null,u.pop(),u.length>0?_=u[u.length-1]:_=null};function $t(x,P,N,O){if(x.visible===!1)return;if(x.layers.test(P.layers)){if(x.isGroup)N=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(P);else if(x.isLight)d.pushLight(x),x.castShadow&&d.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||z.intersectsSprite(x)){O&&Le.setFromMatrixPosition(x.matrixWorld).applyMatrix4(me);const pe=J.update(x),Me=x.material;Me.visible&&_.push(x,pe,Me,N,Le.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||z.intersectsObject(x))){const pe=J.update(x),Me=x.material;if(O&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),Le.copy(x.boundingSphere.center)):(pe.boundingSphere===null&&pe.computeBoundingSphere(),Le.copy(pe.boundingSphere.center)),Le.applyMatrix4(x.matrixWorld).applyMatrix4(me)),Array.isArray(Me)){const be=pe.groups;for(let Fe=0,Re=be.length;Fe<Re;Fe++){const Pe=be[Fe],nt=Me[Pe.materialIndex];nt&&nt.visible&&_.push(x,pe,nt,N,Le.z,Pe)}}else Me.visible&&_.push(x,pe,Me,N,Le.z,null)}}const le=x.children;for(let pe=0,Me=le.length;pe<Me;pe++)$t(le[pe],P,N,O)}function Fs(x,P,N,O){const U=x.opaque,le=x.transmissive,pe=x.transparent;d.setupLightsView(N),Y===!0&&Ne.setGlobalState(E.clippingPlanes,N),le.length>0&&Ml(U,le,P,N),O&&fe.viewport(y.copy(O)),U.length>0&&Ni(U,P,N),le.length>0&&Ni(le,P,N),pe.length>0&&Ni(pe,P,N),fe.buffers.depth.setTest(!0),fe.buffers.depth.setMask(!0),fe.buffers.color.setMask(!0),fe.setPolygonOffset(!1)}function Ml(x,P,N,O){if((N.isScene===!0?N.overrideMaterial:null)!==null)return;const le=we.isWebGL2;ge===null&&(ge=new bn(1,1,{generateMipmaps:!0,type:ve.has("EXT_color_buffer_half_float")?Ci:cn,minFilter:Ri,samples:le?4:0})),E.getDrawingBufferSize(Ce),le?ge.setSize(Ce.x,Ce.y):ge.setSize(Ms(Ce.x),Ms(Ce.y));const pe=E.getRenderTarget();E.setRenderTarget(ge),E.getClearColor(ie),C=E.getClearAlpha(),C<1&&E.setClearColor(16777215,.5),E.clear();const Me=E.toneMapping;E.toneMapping=yn,Ni(x,N,O),M.updateMultisampleRenderTarget(ge),M.updateRenderTargetMipmap(ge);let be=!1;for(let Fe=0,Re=P.length;Fe<Re;Fe++){const Pe=P[Fe],nt=Pe.object,Dt=Pe.geometry,ot=Pe.material,Jt=Pe.group;if(ot.side===on&&nt.layers.test(O.layers)){const Qe=ot.side;ot.side=Rt,ot.needsUpdate=!0,Os(nt,N,O,Dt,ot,Jt),ot.side=Qe,ot.needsUpdate=!0,be=!0}}be===!0&&(M.updateMultisampleRenderTarget(ge),M.updateRenderTargetMipmap(ge)),E.setRenderTarget(pe),E.setClearColor(ie,C),E.toneMapping=Me}function Ni(x,P,N){const O=P.isScene===!0?P.overrideMaterial:null;for(let U=0,le=x.length;U<le;U++){const pe=x[U],Me=pe.object,be=pe.geometry,Fe=O===null?pe.material:O,Re=pe.group;Me.layers.test(N.layers)&&Os(Me,P,N,be,Fe,Re)}}function Os(x,P,N,O,U,le){x.onBeforeRender(E,P,N,O,U,le),x.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),U.onBeforeRender(E,P,N,O,x,le),U.transparent===!0&&U.side===on&&U.forceSinglePass===!1?(U.side=Rt,U.needsUpdate=!0,E.renderBufferDirect(N,P,O,U,x,le),U.side=Tn,U.needsUpdate=!0,E.renderBufferDirect(N,P,O,U,x,le),U.side=on):E.renderBufferDirect(N,P,O,U,x,le),x.onAfterRender(E,P,N,O,U,le)}function Fi(x,P,N){P.isScene!==!0&&(P=ye);const O=Ie.get(x),U=d.state.lights,le=d.state.shadowsArray,pe=U.state.version,Me=de.getParameters(x,U.state,le,P,N),be=de.getProgramCacheKey(Me);let Fe=O.programs;O.environment=x.isMeshStandardMaterial?P.environment:null,O.fog=P.fog,O.envMap=(x.isMeshStandardMaterial?I:g).get(x.envMap||O.environment),Fe===void 0&&(x.addEventListener("dispose",se),Fe=new Map,O.programs=Fe);let Re=Fe.get(be);if(Re!==void 0){if(O.currentProgram===Re&&O.lightsStateVersion===pe)return zs(x,Me),Re}else Me.uniforms=de.getUniforms(x),x.onBuild(N,Me,E),x.onBeforeCompile(Me,E),Re=de.acquireProgram(Me,be),Fe.set(be,Re),O.uniforms=Me.uniforms;const Pe=O.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Pe.clippingPlanes=Ne.uniform),zs(x,Me),O.needsLights=yl(x),O.lightsStateVersion=pe,O.needsLights&&(Pe.ambientLightColor.value=U.state.ambient,Pe.lightProbe.value=U.state.probe,Pe.directionalLights.value=U.state.directional,Pe.directionalLightShadows.value=U.state.directionalShadow,Pe.spotLights.value=U.state.spot,Pe.spotLightShadows.value=U.state.spotShadow,Pe.rectAreaLights.value=U.state.rectArea,Pe.ltc_1.value=U.state.rectAreaLTC1,Pe.ltc_2.value=U.state.rectAreaLTC2,Pe.pointLights.value=U.state.point,Pe.pointLightShadows.value=U.state.pointShadow,Pe.hemisphereLights.value=U.state.hemi,Pe.directionalShadowMap.value=U.state.directionalShadowMap,Pe.directionalShadowMatrix.value=U.state.directionalShadowMatrix,Pe.spotShadowMap.value=U.state.spotShadowMap,Pe.spotLightMatrix.value=U.state.spotLightMatrix,Pe.spotLightMap.value=U.state.spotLightMap,Pe.pointShadowMap.value=U.state.pointShadowMap,Pe.pointShadowMatrix.value=U.state.pointShadowMatrix),O.currentProgram=Re,O.uniformsList=null,Re}function Bs(x){if(x.uniformsList===null){const P=x.currentProgram.getUniforms();x.uniformsList=ur.seqWithValue(P.seq,x.uniforms)}return x.uniformsList}function zs(x,P){const N=Ie.get(x);N.outputColorSpace=P.outputColorSpace,N.batching=P.batching,N.instancing=P.instancing,N.instancingColor=P.instancingColor,N.skinning=P.skinning,N.morphTargets=P.morphTargets,N.morphNormals=P.morphNormals,N.morphColors=P.morphColors,N.morphTargetsCount=P.morphTargetsCount,N.numClippingPlanes=P.numClippingPlanes,N.numIntersection=P.numClipIntersection,N.vertexAlphas=P.vertexAlphas,N.vertexTangents=P.vertexTangents,N.toneMapping=P.toneMapping}function Sl(x,P,N,O,U){P.isScene!==!0&&(P=ye),M.resetTextureUnits();const le=P.fog,pe=O.isMeshStandardMaterial?P.environment:null,Me=w===null?E.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:fn,be=(O.isMeshStandardMaterial?I:g).get(O.envMap||pe),Fe=O.vertexColors===!0&&!!N.attributes.color&&N.attributes.color.itemSize===4,Re=!!N.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),Pe=!!N.morphAttributes.position,nt=!!N.morphAttributes.normal,Dt=!!N.morphAttributes.color;let ot=yn;O.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(ot=E.toneMapping);const Jt=N.morphAttributes.position||N.morphAttributes.normal||N.morphAttributes.color,Qe=Jt!==void 0?Jt.length:0,Be=Ie.get(O),Cr=d.state.lights;if(Y===!0&&(oe===!0||x!==S)){const Ft=x===S&&O.id===j;Ne.setState(O,x,Ft)}let tt=!1;O.version===Be.__version?(Be.needsLights&&Be.lightsStateVersion!==Cr.state.version||Be.outputColorSpace!==Me||U.isBatchedMesh&&Be.batching===!1||!U.isBatchedMesh&&Be.batching===!0||U.isInstancedMesh&&Be.instancing===!1||!U.isInstancedMesh&&Be.instancing===!0||U.isSkinnedMesh&&Be.skinning===!1||!U.isSkinnedMesh&&Be.skinning===!0||U.isInstancedMesh&&Be.instancingColor===!0&&U.instanceColor===null||U.isInstancedMesh&&Be.instancingColor===!1&&U.instanceColor!==null||Be.envMap!==be||O.fog===!0&&Be.fog!==le||Be.numClippingPlanes!==void 0&&(Be.numClippingPlanes!==Ne.numPlanes||Be.numIntersection!==Ne.numIntersection)||Be.vertexAlphas!==Fe||Be.vertexTangents!==Re||Be.morphTargets!==Pe||Be.morphNormals!==nt||Be.morphColors!==Dt||Be.toneMapping!==ot||we.isWebGL2===!0&&Be.morphTargetsCount!==Qe)&&(tt=!0):(tt=!0,Be.__version=O.version);let An=Be.currentProgram;tt===!0&&(An=Fi(O,P,U));let Hs=!1,mi=!1,Pr=!1;const pt=An.getUniforms(),wn=Be.uniforms;if(fe.useProgram(An.program)&&(Hs=!0,mi=!0,Pr=!0),O.id!==j&&(j=O.id,mi=!0),Hs||S!==x){pt.setValue(D,"projectionMatrix",x.projectionMatrix),pt.setValue(D,"viewMatrix",x.matrixWorldInverse);const Ft=pt.map.cameraPosition;Ft!==void 0&&Ft.setValue(D,Le.setFromMatrixPosition(x.matrixWorld)),we.logarithmicDepthBuffer&&pt.setValue(D,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&pt.setValue(D,"isOrthographic",x.isOrthographicCamera===!0),S!==x&&(S=x,mi=!0,Pr=!0)}if(U.isSkinnedMesh){pt.setOptional(D,U,"bindMatrix"),pt.setOptional(D,U,"bindMatrixInverse");const Ft=U.skeleton;Ft&&(we.floatVertexTextures?(Ft.boneTexture===null&&Ft.computeBoneTexture(),pt.setValue(D,"boneTexture",Ft.boneTexture,M)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}U.isBatchedMesh&&(pt.setOptional(D,U,"batchingTexture"),pt.setValue(D,"batchingTexture",U._matricesTexture,M));const Lr=N.morphAttributes;if((Lr.position!==void 0||Lr.normal!==void 0||Lr.color!==void 0&&we.isWebGL2===!0)&&He.update(U,N,An),(mi||Be.receiveShadow!==U.receiveShadow)&&(Be.receiveShadow=U.receiveShadow,pt.setValue(D,"receiveShadow",U.receiveShadow)),O.isMeshGouraudMaterial&&O.envMap!==null&&(wn.envMap.value=be,wn.flipEnvMap.value=be.isCubeTexture&&be.isRenderTargetTexture===!1?-1:1),mi&&(pt.setValue(D,"toneMappingExposure",E.toneMappingExposure),Be.needsLights&&El(wn,Pr),le&&O.fog===!0&&ae.refreshFogUniforms(wn,le),ae.refreshMaterialUniforms(wn,O,X,H,ge),ur.upload(D,Bs(Be),wn,M)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&(ur.upload(D,Bs(Be),wn,M),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&pt.setValue(D,"center",U.center),pt.setValue(D,"modelViewMatrix",U.modelViewMatrix),pt.setValue(D,"normalMatrix",U.normalMatrix),pt.setValue(D,"modelMatrix",U.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){const Ft=O.uniformsGroups;for(let Dr=0,Tl=Ft.length;Dr<Tl;Dr++)if(we.isWebGL2){const Gs=Ft[Dr];Ve.update(Gs,An),Ve.bind(Gs,An)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return An}function El(x,P){x.ambientLightColor.needsUpdate=P,x.lightProbe.needsUpdate=P,x.directionalLights.needsUpdate=P,x.directionalLightShadows.needsUpdate=P,x.pointLights.needsUpdate=P,x.pointLightShadows.needsUpdate=P,x.spotLights.needsUpdate=P,x.spotLightShadows.needsUpdate=P,x.rectAreaLights.needsUpdate=P,x.hemisphereLights.needsUpdate=P}function yl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return L},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(x,P,N){Ie.get(x.texture).__webglTexture=P,Ie.get(x.depthTexture).__webglTexture=N;const O=Ie.get(x);O.__hasExternalTextures=!0,O.__hasExternalTextures&&(O.__autoAllocateDepthBuffer=N===void 0,O.__autoAllocateDepthBuffer||ve.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),O.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(x,P){const N=Ie.get(x);N.__webglFramebuffer=P,N.__useDefaultFramebuffer=P===void 0},this.setRenderTarget=function(x,P=0,N=0){w=x,L=P,R=N;let O=!0,U=null,le=!1,pe=!1;if(x){const be=Ie.get(x);be.__useDefaultFramebuffer!==void 0?(fe.bindFramebuffer(D.FRAMEBUFFER,null),O=!1):be.__webglFramebuffer===void 0?M.setupRenderTarget(x):be.__hasExternalTextures&&M.rebindTextures(x,Ie.get(x.texture).__webglTexture,Ie.get(x.depthTexture).__webglTexture);const Fe=x.texture;(Fe.isData3DTexture||Fe.isDataArrayTexture||Fe.isCompressedArrayTexture)&&(pe=!0);const Re=Ie.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Re[P])?U=Re[P][N]:U=Re[P],le=!0):we.isWebGL2&&x.samples>0&&M.useMultisampledRTT(x)===!1?U=Ie.get(x).__webglMultisampledFramebuffer:Array.isArray(Re)?U=Re[N]:U=Re,y.copy(x.viewport),G.copy(x.scissor),V=x.scissorTest}else y.copy(q).multiplyScalar(X).floor(),G.copy(Q).multiplyScalar(X).floor(),V=ee;if(fe.bindFramebuffer(D.FRAMEBUFFER,U)&&we.drawBuffers&&O&&fe.drawBuffers(x,U),fe.viewport(y),fe.scissor(G),fe.setScissorTest(V),le){const be=Ie.get(x.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+P,be.__webglTexture,N)}else if(pe){const be=Ie.get(x.texture),Fe=P||0;D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,be.__webglTexture,N||0,Fe)}j=-1},this.readRenderTargetPixels=function(x,P,N,O,U,le,pe){if(!(x&&x.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Me=Ie.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&pe!==void 0&&(Me=Me[pe]),Me){fe.bindFramebuffer(D.FRAMEBUFFER,Me);try{const be=x.texture,Fe=be.format,Re=be.type;if(Fe!==zt&&ue.convert(Fe)!==D.getParameter(D.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Pe=Re===Ci&&(ve.has("EXT_color_buffer_half_float")||we.isWebGL2&&ve.has("EXT_color_buffer_float"));if(Re!==cn&&ue.convert(Re)!==D.getParameter(D.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Re===Sn&&(we.isWebGL2||ve.has("OES_texture_float")||ve.has("WEBGL_color_buffer_float")))&&!Pe){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}P>=0&&P<=x.width-O&&N>=0&&N<=x.height-U&&D.readPixels(P,N,O,U,ue.convert(Fe),ue.convert(Re),le)}finally{const be=w!==null?Ie.get(w).__webglFramebuffer:null;fe.bindFramebuffer(D.FRAMEBUFFER,be)}}},this.copyFramebufferToTexture=function(x,P,N=0){const O=Math.pow(2,-N),U=Math.floor(P.image.width*O),le=Math.floor(P.image.height*O);M.setTexture2D(P,0),D.copyTexSubImage2D(D.TEXTURE_2D,N,0,0,x.x,x.y,U,le),fe.unbindTexture()},this.copyTextureToTexture=function(x,P,N,O=0){const U=P.image.width,le=P.image.height,pe=ue.convert(N.format),Me=ue.convert(N.type);M.setTexture2D(N,0),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,N.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,N.unpackAlignment),P.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,O,x.x,x.y,U,le,pe,Me,P.image.data):P.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,O,x.x,x.y,P.mipmaps[0].width,P.mipmaps[0].height,pe,P.mipmaps[0].data):D.texSubImage2D(D.TEXTURE_2D,O,x.x,x.y,pe,Me,P.image),O===0&&N.generateMipmaps&&D.generateMipmap(D.TEXTURE_2D),fe.unbindTexture()},this.copyTextureToTexture3D=function(x,P,N,O,U=0){if(E.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const le=x.max.x-x.min.x+1,pe=x.max.y-x.min.y+1,Me=x.max.z-x.min.z+1,be=ue.convert(O.format),Fe=ue.convert(O.type);let Re;if(O.isData3DTexture)M.setTexture3D(O,0),Re=D.TEXTURE_3D;else if(O.isDataArrayTexture||O.isCompressedArrayTexture)M.setTexture2DArray(O,0),Re=D.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,O.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,O.unpackAlignment);const Pe=D.getParameter(D.UNPACK_ROW_LENGTH),nt=D.getParameter(D.UNPACK_IMAGE_HEIGHT),Dt=D.getParameter(D.UNPACK_SKIP_PIXELS),ot=D.getParameter(D.UNPACK_SKIP_ROWS),Jt=D.getParameter(D.UNPACK_SKIP_IMAGES),Qe=N.isCompressedTexture?N.mipmaps[U]:N.image;D.pixelStorei(D.UNPACK_ROW_LENGTH,Qe.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Qe.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,x.min.x),D.pixelStorei(D.UNPACK_SKIP_ROWS,x.min.y),D.pixelStorei(D.UNPACK_SKIP_IMAGES,x.min.z),N.isDataTexture||N.isData3DTexture?D.texSubImage3D(Re,U,P.x,P.y,P.z,le,pe,Me,be,Fe,Qe.data):N.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),D.compressedTexSubImage3D(Re,U,P.x,P.y,P.z,le,pe,Me,be,Qe.data)):D.texSubImage3D(Re,U,P.x,P.y,P.z,le,pe,Me,be,Fe,Qe),D.pixelStorei(D.UNPACK_ROW_LENGTH,Pe),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,nt),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Dt),D.pixelStorei(D.UNPACK_SKIP_ROWS,ot),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Jt),U===0&&O.generateMipmaps&&D.generateMipmap(Re),fe.unbindTexture()},this.initTexture=function(x){x.isCubeTexture?M.setTextureCube(x,0):x.isData3DTexture?M.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?M.setTexture2DArray(x,0):M.setTexture2D(x,0),fe.unbindTexture()},this.resetState=function(){L=0,R=0,w=null,fe.reset(),De.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ln}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===Ls?"display-p3":"srgb",t.unpackColorSpace=qe.workingColorSpace===yr?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===ct?Hn:Xo}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Hn?ct:fn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class Qp extends ml{}Qp.prototype.isWebGL1Renderer=!0;class kn extends Pt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class em extends Ui{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ee(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const lo=new ut,Es=new Zo,sr=new Tr,ar=new F;class tm extends Pt{constructor(e=new pn,t=new em){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,t){const i=this.geometry,r=this.matrixWorld,s=e.params.Points.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),sr.copy(i.boundingSphere),sr.applyMatrix4(r),sr.radius+=s,e.ray.intersectsSphere(sr)===!1)return;lo.copy(r).invert(),Es.copy(e.ray).applyMatrix4(lo);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=i.index,f=i.attributes.position;if(c!==null){const p=Math.max(0,o.start),m=Math.min(c.count,o.start+o.count);for(let v=p,_=m;v<_;v++){const d=c.getX(v);ar.fromBufferAttribute(f,d),co(ar,d,l,r,e,t,this)}}else{const p=Math.max(0,o.start),m=Math.min(f.count,o.start+o.count);for(let v=p,_=m;v<_;v++)ar.fromBufferAttribute(f,v),co(ar,v,l,r,e,t,this)}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const r=t[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function co(n,e,t,i,r,s,o){const a=Es.distanceSqToPoint(n);if(a<t){const l=new F;Es.closestPointToPoint(n,l),l.applyMatrix4(i);const c=r.ray.origin.distanceTo(l);if(c<r.near||c>r.far)return;s.push({distance:c,distanceToRay:Math.sqrt(a),point:l,index:e,face:null,object:o})}}class nm extends Ct{constructor(e,t,i,r,s,o,a,l,c){super(e,t,i,r,s,o,a,l,c),this.isCanvasTexture=!0,this.needsUpdate=!0}}class im{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=uo(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const t=uo();e=(t-this.oldTime)/1e3,this.oldTime=t,this.elapsedTime+=e}return e}}function uo(){return(typeof performance>"u"?Date:performance).now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Cs}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Cs);class Us{constructor(e){this.opts=e,this.scene.add(this.group),this.cfg={particleCount:6e5,size:2,colorMode:"palette",speed:1,curl:.8,depthFade:!0,glow:.6},this.build()}name="particles";scene=new kn;group=new Si;points=null;material=null;geom=null;uniforms={};cfg;getConfigSchema(){return{particleCount:{label:"Particle count",type:"range",min:1e5,max:15e5,step:5e4,default:6e5,help:"Total points (higher is heavier)"},size:{label:"Point size",type:"range",min:.5,max:4,step:.1,default:2},colorMode:{label:"Color mode",type:"select",options:[{value:"palette",label:"Palette"},{value:"rainbow",label:"Rainbow"},{value:"mono",label:"Monochrome"}],default:"palette"},speed:{label:"Flow speed",type:"range",min:.2,max:3,step:.05,default:1},curl:{label:"Curl noise",type:"range",min:0,max:2,step:.05,default:.8},depthFade:{label:"Depth fade",type:"checkbox",default:!0},glow:{label:"Glow",type:"range",min:0,max:1.2,step:.05,default:.6}}}getConfig(){return{...this.cfg}}setConfig(e){this.cfg={...this.cfg,...e},this.rebuildIfNeeded(),this.updateUniforms()}build(){const e=Math.min(Number(this.cfg.particleCount)||6e5,this.opts.quality().particleBudget),t=new Float32Array(e*3),i=new Float32Array(e*4),r=Math.random;for(let o=0;o<e;o++){const a=Math.pow(r(),.7)*8,l=r()*Math.PI*2,c=(r()-.5)*4;t[o*3+0]=Math.cos(l)*a,t[o*3+1]=c,t[o*3+2]=Math.sin(l)*a,i[o*4+0]=r()*1e3,i[o*4+1]=r()*1e3,i[o*4+2]=r()*1e3,i[o*4+3]=r()}this.geom?.dispose(),this.geom=new pn,this.geom.setAttribute("position",new un(t,3)),this.geom.setAttribute("seed",new un(i,4));const s=this.opts.palette().map(o=>new Ee(o));this.uniforms={uTime:{value:0},uSpeed:{value:Number(this.cfg.speed)},uCurl:{value:Number(this.cfg.curl)},uSize:{value:Number(this.cfg.size)},uGlow:{value:Number(this.cfg.glow)},uColorMode:{value:this.cfg.colorMode},uPalette:{value:s},uDepthFade:{value:!!this.cfg.depthFade},uIntensity:{value:this.opts.accessibility().intensityLimiter}},this.material?.dispose(),this.material=new Lt({uniforms:this.uniforms,vertexShader:`
        precision mediump float;
        attribute vec4 seed;
        uniform float uTime;
      ...
      `,transparent:!0,depthWrite:!1,blending:hs}),this.points?.geometry.dispose(),this.points?.material?.dispose(),this.points=new tm(this.geom,this.material),this.group.clear(),this.group.add(this.points),this.updateUniforms()}rebuildIfNeeded(){const e=Math.min(Number(this.cfg.particleCount)||6e5,this.opts.quality().particleBudget),t=this.geom?.getAttribute("position")?.count||0;Math.abs(t-e)>1e4&&this.build()}updateUniforms(){if(!this.material)return;this.uniforms.uSize.value=Number(this.cfg.size),this.uniforms.uSpeed.value=Number(this.cfg.speed),this.uniforms.uCurl.value=Number(this.cfg.curl),this.uniforms.uGlow.value=Number(this.cfg.glow);const e=this.opts.palette().map(t=>new Ee(t));this.uniforms.uPalette.value=e}setPalette(e){const t=e.map(i=>new Ee(i));this.uniforms.uPalette&&(this.uniforms.uPalette.value=t)}setQuality(e){const t=e?.particleBudget??1e6;Number(this.cfg.particleCount)>t&&(this.cfg.particleCount=t,this.rebuildIfNeeded())}start(){}stop(){}update(e,t){this.uniforms.uTime&&(this.uniforms.uTime.value=t)}onMacro(e,t){e==="intensity"&&(this.uniforms.uGlow.value=.3+.9*t)}}class rm{constructor(e){this.opts=e,this.cfg={resolution:512,advection:.96,swirl:.7,speed:.8,dye:.9},this.build()}name="fluid";scene=new kn;quad=null;rtA=null;rtB=null;simMat=null;dispMat=null;cfg;getConfigSchema(){return{resolution:{label:"Sim resolution",type:"range",min:256,max:1024,step:128,default:512},advection:{label:"Advection",type:"range",min:.85,max:.995,step:.005,default:.96},swirl:{label:"Swirl",type:"range",min:0,max:1.5,step:.05,default:.7},speed:{label:"Scroll speed",type:"range",min:.2,max:2,step:.05,default:.8},dye:{label:"Dye fade",type:"range",min:.7,max:1,step:.01,default:.9}}}getConfig(){return{...this.cfg}}setConfig(e){this.cfg={...this.cfg,...e},this.recreateTargets()}createRT(e){return new bn(e,e,{minFilter:yt,magFilter:yt,depthBuffer:!1,stencilBuffer:!1,type:cn,format:zt})}recreateTargets(){const e=Number(this.cfg.resolution)||512;this.rtA?.dispose(),this.rtB?.dispose(),this.rtA=this.createRT(e),this.rtB=this.createRT(e)}build(){this.recreateTargets(),this.simMat=new Lt({uniforms:{uTex:{value:null},uTime:{value:0},uAdvect:{value:Number(this.cfg.advection)},uSwirl:{value:Number(this.cfg.swirl)},uSpeed:{value:Number(this.cfg.speed)},uDye:{value:Number(this.cfg.dye)},uPalette:{value:this.opts.palette().map(t=>new Ee(t))}},vertexShader:"varying vec2 vUv; void main(){ vUv = uv; gl_Position = vec4(position,1.0); }",fragmentShader:`
        precision mediump float;
        varying vec2 vUv;
      ...
      `}),this.dispMat=new Lt({uniforms:{uTex:{value:this.rtA.texture},uPalette:{value:this.opts.palette().map(t=>new Ee(t))}},vertexShader:"varying vec2 vUv; void main(){ vUv=uv; gl_Position=vec4(position,1.0); }",fragmentShader:`
        precision mediump float;
        varying vec2 vUv;
        uniform sampler2D uTex;
        uniform vec3 uPalette[5];
      ...
      `});const e=new dn(2,2);this.quad=new wt(e,this.dispMat),this.scene.add(this.quad)}setPalette(e){this.simMat.uniforms.uPalette.value=e.map(t=>new Ee(t)),this.dispMat.uniforms.uPalette.value=e.map(t=>new Ee(t))}start(){}stop(){}update(e,t){const i=this.simMat.uniforms;i.uTex.value=this.rtA.texture,i.uTime.value=t,i.uAdvect.value=Number(this.cfg.advection),i.uSwirl.value=Number(this.cfg.swirl),i.uSpeed.value=Number(this.cfg.speed),i.uDye.value=Number(this.cfg.dye);const r=this.opts.renderer.getRenderTarget();this.opts.renderer.setRenderTarget(this.rtB),this.renderFullScreen(this.simMat),this.opts.renderer.setRenderTarget(r);const s=this.rtA;this.rtA=this.rtB,this.rtB=s,this.dispMat.uniforms.uTex.value=this.rtA.texture}renderFullScreen(e){const t=new wt(new dn(2,2),e),i=new kn;i.add(t);const r=new ll(-1,1,1,-1,0,1);this.opts.renderer.render(i,r),t.geometry.dispose(),t.material.dispose?.()}onMacro(e,t){e==="intensity"&&(this.cfg.swirl=.2+t*1.2)}}class sm{constructor(e){this.opts=e,this.cfg={steps:256,speed:.7,twist:1,radius:1.2,brightness:1},this.build()}name="tunnel";scene=new kn;mesh=null;uniforms={};cfg;getConfigSchema(){return{steps:{label:"Ray steps",type:"range",min:64,max:768,step:32,default:256},speed:{label:"Motion speed",type:"range",min:.2,max:2,step:.05,default:.7},twist:{label:"Twist",type:"range",min:0,max:2.5,step:.05,default:1},radius:{label:"Radius",type:"range",min:.6,max:2.5,step:.05,default:1.2},brightness:{label:"Brightness",type:"range",min:.5,max:2,step:.05,default:1}}}getConfig(){return{...this.cfg}}setConfig(e){this.cfg={...this.cfg,...e}}build(){this.uniforms={uTime:{value:0},uSteps:{value:Number(this.cfg.steps)},uSpeed:{value:Number(this.cfg.speed)},uTwist:{value:Number(this.cfg.twist)},uRadius:{value:Number(this.cfg.radius)},uBright:{value:Number(this.cfg.brightness)},uPalette:{value:this.opts.palette().map(i=>new Ee(i))}};const e=new dn(2,2),t=new Lt({uniforms:this.uniforms,vertexShader:`
        varying vec2 vUv;
        void main(){
          vUv = uv*2.0-1.0;
          gl_Position = vec4(position,1.0);
      ...
      `});this.mesh=new wt(e,t),this.scene.add(this.mesh)}setPalette(e){this.mesh.material.uniforms.uPalette.value=e.map(t=>new Ee(t))}start(){}stop(){}update(e,t){const i=this.mesh.material.uniforms;i.uTime.value=t,i.uSteps.value=Number(this.cfg.steps),i.uTwist.value=Number(this.cfg.twist),i.uRadius.value=Number(this.cfg.radius),i.uSpeed.value=Number(this.cfg.speed),i.uBright.value=Number(this.cfg.brightness)}onMacro(e,t){e==="intensity"&&(this.cfg.brightness=.8+t*.8)}}class am{constructor(e){this.opts=e,this.cfg={scale:1,amplitude:.6,speed:.4,wireframe:!1,shading:"lambert"},this.build()}name="terrain";scene=new kn;mesh=null;uniforms={};cfg;getConfigSchema(){return{scale:{label:"Noise scale",type:"range",min:.2,max:3,step:.05,default:1},amplitude:{label:"Amplitude",type:"range",min:.1,max:1.5,step:.05,default:.6},speed:{label:"Scroll speed",type:"range",min:.1,max:2,step:.05,default:.4},wireframe:{label:"Wireframe",type:"checkbox",default:!1},shading:{label:"Shading",type:"select",options:[{value:"flat",label:"Flat"},{value:"lambert",label:"Lambert"}],default:"lambert"}}}getConfig(){return{...this.cfg}}setConfig(e){this.cfg={...this.cfg,...e},this.mesh&&(this.mesh.material.wireframe=!!this.cfg.wireframe)}build(){this.uniforms={uTime:{value:0},uScale:{value:Number(this.cfg.scale)},uAmp:{value:Number(this.cfg.amplitude)},uSpeed:{value:Number(this.cfg.speed)},uPalette:{value:this.opts.palette().map(i=>new Ee(i))}};const e=new dn(8,8,200,200);e.rotateX(-Math.PI/2);const t=new Lt({uniforms:this.uniforms,vertexShader:`
        precision mediump float;
